...
* GitHub v3 REST API
  ...
  PROTECTED SECTION.
    ...
    METHODS parse_scoped_installation
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(scoped_installation) TYPE zif_ghes218=>scoped_installation
      RAISING cx_static_check.
    ...
    METHODS parse_git_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_user) TYPE zif_ghes218=>git_user
      RAISING cx_static_check.
    ...
    METHODS json_oauth_authorizations_crea
      IMPORTING data TYPE zif_ghes218=>bodyoauth_authorizations_creat
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_oauth_authorizations_get_
      IMPORTING data TYPE zif_ghes218=>bodyoauth_authorizations_get_o
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_oauth_authorizations_ge01
      IMPORTING data TYPE zif_ghes218=>bodyoauth_authorizations_get01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_oauth_authorizations_upda
      IMPORTING data TYPE zif_ghes218=>bodyoauth_authorizations_updat
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_oauth_authorizations_dele
      IMPORTING data TYPE zif_ghes218=>bodyoauth_authorizations_delet
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_repos_add_status_check_co
      IMPORTING data TYPE zif_ghes218=>bodyrepos_add_status_check_con
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_set_status_check_co
      IMPORTING data TYPE zif_ghes218=>bodyrepos_set_status_check_con
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_remove_status_che01
      IMPORTING data TYPE zif_ghes218=>bodyrepos_remove_status_chec01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_add_team_access_res
      IMPORTING data TYPE zif_ghes218=>bodyrepos_add_team_access_rest
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_set_team_access_res
      IMPORTING data TYPE zif_ghes218=>bodyrepos_set_team_access_rest
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_remove_team_access_
      IMPORTING data TYPE zif_ghes218=>bodyrepos_remove_team_access_r
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_add_user_access_res
      IMPORTING data TYPE zif_ghes218=>bodyrepos_add_user_access_rest
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_set_user_access_res
      IMPORTING data TYPE zif_ghes218=>bodyrepos_set_user_access_rest
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_remove_user_access_
      IMPORTING data TYPE zif_ghes218=>bodyrepos_remove_user_access_r
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_issues_add_labels
      IMPORTING data TYPE zif_ghes218=>bodyissues_add_labels
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_set_labels
      IMPORTING data TYPE zif_ghes218=>bodyissues_set_labels
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_remove_all_labels
      IMPORTING data TYPE zif_ghes218=>bodyissues_remove_all_labels
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_enterprise_admin_enable_o
      IMPORTING data TYPE zif_ghes218=>bodyenterprise_admin_enable_or
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_set_sett
      IMPORTING data TYPE zif_ghes218=>bodyenterprise_admin_set_setti
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_add_auth
      IMPORTING data TYPE zif_ghes218=>bodyenterprise_admin_add_autho
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_remove_a
      IMPORTING data TYPE zif_ghes218=>bodyenterprise_admin_remove_au
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_e
      IMPORTING data TYPE zif_ghes218=>bodyenterprise_admin_create_en
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_upgrade_
      IMPORTING data TYPE zif_ghes218=>bodyenterprise_admin_upgrade_l
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS parse_oauth_authorizations_lis
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_oauth_authorizations_) TYPE zif_ghes218=>response_oauth_authorizations_
      RAISING cx_static_check.
    METHODS parse_oauth_authorizations_l01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_oauth_authorization01) TYPE zif_ghes218=>response_oauth_authorization01
      RAISING cx_static_check.
    ...
    METHODS parse_repos_create_deploymen01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_create_deploy01) TYPE zif_ghes218=>response_repos_create_deploy01
      RAISING cx_static_check.
    ...
    METHODS parse_repos_merge
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_merge) TYPE zif_ghes218=>response_repos_merge
      RAISING cx_static_check.
    METHODS parse_repos_merge01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_merge01) TYPE zif_ghes218=>response_repos_merge01
      RAISING cx_static_check.
    ...
    METHODS parse_activity_list_stargazers
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_stargaz) TYPE zif_ghes218=>response_activity_list_stargaz
      RAISING cx_static_check.
    ...
    METHODS parse_teams_add_member_legacy
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_add_member_lega) TYPE zif_ghes218=>response_teams_add_member_lega
      RAISING cx_static_check.
    METHODS parse_teams_add_or_update_memb
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_add_or_update_m) TYPE zif_ghes218=>response_teams_add_or_update_m
      RAISING cx_static_check.
    ...
    METHODS parse_activity_list_repos_st01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_repos01) TYPE zif_ghes218=>response_activity_list_repos01
      RAISING cx_static_check.
...
* todo, array, errors
  ...
  METHOD parse_oauth_authorizations_lis.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA application_grant TYPE zif_ghes218=>application_grant.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
...
* todo, handle more responses
  ...
  METHOD zif_ghes218~oauth_authorizations_list_gran.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes218~oauth_authorizations_get_grant.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes218~oauth_authorizations_delete_gr.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/applications/grants/{grant_id}'.
    lv_temp = grant_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes218~oauth_authorizations_list_auth.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes218~oauth_authorizations_create_au.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/authorizations'.
    mi_client->request->set_method( 'POST' ).
  ...
  METHOD zif_ghes218~oauth_authorizations_get_or_cr.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes218~oauth_authorizations_get_or_01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes218~oauth_authorizations_get_autho.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes218~oauth_authorizations_update_au.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/authorizations/{authorization_id}'.
    lv_temp = authorization_id.
  ...
  METHOD zif_ghes218~oauth_authorizations_delete_au.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/authorizations/{authorization_id}'.
    lv_temp = authorization_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes218~codes_of_conduct_get_for_repo.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes218~git_get_all_refs.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/repos/{owner}/{repo}/git/refs/{namespace}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
    REPLACE ALL OCCURRENCES OF '{repo}' IN lv_uri WITH repo.
    lv_temp = per_page.
    CONDENSE lv_temp.
...
* todo, handle more responses
  ...
  METHOD zif_ghes218~teams_get_member_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes218~teams_add_member_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/members/{username}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes218~teams_remove_member_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/members/{username}'.
    lv_temp = team_id.
