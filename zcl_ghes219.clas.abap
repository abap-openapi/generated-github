...
* GitHub v3 REST API
  ...
  PROTECTED SECTION.
    ...
    METHODS parse_enterprise_public_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_public_key) TYPE zif_ghes219=>enterprise_public_key
      RAISING cx_static_check.
    ...
    METHODS json_oauth_authorizations_crea
      IMPORTING data TYPE zif_ghes219=>bodyoauth_authorizations_creat
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_oauth_authorizations_get_
      IMPORTING data TYPE zif_ghes219=>bodyoauth_authorizations_get_o
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_oauth_authorizations_ge01
      IMPORTING data TYPE zif_ghes219=>bodyoauth_authorizations_get01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_oauth_authorizations_upda
      IMPORTING data TYPE zif_ghes219=>bodyoauth_authorizations_updat
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_oauth_authorizations_dele
      IMPORTING data TYPE zif_ghes219=>bodyoauth_authorizations_delet
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_repos_add_status_check_co
      IMPORTING data TYPE zif_ghes219=>bodyrepos_add_status_check_con
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_set_status_check_co
      IMPORTING data TYPE zif_ghes219=>bodyrepos_set_status_check_con
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_remove_status_che01
      IMPORTING data TYPE zif_ghes219=>bodyrepos_remove_status_chec01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_add_app_access_rest
      IMPORTING data TYPE zif_ghes219=>bodyrepos_add_app_access_restr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_set_app_access_rest
      IMPORTING data TYPE zif_ghes219=>bodyrepos_set_app_access_restr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_remove_app_access_r
      IMPORTING data TYPE zif_ghes219=>bodyrepos_remove_app_access_re
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_add_team_access_res
      IMPORTING data TYPE zif_ghes219=>bodyrepos_add_team_access_rest
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_set_team_access_res
      IMPORTING data TYPE zif_ghes219=>bodyrepos_set_team_access_rest
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_remove_team_access_
      IMPORTING data TYPE zif_ghes219=>bodyrepos_remove_team_access_r
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_add_user_access_res
      IMPORTING data TYPE zif_ghes219=>bodyrepos_add_user_access_rest
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_set_user_access_res
      IMPORTING data TYPE zif_ghes219=>bodyrepos_set_user_access_rest
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_remove_user_access_
      IMPORTING data TYPE zif_ghes219=>bodyrepos_remove_user_access_r
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_issues_add_labels
      IMPORTING data TYPE zif_ghes219=>bodyissues_add_labels
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_set_labels
      IMPORTING data TYPE zif_ghes219=>bodyissues_set_labels
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_remove_all_labels
      IMPORTING data TYPE zif_ghes219=>bodyissues_remove_all_labels
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS parse_oauth_authorizations_lis
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_oauth_authorizations_) TYPE zif_ghes219=>response_oauth_authorizations_
      RAISING cx_static_check.
    METHODS parse_oauth_authorizations_l01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_oauth_authorization01) TYPE zif_ghes219=>response_oauth_authorization01
      RAISING cx_static_check.
    ...
    METHODS parse_repos_create_deploymen01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_create_deploy01) TYPE zif_ghes219=>response_repos_create_deploy01
      RAISING cx_static_check.
    ...
    METHODS parse_repos_merge
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_merge) TYPE zif_ghes219=>response_repos_merge
      RAISING cx_static_check.
    METHODS parse_repos_merge01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_merge01) TYPE zif_ghes219=>response_repos_merge01
      RAISING cx_static_check.
    ...
    METHODS parse_activity_list_stargazers
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_stargaz) TYPE zif_ghes219=>response_activity_list_stargaz
      RAISING cx_static_check.
    ...
    METHODS parse_teams_add_member_legacy
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_add_member_lega) TYPE zif_ghes219=>response_teams_add_member_lega
      RAISING cx_static_check.
    METHODS parse_teams_add_or_update_memb
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_add_or_update_m) TYPE zif_ghes219=>response_teams_add_or_update_m
      RAISING cx_static_check.
    ...
    METHODS parse_activity_list_repos_st01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_repos01) TYPE zif_ghes219=>response_activity_list_repos01
      RAISING cx_static_check.
...
* todo, array, contexts
  ...
  METHOD parse_enterprise_admin_list_pu.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA enterprise_public_key TYPE zif_ghes219=>enterprise_public_key.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
...
* todo, array, errors
  ...
  METHOD parse_oauth_authorizations_lis.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA application_grant TYPE zif_ghes219=>application_grant.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~oauth_authorizations_list_gran.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~oauth_authorizations_get_grant.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~oauth_authorizations_delete_gr.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/applications/grants/{grant_id}'.
    lv_temp = grant_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~oauth_authorizations_list_auth.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~oauth_authorizations_create_au.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/authorizations'.
    mi_client->request->set_method( 'POST' ).
  ...
  METHOD zif_ghes219~oauth_authorizations_get_or_cr.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~oauth_authorizations_get_or_01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~oauth_authorizations_get_autho.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~oauth_authorizations_update_au.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/authorizations/{authorization_id}'.
    lv_temp = authorization_id.
  ...
  METHOD zif_ghes219~oauth_authorizations_delete_au.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/authorizations/{authorization_id}'.
    lv_temp = authorization_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~enterprise_admin_get_type_stat.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_enable_vulnerability_ale.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_disable_vulnerability_al.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/repos/{owner}/{repo}/vulnerability-alerts'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~teams_get_member_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~teams_add_member_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/members/{username}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~teams_remove_member_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/members/{username}'.
    lv_temp = team_id.
