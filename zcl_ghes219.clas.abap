CLASS zcl_ghes219 DEFINITION PUBLIC.
* Generated by abap-openapi-client
* GitHub v3 REST API
  PUBLIC SECTION.
    INTERFACES zif_ghes219.
  ...
  PROTECTED SECTION.
    ...
    METHODS parse_global_hook
      ...
      RETURNING VALUE(global_hook) TYPE zif_ghes219=>global_hook
      RAISING cx_static_check.
    METHODS parse_global_hook_2
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(global_hook_2) TYPE zif_ghes219=>global_hook_2
      RAISING cx_static_check.
    METHODS parse_public_key_full
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(public_key_full) TYPE zif_ghes219=>public_key_full
      RAISING cx_static_check.
    METHODS parse_ldap_mapping_team
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(ldap_mapping_team) TYPE zif_ghes219=>ldap_mapping_team
      RAISING cx_static_check.
    METHODS parse_ldap_mapping_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(ldap_mapping_user) TYPE zif_ghes219=>ldap_mapping_user
      RAISING cx_static_check.
    METHODS parse_organization_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(organization_simple) TYPE zif_ghes219=>organization_simple
      RAISING cx_static_check.
    METHODS parse_pre_receive_environment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pre_receive_environment) TYPE zif_ghes219=>pre_receive_environment
      RAISING cx_static_check.
    METHODS parse_pre_receive_environment_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pre_receive_environment_downlo) TYPE zif_ghes219=>pre_receive_environment_downlo
      RAISING cx_static_check.
    METHODS parse_pre_receive_hook
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pre_receive_hook) TYPE zif_ghes219=>pre_receive_hook
      RAISING cx_static_check.
    METHODS parse_nullable_simple_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(nullable_simple_user) TYPE zif_ghes219=>nullable_simple_user
      RAISING cx_static_check.
    METHODS parse_app_permissions
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(app_permissions) TYPE zif_ghes219=>app_permissions
      RAISING cx_static_check.
    METHODS parse_simple_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(simple_user) TYPE zif_ghes219=>simple_user
      RAISING cx_static_check.
    METHODS parse_nullable_scoped_installa
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(nullable_scoped_installation) TYPE zif_ghes219=>nullable_scoped_installation
      RAISING cx_static_check.
    METHODS parse_authorization
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(authorization) TYPE zif_ghes219=>authorization
      RAISING cx_static_check.
    METHODS parse_integration
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(integration) TYPE zif_ghes219=>integration
      RAISING cx_static_check.
    METHODS parse_basic_error
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(basic_error) TYPE zif_ghes219=>basic_error
      RAISING cx_static_check.
    METHODS parse_validation_error_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(validation_error_simple) TYPE zif_ghes219=>validation_error_simple
      RAISING cx_static_check.
    METHODS parse_enterprise
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise) TYPE zif_ghes219=>enterprise
      RAISING cx_static_check.
    METHODS parse_installation_ghes_2
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(installation_ghes_2) TYPE zif_ghes219=>installation_ghes_2
      RAISING cx_static_check.
    METHODS parse_nullable_license_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(nullable_license_simple) TYPE zif_ghes219=>nullable_license_simple
      RAISING cx_static_check.
    METHODS parse_repository
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repository) TYPE zif_ghes219=>repository
      RAISING cx_static_check.
    METHODS parse_installation_token
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(installation_token) TYPE zif_ghes219=>installation_token
      RAISING cx_static_check.
    METHODS parse_validation_error
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(validation_error) TYPE zif_ghes219=>validation_error
      RAISING cx_static_check.
    METHODS parse_application_grant
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(application_grant) TYPE zif_ghes219=>application_grant
      RAISING cx_static_check.
    METHODS parse_authorization_with_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(authorization_with_user) TYPE zif_ghes219=>authorization_with_user
      RAISING cx_static_check.
    METHODS parse_code_of_conduct
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_of_conduct) TYPE zif_ghes219=>code_of_conduct
      RAISING cx_static_check.
    METHODS parse_license_info
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(license_info) TYPE zif_ghes219=>license_info
      RAISING cx_static_check.
    METHODS parse_enterprise_repository_ov
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_repository_overview) TYPE zif_ghes219=>enterprise_repository_overview
      RAISING cx_static_check.
    METHODS parse_enterprise_hook_overview
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_hook_overview) TYPE zif_ghes219=>enterprise_hook_overview
      RAISING cx_static_check.
    METHODS parse_enterprise_page_overview
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_page_overview) TYPE zif_ghes219=>enterprise_page_overview
      RAISING cx_static_check.
    METHODS parse_enterprise_organization_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_organization_overvi) TYPE zif_ghes219=>enterprise_organization_overvi
      RAISING cx_static_check.
    METHODS parse_enterprise_user_overview
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_user_overview) TYPE zif_ghes219=>enterprise_user_overview
      RAISING cx_static_check.
    METHODS parse_enterprise_pull_request_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_pull_request_overvi) TYPE zif_ghes219=>enterprise_pull_request_overvi
      RAISING cx_static_check.
    METHODS parse_enterprise_issue_overvie
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_issue_overview) TYPE zif_ghes219=>enterprise_issue_overview
      RAISING cx_static_check.
    METHODS parse_enterprise_milestone_ove
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_milestone_overview) TYPE zif_ghes219=>enterprise_milestone_overview
      RAISING cx_static_check.
    METHODS parse_enterprise_gist_overview
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_gist_overview) TYPE zif_ghes219=>enterprise_gist_overview
      RAISING cx_static_check.
    METHODS parse_enterprise_comment_overv
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_comment_overview) TYPE zif_ghes219=>enterprise_comment_overview
      RAISING cx_static_check.
    METHODS parse_enterprise_overview
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_overview) TYPE zif_ghes219=>enterprise_overview
      RAISING cx_static_check.
    METHODS parse_actor
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(actor) TYPE zif_ghes219=>actor
      RAISING cx_static_check.
    METHODS parse_label
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(label) TYPE zif_ghes219=>label
      RAISING cx_static_check.
    METHODS parse_nullable_milestone
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(nullable_milestone) TYPE zif_ghes219=>nullable_milestone
      RAISING cx_static_check.
    METHODS parse_author_association
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(author_association) TYPE zif_ghes219=>author_association
      RAISING cx_static_check.
    METHODS parse_nullable_integration
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(nullable_integration) TYPE zif_ghes219=>nullable_integration
      RAISING cx_static_check.
    METHODS parse_issue_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_simple) TYPE zif_ghes219=>issue_simple
      RAISING cx_static_check.
    METHODS parse_reaction_rollup
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(reaction_rollup) TYPE zif_ghes219=>reaction_rollup
      RAISING cx_static_check.
    METHODS parse_issue_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_comment) TYPE zif_ghes219=>issue_comment
      RAISING cx_static_check.
    METHODS parse_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(event) TYPE zif_ghes219=>event
      RAISING cx_static_check.
    METHODS parse_link_with_type
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(link_with_type) TYPE zif_ghes219=>link_with_type
      RAISING cx_static_check.
    METHODS parse_feed
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(feed) TYPE zif_ghes219=>feed
      RAISING cx_static_check.
    METHODS parse_base_gist
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(base_gist) TYPE zif_ghes219=>base_gist
      RAISING cx_static_check.
    METHODS parse_public_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(public_user) TYPE zif_ghes219=>public_user
      RAISING cx_static_check.
    METHODS parse_gist_history
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gist_history) TYPE zif_ghes219=>gist_history
      RAISING cx_static_check.
    METHODS parse_gist_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gist_simple) TYPE zif_ghes219=>gist_simple
      RAISING cx_static_check.
    METHODS parse_gist_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gist_comment) TYPE zif_ghes219=>gist_comment
      RAISING cx_static_check.
    METHODS parse_gist_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gist_commit) TYPE zif_ghes219=>gist_commit
      RAISING cx_static_check.
    METHODS parse_gitignore_template
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gitignore_template) TYPE zif_ghes219=>gitignore_template
      RAISING cx_static_check.
    METHODS parse_issue
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue) TYPE zif_ghes219=>issue
      RAISING cx_static_check.
    METHODS parse_license_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(license_simple) TYPE zif_ghes219=>license_simple
      RAISING cx_static_check.
    METHODS parse_license
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(license) TYPE zif_ghes219=>license
      RAISING cx_static_check.
    METHODS parse_api_overview
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(api_overview) TYPE zif_ghes219=>api_overview
      RAISING cx_static_check.
    METHODS parse_nullable_repository
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(nullable_repository) TYPE zif_ghes219=>nullable_repository
      RAISING cx_static_check.
    METHODS parse_minimal_repository
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(minimal_repository) TYPE zif_ghes219=>minimal_repository
      RAISING cx_static_check.
    METHODS parse_thread
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(thread) TYPE zif_ghes219=>thread
      RAISING cx_static_check.
    METHODS parse_thread_subscription
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(thread_subscription) TYPE zif_ghes219=>thread_subscription
      RAISING cx_static_check.
    METHODS parse_organization_full
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(organization_full) TYPE zif_ghes219=>organization_full
      RAISING cx_static_check.
    METHODS parse_org_hook
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(org_hook) TYPE zif_ghes219=>org_hook
      RAISING cx_static_check.
    METHODS parse_webhook_config_url
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(webhook_config_url) TYPE zif_ghes219=>webhook_config_url
      RAISING cx_static_check.
    METHODS parse_webhook_config_content_t
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(webhook_config_content_type) TYPE zif_ghes219=>webhook_config_content_type
      RAISING cx_static_check.
    METHODS parse_webhook_config_secret
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(webhook_config_secret) TYPE zif_ghes219=>webhook_config_secret
      RAISING cx_static_check.
    METHODS parse_webhook_config_insecure_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(webhook_config_insecure_ssl) TYPE zif_ghes219=>webhook_config_insecure_ssl
      RAISING cx_static_check.
    METHODS parse_org_membership
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(org_membership) TYPE zif_ghes219=>org_membership
      RAISING cx_static_check.
    METHODS parse_org_pre_receive_hook
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(org_pre_receive_hook) TYPE zif_ghes219=>org_pre_receive_hook
      RAISING cx_static_check.
    METHODS parse_project
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(project) TYPE zif_ghes219=>project
      RAISING cx_static_check.
    METHODS parse_nullable_team_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(nullable_team_simple) TYPE zif_ghes219=>nullable_team_simple
      RAISING cx_static_check.
    METHODS parse_team
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team) TYPE zif_ghes219=>team
      RAISING cx_static_check.
    METHODS parse_team_full
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_full) TYPE zif_ghes219=>team_full
      RAISING cx_static_check.
    METHODS parse_project_card
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(project_card) TYPE zif_ghes219=>project_card
      RAISING cx_static_check.
    METHODS parse_project_column
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(project_column) TYPE zif_ghes219=>project_column
      RAISING cx_static_check.
    METHODS parse_repository_collaborator_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repository_collaborator_permis) TYPE zif_ghes219=>repository_collaborator_permis
      RAISING cx_static_check.
    METHODS parse_rate_limit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(rate_limit) TYPE zif_ghes219=>rate_limit
      RAISING cx_static_check.
    ...
    METHODS parse_protected_branch_admin_e
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(protected_branch_admin_enforce) TYPE zif_ghes219=>protected_branch_admin_enforce
      RAISING cx_static_check.
    METHODS parse_protected_branch_pull_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(protected_branch_pull_request_) TYPE zif_ghes219=>protected_branch_pull_request_
      RAISING cx_static_check.
    METHODS parse_branch_restriction_polic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(branch_restriction_policy) TYPE zif_ghes219=>branch_restriction_policy
      RAISING cx_static_check.
    METHODS parse_branch_protection
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(branch_protection) TYPE zif_ghes219=>branch_protection
      RAISING cx_static_check.
    METHODS parse_short_branch
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(short_branch) TYPE zif_ghes219=>short_branch
      RAISING cx_static_check.
    METHODS parse_nullable_git_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(nullable_git_user) TYPE zif_ghes219=>nullable_git_user
      RAISING cx_static_check.
    METHODS parse_verification
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(verification) TYPE zif_ghes219=>verification
      RAISING cx_static_check.
    METHODS parse_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(commit) TYPE zif_ghes219=>commit
      RAISING cx_static_check.
    METHODS parse_branch_with_protection
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(branch_with_protection) TYPE zif_ghes219=>branch_with_protection
      RAISING cx_static_check.
    METHODS parse_status_check_policy
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(status_check_policy) TYPE zif_ghes219=>status_check_policy
      RAISING cx_static_check.
    METHODS parse_protected_branch
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(protected_branch) TYPE zif_ghes219=>protected_branch
      RAISING cx_static_check.
    METHODS parse_pull_request_minimal
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_minimal) TYPE zif_ghes219=>pull_request_minimal
      RAISING cx_static_check.
    METHODS parse_deployment_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(deployment_simple) TYPE zif_ghes219=>deployment_simple
      RAISING cx_static_check.
    METHODS parse_check_run
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(check_run) TYPE zif_ghes219=>check_run
      RAISING cx_static_check.
    METHODS parse_check_annotation
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(check_annotation) TYPE zif_ghes219=>check_annotation
      RAISING cx_static_check.
    METHODS parse_simple_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(simple_commit) TYPE zif_ghes219=>simple_commit
      RAISING cx_static_check.
    METHODS parse_check_suite
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(check_suite) TYPE zif_ghes219=>check_suite
      RAISING cx_static_check.
    METHODS parse_check_suite_preference
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(check_suite_preference) TYPE zif_ghes219=>check_suite_preference
      RAISING cx_static_check.
    METHODS parse_collaborator
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(collaborator) TYPE zif_ghes219=>collaborator
      RAISING cx_static_check.
    METHODS parse_repository_invitation
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repository_invitation) TYPE zif_ghes219=>repository_invitation
      RAISING cx_static_check.
    METHODS parse_commit_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(commit_comment) TYPE zif_ghes219=>commit_comment
      RAISING cx_static_check.
    METHODS parse_reaction
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(reaction) TYPE zif_ghes219=>reaction
      RAISING cx_static_check.
    METHODS parse_scim_error
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(scim_error) TYPE zif_ghes219=>scim_error
      RAISING cx_static_check.
    METHODS parse_branch_short
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(branch_short) TYPE zif_ghes219=>branch_short
      RAISING cx_static_check.
    METHODS parse_link
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(link) TYPE zif_ghes219=>link
      RAISING cx_static_check.
    METHODS parse_pull_request_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_simple) TYPE zif_ghes219=>pull_request_simple
      RAISING cx_static_check.
    METHODS parse_simple_commit_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(simple_commit_status) TYPE zif_ghes219=>simple_commit_status
      RAISING cx_static_check.
    METHODS parse_combined_commit_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(combined_commit_status) TYPE zif_ghes219=>combined_commit_status
      RAISING cx_static_check.
    METHODS parse_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(status) TYPE zif_ghes219=>status
      RAISING cx_static_check.
    METHODS parse_diff_entry
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(diff_entry) TYPE zif_ghes219=>diff_entry
      RAISING cx_static_check.
    ...
    METHODS parse_content_directory
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_directory) TYPE zif_ghes219=>content_directory
      RAISING cx_static_check.
    METHODS parse_content_file
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_file) TYPE zif_ghes219=>content_file
      RAISING cx_static_check.
    METHODS parse_content_symlink
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_symlink) TYPE zif_ghes219=>content_symlink
      RAISING cx_static_check.
    METHODS parse_content_submodule
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_submodule) TYPE zif_ghes219=>content_submodule
      RAISING cx_static_check.
    METHODS parse_file_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(file_commit) TYPE zif_ghes219=>file_commit
      RAISING cx_static_check.
    METHODS parse_contributor
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(contributor) TYPE zif_ghes219=>contributor
      RAISING cx_static_check.
    METHODS parse_deployment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(deployment) TYPE zif_ghes219=>deployment
      RAISING cx_static_check.
    METHODS parse_deployment_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(deployment_status) TYPE zif_ghes219=>deployment_status
      RAISING cx_static_check.
    METHODS parse_short_blob
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(short_blob) TYPE zif_ghes219=>short_blob
      RAISING cx_static_check.
    METHODS parse_blob
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(blob) TYPE zif_ghes219=>blob
      RAISING cx_static_check.
    METHODS parse_git_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_commit) TYPE zif_ghes219=>git_commit
      RAISING cx_static_check.
    METHODS parse_git_ref
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_ref) TYPE zif_ghes219=>git_ref
      RAISING cx_static_check.
    METHODS parse_git_tag
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_tag) TYPE zif_ghes219=>git_tag
      RAISING cx_static_check.
    METHODS parse_git_tree
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_tree) TYPE zif_ghes219=>git_tree
      RAISING cx_static_check.
    METHODS parse_hook_response
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(hook_response) TYPE zif_ghes219=>hook_response
      RAISING cx_static_check.
    METHODS parse_hook
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(hook) TYPE zif_ghes219=>hook
      RAISING cx_static_check.
    METHODS parse_issue_event_label
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_label) TYPE zif_ghes219=>issue_event_label
      RAISING cx_static_check.
    METHODS parse_issue_event_dismissed_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_dismissed_review) TYPE zif_ghes219=>issue_event_dismissed_review
      RAISING cx_static_check.
    METHODS parse_issue_event_milestone
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_milestone) TYPE zif_ghes219=>issue_event_milestone
      RAISING cx_static_check.
    METHODS parse_issue_event_project_card
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_project_card) TYPE zif_ghes219=>issue_event_project_card
      RAISING cx_static_check.
    METHODS parse_issue_event_rename
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_rename) TYPE zif_ghes219=>issue_event_rename
      RAISING cx_static_check.
    METHODS parse_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event) TYPE zif_ghes219=>issue_event
      RAISING cx_static_check.
    METHODS parse_labeled_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(labeled_issue_event) TYPE zif_ghes219=>labeled_issue_event
      RAISING cx_static_check.
    METHODS parse_unlabeled_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(unlabeled_issue_event) TYPE zif_ghes219=>unlabeled_issue_event
      RAISING cx_static_check.
    METHODS parse_assigned_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(assigned_issue_event) TYPE zif_ghes219=>assigned_issue_event
      RAISING cx_static_check.
    METHODS parse_unassigned_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(unassigned_issue_event) TYPE zif_ghes219=>unassigned_issue_event
      RAISING cx_static_check.
    METHODS parse_milestoned_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(milestoned_issue_event) TYPE zif_ghes219=>milestoned_issue_event
      RAISING cx_static_check.
    METHODS parse_demilestoned_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(demilestoned_issue_event) TYPE zif_ghes219=>demilestoned_issue_event
      RAISING cx_static_check.
    METHODS parse_renamed_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(renamed_issue_event) TYPE zif_ghes219=>renamed_issue_event
      RAISING cx_static_check.
    METHODS parse_review_requested_issue_e
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(review_requested_issue_event) TYPE zif_ghes219=>review_requested_issue_event
      RAISING cx_static_check.
    METHODS parse_review_request_removed_i
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(review_request_removed_issue_e) TYPE zif_ghes219=>review_request_removed_issue_e
      RAISING cx_static_check.
    METHODS parse_review_dismissed_issue_e
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(review_dismissed_issue_event) TYPE zif_ghes219=>review_dismissed_issue_event
      RAISING cx_static_check.
    METHODS parse_locked_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(locked_issue_event) TYPE zif_ghes219=>locked_issue_event
      RAISING cx_static_check.
    METHODS parse_added_to_project_issue_e
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(added_to_project_issue_event) TYPE zif_ghes219=>added_to_project_issue_event
      RAISING cx_static_check.
    METHODS parse_moved_column_in_project_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(moved_column_in_project_issue_) TYPE zif_ghes219=>moved_column_in_project_issue_
      RAISING cx_static_check.
    METHODS parse_removed_from_project_iss
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(removed_from_project_issue_eve) TYPE zif_ghes219=>removed_from_project_issue_eve
      RAISING cx_static_check.
    METHODS parse_converted_note_to_issue_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(converted_note_to_issue_issue_) TYPE zif_ghes219=>converted_note_to_issue_issue_
      RAISING cx_static_check.
    METHODS parse_issue_event_for_issue
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_for_issue) TYPE zif_ghes219=>issue_event_for_issue
      RAISING cx_static_check.
    METHODS parse_timeline_comment_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_comment_event) TYPE zif_ghes219=>timeline_comment_event
      RAISING cx_static_check.
    METHODS parse_timeline_cross_reference
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_cross_referenced_even) TYPE zif_ghes219=>timeline_cross_referenced_even
      RAISING cx_static_check.
    METHODS parse_timeline_committed_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_committed_event) TYPE zif_ghes219=>timeline_committed_event
      RAISING cx_static_check.
    METHODS parse_timeline_reviewed_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_reviewed_event) TYPE zif_ghes219=>timeline_reviewed_event
      RAISING cx_static_check.
    METHODS parse_pull_request_review_comm
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_review_comment) TYPE zif_ghes219=>pull_request_review_comment
      RAISING cx_static_check.
    METHODS parse_timeline_line_commented_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_line_commented_event) TYPE zif_ghes219=>timeline_line_commented_event
      RAISING cx_static_check.
    METHODS parse_timeline_commit_commente
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_commit_commented_even) TYPE zif_ghes219=>timeline_commit_commented_even
      RAISING cx_static_check.
    METHODS parse_timeline_assigned_issue_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_assigned_issue_event) TYPE zif_ghes219=>timeline_assigned_issue_event
      RAISING cx_static_check.
    METHODS parse_timeline_unassigned_issu
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_unassigned_issue_even) TYPE zif_ghes219=>timeline_unassigned_issue_even
      RAISING cx_static_check.
    METHODS parse_timeline_issue_events
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_issue_events) TYPE zif_ghes219=>timeline_issue_events
      RAISING cx_static_check.
    METHODS parse_deploy_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(deploy_key) TYPE zif_ghes219=>deploy_key
      RAISING cx_static_check.
    METHODS parse_language
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(language) TYPE zif_ghes219=>language
      RAISING cx_static_check.
    METHODS parse_license_content
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(license_content) TYPE zif_ghes219=>license_content
      RAISING cx_static_check.
    METHODS parse_milestone
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(milestone) TYPE zif_ghes219=>milestone
      RAISING cx_static_check.
    METHODS parse_pages_source_hash
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pages_source_hash) TYPE zif_ghes219=>pages_source_hash
      RAISING cx_static_check.
    METHODS parse_pages_https_certificate
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pages_https_certificate) TYPE zif_ghes219=>pages_https_certificate
      RAISING cx_static_check.
    METHODS parse_page
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(page) TYPE zif_ghes219=>page
      RAISING cx_static_check.
    METHODS parse_page_build
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(page_build) TYPE zif_ghes219=>page_build
      RAISING cx_static_check.
    METHODS parse_page_build_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(page_build_status) TYPE zif_ghes219=>page_build_status
      RAISING cx_static_check.
    METHODS parse_repository_pre_receive_h
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repository_pre_receive_hook) TYPE zif_ghes219=>repository_pre_receive_hook
      RAISING cx_static_check.
    METHODS parse_team_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_simple) TYPE zif_ghes219=>team_simple
      RAISING cx_static_check.
    METHODS parse_pull_request
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request) TYPE zif_ghes219=>pull_request
      RAISING cx_static_check.
    METHODS parse_legacy_review_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(legacy_review_comment) TYPE zif_ghes219=>legacy_review_comment
      RAISING cx_static_check.
    METHODS parse_pull_request_merge_resul
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_merge_result) TYPE zif_ghes219=>pull_request_merge_result
      RAISING cx_static_check.
    METHODS parse_pull_request_review_requ
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_review_request) TYPE zif_ghes219=>pull_request_review_request
      RAISING cx_static_check.
    METHODS parse_pull_request_review
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_review) TYPE zif_ghes219=>pull_request_review
      RAISING cx_static_check.
    METHODS parse_review_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(review_comment) TYPE zif_ghes219=>review_comment
      RAISING cx_static_check.
    METHODS parse_release_asset
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(release_asset) TYPE zif_ghes219=>release_asset
      RAISING cx_static_check.
    METHODS parse_release
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(release) TYPE zif_ghes219=>release
      RAISING cx_static_check.
    METHODS parse_stargazer
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(stargazer) TYPE zif_ghes219=>stargazer
      RAISING cx_static_check.
    METHODS parse_code_frequency_stat
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_frequency_stat) TYPE zif_ghes219=>code_frequency_stat
      RAISING cx_static_check.
    METHODS parse_commit_activity
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(commit_activity) TYPE zif_ghes219=>commit_activity
      RAISING cx_static_check.
    METHODS parse_contributor_activity
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(contributor_activity) TYPE zif_ghes219=>contributor_activity
      RAISING cx_static_check.
    METHODS parse_participation_stats
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(participation_stats) TYPE zif_ghes219=>participation_stats
      RAISING cx_static_check.
    METHODS parse_repository_subscription
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repository_subscription) TYPE zif_ghes219=>repository_subscription
      RAISING cx_static_check.
    METHODS parse_tag
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(tag) TYPE zif_ghes219=>tag
      RAISING cx_static_check.
    METHODS parse_topic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(topic) TYPE zif_ghes219=>topic
      RAISING cx_static_check.
    METHODS parse_search_result_text_match
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(search_result_text_matches) TYPE zif_ghes219=>search_result_text_matches
      RAISING cx_static_check.
    METHODS parse_code_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_search_result_item) TYPE zif_ghes219=>code_search_result_item
      RAISING cx_static_check.
    METHODS parse_commit_search_result_ite
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(commit_search_result_item) TYPE zif_ghes219=>commit_search_result_item
      RAISING cx_static_check.
    METHODS parse_issue_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_search_result_item) TYPE zif_ghes219=>issue_search_result_item
      RAISING cx_static_check.
    METHODS parse_label_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(label_search_result_item) TYPE zif_ghes219=>label_search_result_item
      RAISING cx_static_check.
    METHODS parse_repo_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repo_search_result_item) TYPE zif_ghes219=>repo_search_result_item
      RAISING cx_static_check.
    METHODS parse_topic_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(topic_search_result_item) TYPE zif_ghes219=>topic_search_result_item
      RAISING cx_static_check.
    METHODS parse_user_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(user_search_result_item) TYPE zif_ghes219=>user_search_result_item
      RAISING cx_static_check.
    METHODS parse_configuration_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(configuration_status) TYPE zif_ghes219=>configuration_status
      RAISING cx_static_check.
    METHODS parse_maintenance_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(maintenance_status) TYPE zif_ghes219=>maintenance_status
      RAISING cx_static_check.
    METHODS parse_enterprise_settings
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_settings) TYPE zif_ghes219=>enterprise_settings
      RAISING cx_static_check.
    METHODS parse_ssh_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(ssh_key) TYPE zif_ghes219=>ssh_key
      RAISING cx_static_check.
    METHODS parse_team_discussion
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_discussion) TYPE zif_ghes219=>team_discussion
      RAISING cx_static_check.
    METHODS parse_team_discussion_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_discussion_comment) TYPE zif_ghes219=>team_discussion_comment
      RAISING cx_static_check.
    METHODS parse_team_membership
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_membership) TYPE zif_ghes219=>team_membership
      RAISING cx_static_check.
    METHODS parse_team_project
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_project) TYPE zif_ghes219=>team_project
      RAISING cx_static_check.
    METHODS parse_team_2
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_2) TYPE zif_ghes219=>team_2
      RAISING cx_static_check.
    METHODS parse_private_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(private_user) TYPE zif_ghes219=>private_user
      RAISING cx_static_check.
    METHODS parse_email
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(email) TYPE zif_ghes219=>email
      RAISING cx_static_check.
    METHODS parse_gpg_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gpg_key) TYPE zif_ghes219=>gpg_key
      RAISING cx_static_check.
    METHODS parse_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(key) TYPE zif_ghes219=>key
      RAISING cx_static_check.
    METHODS parse_starred_repository
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(starred_repository) TYPE zif_ghes219=>starred_repository
      RAISING cx_static_check.
    METHODS parse_hovercard
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(hovercard) TYPE zif_ghes219=>hovercard
      RAISING cx_static_check.
    ...
    METHODS json_enterprise_admin_update_g
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_update_gl
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete_g
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_delete_gl
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_l
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_update_ld
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update01
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_update_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_o
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_create_or
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_o
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_update_or
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_p
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_create_pr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_p
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_update_pr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete_p
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_delete_pr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create01
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_create_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update02
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_update_02
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete01
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_delete_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_u
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_create_us
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_u
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_update_us
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete_u
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_delete_us
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_i
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_create_im
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete_i
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_delete_im
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_create_from_manifest
      IMPORTING data TYPE zif_ghes219=>bodyapps_create_from_manifest
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_create_installation_
      IMPORTING data TYPE zif_ghes219=>bodyapps_create_installation_a
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_create
      IMPORTING data TYPE zif_ghes219=>bodygists_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_update
      IMPORTING data TYPE zif_ghes219=>bodygists_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_delete
      IMPORTING data TYPE zif_ghes219=>bodygists_delete
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_create_comment
      IMPORTING data TYPE zif_ghes219=>bodygists_create_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_update_comment
      IMPORTING data TYPE zif_ghes219=>bodygists_update_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_delete_comment
      IMPORTING data TYPE zif_ghes219=>bodygists_delete_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_markdown_render
      IMPORTING data TYPE zif_ghes219=>bodymarkdown_render
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_mark_notificatio
      IMPORTING data TYPE zif_ghes219=>bodyactivity_mark_notification
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_set_thread_subsc
      IMPORTING data TYPE zif_ghes219=>bodyactivity_set_thread_subscr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_delete_thread_su
      IMPORTING data TYPE zif_ghes219=>bodyactivity_delete_thread_sub
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_update
      IMPORTING data TYPE zif_ghes219=>bodyorgs_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_create_webhook
      IMPORTING data TYPE zif_ghes219=>bodyorgs_create_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_update_webhook
      IMPORTING data TYPE zif_ghes219=>bodyorgs_update_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_delete_webhook
      IMPORTING data TYPE zif_ghes219=>bodyorgs_delete_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_set_membership_for_u
      IMPORTING data TYPE zif_ghes219=>bodyorgs_set_membership_for_us
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_remove_membership_fo
      IMPORTING data TYPE zif_ghes219=>bodyorgs_remove_membership_for
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update03
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_update_03
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_remove_p
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_remove_pr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_for_org
      IMPORTING data TYPE zif_ghes219=>bodyprojects_create_for_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_in_org
      IMPORTING data TYPE zif_ghes219=>bodyrepos_create_in_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create
      IMPORTING data TYPE zif_ghes219=>bodyteams_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_update_card
      IMPORTING data TYPE zif_ghes219=>bodyprojects_update_card
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_delete_card
      IMPORTING data TYPE zif_ghes219=>bodyprojects_delete_card
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_move_card
      IMPORTING data TYPE zif_ghes219=>bodyprojects_move_card
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_update_column
      IMPORTING data TYPE zif_ghes219=>bodyprojects_update_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_delete_column
      IMPORTING data TYPE zif_ghes219=>bodyprojects_delete_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_move_column
      IMPORTING data TYPE zif_ghes219=>bodyprojects_move_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_update
      IMPORTING data TYPE zif_ghes219=>bodyprojects_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_delete
      IMPORTING data TYPE zif_ghes219=>bodyprojects_delete
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_add_collaborator
      IMPORTING data TYPE zif_ghes219=>bodyprojects_add_collaborator
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_remove_collabora
      IMPORTING data TYPE zif_ghes219=>bodyprojects_remove_collaborat
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_column
      IMPORTING data TYPE zif_ghes219=>bodyprojects_create_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update
      IMPORTING data TYPE zif_ghes219=>bodyrepos_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete
      IMPORTING data TYPE zif_ghes219=>bodyrepos_delete
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_branch_prote
      IMPORTING data TYPE zif_ghes219=>bodyrepos_update_branch_protec
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_branch_prote
      IMPORTING data TYPE zif_ghes219=>bodyrepos_delete_branch_protec
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_pull_request
      IMPORTING data TYPE zif_ghes219=>bodyrepos_update_pull_request_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_pull_request
      IMPORTING data TYPE zif_ghes219=>bodyrepos_delete_pull_request_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_status_check
      IMPORTING data TYPE zif_ghes219=>bodyrepos_update_status_check_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_remove_status_check
      IMPORTING data TYPE zif_ghes219=>bodyrepos_remove_status_check_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_create
      IMPORTING data TYPE zif_ghes219=>bodychecks_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_update
      IMPORTING data TYPE zif_ghes219=>bodychecks_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_create_suite
      IMPORTING data TYPE zif_ghes219=>bodychecks_create_suite
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_set_suites_prefere
      IMPORTING data TYPE zif_ghes219=>bodychecks_set_suites_preferen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_add_collaborator
      IMPORTING data TYPE zif_ghes219=>bodyrepos_add_collaborator
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_remove_collaborator
      IMPORTING data TYPE zif_ghes219=>bodyrepos_remove_collaborator
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_commit_comme
      IMPORTING data TYPE zif_ghes219=>bodyrepos_update_commit_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_commit_comme
      IMPORTING data TYPE zif_ghes219=>bodyrepos_delete_commit_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_comm
      IMPORTING data TYPE zif_ghes219=>bodyreactions_create_for_commi
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_repos_create_or_update_fi
      IMPORTING data TYPE zif_ghes219=>bodyrepos_create_or_update_fil
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_file
      IMPORTING data TYPE zif_ghes219=>bodyrepos_delete_file
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_deployment
      IMPORTING data TYPE zif_ghes219=>bodyrepos_create_deployment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_deployment_s
      IMPORTING data TYPE zif_ghes219=>bodyrepos_create_deployment_st
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_fork
      IMPORTING data TYPE zif_ghes219=>bodyrepos_create_fork
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_blob
      IMPORTING data TYPE zif_ghes219=>bodygit_create_blob
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_commit
      IMPORTING data TYPE zif_ghes219=>bodygit_create_commit
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_ref
      IMPORTING data TYPE zif_ghes219=>bodygit_create_ref
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_update_ref
      IMPORTING data TYPE zif_ghes219=>bodygit_update_ref
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_delete_ref
      IMPORTING data TYPE zif_ghes219=>bodygit_delete_ref
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_tag
      IMPORTING data TYPE zif_ghes219=>bodygit_create_tag
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_tree
      IMPORTING data TYPE zif_ghes219=>bodygit_create_tree
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_webhook
      IMPORTING data TYPE zif_ghes219=>bodyrepos_create_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_webhook
      IMPORTING data TYPE zif_ghes219=>bodyrepos_update_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_webhook
      IMPORTING data TYPE zif_ghes219=>bodyrepos_delete_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_invitation
      IMPORTING data TYPE zif_ghes219=>bodyrepos_update_invitation
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_invitation
      IMPORTING data TYPE zif_ghes219=>bodyrepos_delete_invitation
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create
      IMPORTING data TYPE zif_ghes219=>bodyissues_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update_comment
      IMPORTING data TYPE zif_ghes219=>bodyissues_update_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_delete_comment
      IMPORTING data TYPE zif_ghes219=>bodyissues_delete_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_issu
      IMPORTING data TYPE zif_ghes219=>bodyreactions_create_for_issue
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update
      IMPORTING data TYPE zif_ghes219=>bodyissues_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_add_assignees
      IMPORTING data TYPE zif_ghes219=>bodyissues_add_assignees
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_remove_assignees
      IMPORTING data TYPE zif_ghes219=>bodyissues_remove_assignees
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create_comment
      IMPORTING data TYPE zif_ghes219=>bodyissues_create_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_lock
      IMPORTING data TYPE zif_ghes219=>bodyissues_lock
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_unlock
      IMPORTING data TYPE zif_ghes219=>bodyissues_unlock
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_is01
      IMPORTING data TYPE zif_ghes219=>bodyreactions_create_for_iss01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_deploy_key
      IMPORTING data TYPE zif_ghes219=>bodyrepos_create_deploy_key
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create_label
      IMPORTING data TYPE zif_ghes219=>bodyissues_create_label
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update_label
      IMPORTING data TYPE zif_ghes219=>bodyissues_update_label
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_delete_label
      IMPORTING data TYPE zif_ghes219=>bodyissues_delete_label
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_merge
      IMPORTING data TYPE zif_ghes219=>bodyrepos_merge
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create_milestone
      IMPORTING data TYPE zif_ghes219=>bodyissues_create_milestone
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update_milestone
      IMPORTING data TYPE zif_ghes219=>bodyissues_update_milestone
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_delete_milestone
      IMPORTING data TYPE zif_ghes219=>bodyissues_delete_milestone
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_mark_repo_notifi
      IMPORTING data TYPE zif_ghes219=>bodyactivity_mark_repo_notific
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_pages_site
      IMPORTING data TYPE zif_ghes219=>bodyrepos_create_pages_site
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_information_
      IMPORTING data TYPE zif_ghes219=>bodyrepos_update_information_a
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_pages_site
      IMPORTING data TYPE zif_ghes219=>bodyrepos_delete_pages_site
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update04
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_update_04
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_remove01
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_remove_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_for_repo
      IMPORTING data TYPE zif_ghes219=>bodyprojects_create_for_repo
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create
      IMPORTING data TYPE zif_ghes219=>bodypulls_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update_review_comme
      IMPORTING data TYPE zif_ghes219=>bodypulls_update_review_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_delete_review_comme
      IMPORTING data TYPE zif_ghes219=>bodypulls_delete_review_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_pull
      IMPORTING data TYPE zif_ghes219=>bodyreactions_create_for_pull_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update
      IMPORTING data TYPE zif_ghes219=>bodypulls_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create_review_comme
      IMPORTING data TYPE zif_ghes219=>bodypulls_create_review_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create_reply_for_re
      IMPORTING data TYPE zif_ghes219=>bodypulls_create_reply_for_rev
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_merge
      IMPORTING data TYPE zif_ghes219=>bodypulls_merge
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_request_reviewers
      IMPORTING data TYPE zif_ghes219=>bodypulls_request_reviewers
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_remove_requested_re
      IMPORTING data TYPE zif_ghes219=>bodypulls_remove_requested_rev
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create_review
      IMPORTING data TYPE zif_ghes219=>bodypulls_create_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update_review
      IMPORTING data TYPE zif_ghes219=>bodypulls_update_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_delete_pending_revi
      IMPORTING data TYPE zif_ghes219=>bodypulls_delete_pending_revie
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_dismiss_review
      IMPORTING data TYPE zif_ghes219=>bodypulls_dismiss_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_submit_review
      IMPORTING data TYPE zif_ghes219=>bodypulls_submit_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update_branch
      IMPORTING data TYPE zif_ghes219=>bodypulls_update_branch
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_release
      IMPORTING data TYPE zif_ghes219=>bodyrepos_create_release
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_release_asse
      IMPORTING data TYPE zif_ghes219=>bodyrepos_update_release_asset
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_release_asse
      IMPORTING data TYPE zif_ghes219=>bodyrepos_delete_release_asset
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_release
      IMPORTING data TYPE zif_ghes219=>bodyrepos_update_release
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_release
      IMPORTING data TYPE zif_ghes219=>bodyrepos_delete_release
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_commit_statu
      IMPORTING data TYPE zif_ghes219=>bodyrepos_create_commit_status
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_set_repo_subscri
      IMPORTING data TYPE zif_ghes219=>bodyactivity_set_repo_subscrip
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_delete_repo_subs
      IMPORTING data TYPE zif_ghes219=>bodyactivity_delete_repo_subsc
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_replace_all_topics
      IMPORTING data TYPE zif_ghes219=>bodyrepos_replace_all_topics
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_transfer
      IMPORTING data TYPE zif_ghes219=>bodyrepos_transfer
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_using_templa
      IMPORTING data TYPE zif_ghes219=>bodyrepos_create_using_templat
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update
      IMPORTING data TYPE zif_ghes219=>bodyteams_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete
      IMPORTING data TYPE zif_ghes219=>bodyteams_delete
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_discussion
      IMPORTING data TYPE zif_ghes219=>bodyteams_create_discussion
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_discussion
      IMPORTING data TYPE zif_ghes219=>bodyteams_update_discussion
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_discussion
      IMPORTING data TYPE zif_ghes219=>bodyteams_delete_discussion
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_discussion_c
      IMPORTING data TYPE zif_ghes219=>bodyteams_create_discussion_co
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_discussion_c
      IMPORTING data TYPE zif_ghes219=>bodyteams_update_discussion_co
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_discussion_c
      IMPORTING data TYPE zif_ghes219=>bodyteams_delete_discussion_co
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_team
      IMPORTING data TYPE zif_ghes219=>bodyreactions_create_for_team_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_te01
      IMPORTING data TYPE zif_ghes219=>bodyreactions_create_for_tea01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_membe
      IMPORTING data TYPE zif_ghes219=>bodyteams_add_or_update_member
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_membership_f
      IMPORTING data TYPE zif_ghes219=>bodyteams_remove_membership_fo
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_proje
      IMPORTING data TYPE zif_ghes219=>bodyteams_add_or_update_projec
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_project
      IMPORTING data TYPE zif_ghes219=>bodyteams_remove_project
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_repo_
      IMPORTING data TYPE zif_ghes219=>bodyteams_add_or_update_repo_p
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_repo
      IMPORTING data TYPE zif_ghes219=>bodyteams_remove_repo
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_users_update_authenticate
      IMPORTING data TYPE zif_ghes219=>bodyusers_update_authenticated
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_users_create_gpg_key_for_
      IMPORTING data TYPE zif_ghes219=>bodyusers_create_gpg_key_for_a
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_users_create_public_ssh_k
      IMPORTING data TYPE zif_ghes219=>bodyusers_create_public_ssh_ke
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_update_membership_fo
      IMPORTING data TYPE zif_ghes219=>bodyorgs_update_membership_for
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_for_authe
      IMPORTING data TYPE zif_ghes219=>bodyprojects_create_for_authen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_for_authenti
      IMPORTING data TYPE zif_ghes219=>bodyrepos_create_for_authentic
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_suspend_
      IMPORTING data TYPE zif_ghes219=>bodyenterprise_admin_suspend_u
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS parse_meta_root
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_meta_root) TYPE zif_ghes219=>response_meta_root
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_list_gl
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_list) TYPE zif_ghes219=>response_enterprise_admin_list
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_list_pu
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_li01) TYPE zif_ghes219=>response_enterprise_admin_li01
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_sync_ld
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_sync) TYPE zif_ghes219=>response_enterprise_admin_sync
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_sync_01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_sy01) TYPE zif_ghes219=>response_enterprise_admin_sy01
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_update_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_upda) TYPE zif_ghes219=>response_enterprise_admin_upda
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_list_pr
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_li02) TYPE zif_ghes219=>response_enterprise_admin_li02
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_updat01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_up01) TYPE zif_ghes219=>response_enterprise_admin_up01
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_delete_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_dele) TYPE zif_ghes219=>response_enterprise_admin_dele
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_start_p
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_star) TYPE zif_ghes219=>response_enterprise_admin_star
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_list_01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_li03) TYPE zif_ghes219=>response_enterprise_admin_li03
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_list_pe
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_li04) TYPE zif_ghes219=>response_enterprise_admin_li04
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_updat02
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_up02) TYPE zif_ghes219=>response_enterprise_admin_up02
      RAISING cx_static_check.
    METHODS parse_apps_list_installations
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_apps_list_installatio) TYPE zif_ghes219=>response_apps_list_installatio
      RAISING cx_static_check.
    METHODS parse_codes_of_conduct_get_all
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_codes_of_conduct_get_) TYPE zif_ghes219=>response_codes_of_conduct_get_
      RAISING cx_static_check.
    METHODS parse_emojis_get
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_emojis_get) TYPE zif_ghes219=>response_emojis_get
      RAISING cx_static_check.
    METHODS parse_activity_list_public_eve
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_public_) TYPE zif_ghes219=>response_activity_list_public_
      RAISING cx_static_check.
    METHODS parse_gists_list
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list) TYPE zif_ghes219=>response_gists_list
      RAISING cx_static_check.
    METHODS parse_gists_list_public
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_public) TYPE zif_ghes219=>response_gists_list_public
      RAISING cx_static_check.
    METHODS parse_gists_list_starred
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_starred) TYPE zif_ghes219=>response_gists_list_starred
      RAISING cx_static_check.
    METHODS parse_gists_list_comments
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_comments) TYPE zif_ghes219=>response_gists_list_comments
      RAISING cx_static_check.
    METHODS parse_gists_list_commits
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_commits) TYPE zif_ghes219=>response_gists_list_commits
      RAISING cx_static_check.
    METHODS parse_gists_list_forks
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_forks) TYPE zif_ghes219=>response_gists_list_forks
      RAISING cx_static_check.
    METHODS parse_gists_check_is_starred
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_check_is_starre) TYPE zif_ghes219=>response_gists_check_is_starre
      RAISING cx_static_check.
    METHODS parse_gitignore_get_all_templa
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gitignore_get_all_tem) TYPE zif_ghes219=>response_gitignore_get_all_tem
      RAISING cx_static_check.
    METHODS parse_apps_list_repos_accessib
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_apps_list_repos_acces) TYPE zif_ghes219=>response_apps_list_repos_acces
      RAISING cx_static_check.
    METHODS parse_issues_list
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list) TYPE zif_ghes219=>response_issues_list
      RAISING cx_static_check.
    METHODS parse_licenses_get_all_commonl
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_licenses_get_all_comm) TYPE zif_ghes219=>response_licenses_get_all_comm
      RAISING cx_static_check.
    METHODS parse_activity_list_public_e01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_publi01) TYPE zif_ghes219=>response_activity_list_publi01
      RAISING cx_static_check.
    METHODS parse_activity_list_notificati
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_notific) TYPE zif_ghes219=>response_activity_list_notific
      RAISING cx_static_check.
    METHODS parse_activity_mark_notificati
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_mark_notific) TYPE zif_ghes219=>response_activity_mark_notific
      RAISING cx_static_check.
    METHODS parse_orgs_list
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list) TYPE zif_ghes219=>response_orgs_list
      RAISING cx_static_check.
    METHODS parse_activity_list_public_org
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_publi02) TYPE zif_ghes219=>response_activity_list_publi02
      RAISING cx_static_check.
    METHODS parse_orgs_list_webhooks
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_webhooks) TYPE zif_ghes219=>response_orgs_list_webhooks
      RAISING cx_static_check.
    METHODS parse_orgs_list_app_installati
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_app_install) TYPE zif_ghes219=>response_orgs_list_app_install
      RAISING cx_static_check.
    METHODS parse_issues_list_for_org
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_for_org) TYPE zif_ghes219=>response_issues_list_for_org
      RAISING cx_static_check.
    METHODS parse_orgs_list_members
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_members) TYPE zif_ghes219=>response_orgs_list_members
      RAISING cx_static_check.
    METHODS parse_orgs_list_outside_collab
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_outside_col) TYPE zif_ghes219=>response_orgs_list_outside_col
      RAISING cx_static_check.
    METHODS parse_orgs_convert_member_to_o
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_convert_member_t) TYPE zif_ghes219=>response_orgs_convert_member_t
      RAISING cx_static_check.
    METHODS parse_orgs_remove_outside_coll
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_remove_outside_c) TYPE zif_ghes219=>response_orgs_remove_outside_c
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_list_02
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_li05) TYPE zif_ghes219=>response_enterprise_admin_li05
      RAISING cx_static_check.
    METHODS parse_projects_list_for_org
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_list_for_org) TYPE zif_ghes219=>response_projects_list_for_org
      RAISING cx_static_check.
    METHODS parse_orgs_list_public_members
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_public_memb) TYPE zif_ghes219=>response_orgs_list_public_memb
      RAISING cx_static_check.
    METHODS parse_repos_list_for_org
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_for_org) TYPE zif_ghes219=>response_repos_list_for_org
      RAISING cx_static_check.
    METHODS parse_teams_list
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list) TYPE zif_ghes219=>response_teams_list
      RAISING cx_static_check.
    METHODS parse_projects_delete_card
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_delete_card) TYPE zif_ghes219=>response_projects_delete_card
      RAISING cx_static_check.
    METHODS parse_projects_move_card
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_move_card) TYPE zif_ghes219=>response_projects_move_card
      RAISING cx_static_check.
    METHODS parse_projects_move_card01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_move_card01) TYPE zif_ghes219=>response_projects_move_card01
      RAISING cx_static_check.
    METHODS parse_projects_move_card02
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_move_card02) TYPE zif_ghes219=>response_projects_move_card02
      RAISING cx_static_check.
    METHODS parse_projects_list_cards
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_list_cards) TYPE zif_ghes219=>response_projects_list_cards
      RAISING cx_static_check.
    METHODS parse_projects_create_card
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_create_card) TYPE zif_ghes219=>response_projects_create_card
      RAISING cx_static_check.
    METHODS parse_projects_move_column
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_move_column) TYPE zif_ghes219=>response_projects_move_column
      RAISING cx_static_check.
    METHODS parse_projects_update
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_update) TYPE zif_ghes219=>response_projects_update
      RAISING cx_static_check.
    METHODS parse_projects_delete
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_delete) TYPE zif_ghes219=>response_projects_delete
      RAISING cx_static_check.
    METHODS parse_projects_list_collaborat
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_list_collabo) TYPE zif_ghes219=>response_projects_list_collabo
      RAISING cx_static_check.
    METHODS parse_projects_list_columns
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_list_columns) TYPE zif_ghes219=>response_projects_list_columns
      RAISING cx_static_check.
    METHODS parse_repos_delete
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_delete) TYPE zif_ghes219=>response_repos_delete
      RAISING cx_static_check.
    METHODS parse_issues_list_assignees
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_assignees) TYPE zif_ghes219=>response_issues_list_assignees
      RAISING cx_static_check.
    METHODS parse_repos_list_branches
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_branches) TYPE zif_ghes219=>response_repos_list_branches
      RAISING cx_static_check.
    METHODS parse_repos_get_all_status_che
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_all_status_) TYPE zif_ghes219=>response_repos_get_all_status_
      RAISING cx_static_check.
    METHODS parse_repos_add_status_check_c
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_add_status_chec) TYPE zif_ghes219=>response_repos_add_status_chec
      RAISING cx_static_check.
    METHODS parse_repos_set_status_check_c
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_set_status_chec) TYPE zif_ghes219=>response_repos_set_status_chec
      RAISING cx_static_check.
    METHODS parse_repos_remove_status_chec
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_remove_status_c) TYPE zif_ghes219=>response_repos_remove_status_c
      RAISING cx_static_check.
    METHODS parse_repos_get_apps_with_acce
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_apps_with_a) TYPE zif_ghes219=>response_repos_get_apps_with_a
      RAISING cx_static_check.
    METHODS parse_repos_add_app_access_res
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_add_app_access_) TYPE zif_ghes219=>response_repos_add_app_access_
      RAISING cx_static_check.
    METHODS parse_repos_set_app_access_res
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_set_app_access_) TYPE zif_ghes219=>response_repos_set_app_access_
      RAISING cx_static_check.
    METHODS parse_repos_remove_app_access_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_remove_app_acce) TYPE zif_ghes219=>response_repos_remove_app_acce
      RAISING cx_static_check.
    METHODS parse_repos_get_teams_with_acc
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_teams_with_) TYPE zif_ghes219=>response_repos_get_teams_with_
      RAISING cx_static_check.
    METHODS parse_repos_add_team_access_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_add_team_access) TYPE zif_ghes219=>response_repos_add_team_access
      RAISING cx_static_check.
    METHODS parse_repos_set_team_access_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_set_team_access) TYPE zif_ghes219=>response_repos_set_team_access
      RAISING cx_static_check.
    METHODS parse_repos_remove_team_access
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_remove_team_acc) TYPE zif_ghes219=>response_repos_remove_team_acc
      RAISING cx_static_check.
    METHODS parse_repos_get_users_with_acc
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_users_with_) TYPE zif_ghes219=>response_repos_get_users_with_
      RAISING cx_static_check.
    METHODS parse_repos_add_user_access_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_add_user_access) TYPE zif_ghes219=>response_repos_add_user_access
      RAISING cx_static_check.
    METHODS parse_repos_set_user_access_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_set_user_access) TYPE zif_ghes219=>response_repos_set_user_access
      RAISING cx_static_check.
    METHODS parse_repos_remove_user_access
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_remove_user_acc) TYPE zif_ghes219=>response_repos_remove_user_acc
      RAISING cx_static_check.
    METHODS parse_checks_list_annotations
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_checks_list_annotatio) TYPE zif_ghes219=>response_checks_list_annotatio
      RAISING cx_static_check.
    METHODS parse_checks_list_for_suite
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_checks_list_for_suite) TYPE zif_ghes219=>response_checks_list_for_suite
      RAISING cx_static_check.
    METHODS parse_checks_rerequest_suite
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_checks_rerequest_suit) TYPE zif_ghes219=>response_checks_rerequest_suit
      RAISING cx_static_check.
    METHODS parse_repos_list_collaborators
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_collaborat) TYPE zif_ghes219=>response_repos_list_collaborat
      RAISING cx_static_check.
    METHODS parse_repos_list_commit_commen
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_commit_com) TYPE zif_ghes219=>response_repos_list_commit_com
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_commi
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_co) TYPE zif_ghes219=>response_reactions_list_for_co
      RAISING cx_static_check.
    METHODS parse_repos_list_commits
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_commits) TYPE zif_ghes219=>response_repos_list_commits
      RAISING cx_static_check.
    METHODS parse_repos_list_branches_for_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_branches_f) TYPE zif_ghes219=>response_repos_list_branches_f
      RAISING cx_static_check.
    METHODS parse_repos_list_comments_for_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_comments_f) TYPE zif_ghes219=>response_repos_list_comments_f
      RAISING cx_static_check.
    METHODS parse_repos_list_pull_requests
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_pull_reque) TYPE zif_ghes219=>response_repos_list_pull_reque
      RAISING cx_static_check.
    METHODS parse_checks_list_for_ref
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_checks_list_for_ref) TYPE zif_ghes219=>response_checks_list_for_ref
      RAISING cx_static_check.
    METHODS parse_checks_list_suites_for_r
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_checks_list_suites_fo) TYPE zif_ghes219=>response_checks_list_suites_fo
      RAISING cx_static_check.
    METHODS parse_repos_list_commit_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_commit_sta) TYPE zif_ghes219=>response_repos_list_commit_sta
      RAISING cx_static_check.
    METHODS parse_repos_list_contributors
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_contributo) TYPE zif_ghes219=>response_repos_list_contributo
      RAISING cx_static_check.
    METHODS parse_repos_list_deployments
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_deployment) TYPE zif_ghes219=>response_repos_list_deployment
      RAISING cx_static_check.
    METHODS parse_repos_create_deployment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_create_deployme) TYPE zif_ghes219=>response_repos_create_deployme
      RAISING cx_static_check.
    METHODS parse_repos_list_deployment_st
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_deployme01) TYPE zif_ghes219=>response_repos_list_deployme01
      RAISING cx_static_check.
    METHODS parse_activity_list_repo_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_repo_ev) TYPE zif_ghes219=>response_activity_list_repo_ev
      RAISING cx_static_check.
    METHODS parse_repos_list_forks
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_forks) TYPE zif_ghes219=>response_repos_list_forks
      RAISING cx_static_check.
    METHODS parse_git_list_matching_refs
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_git_list_matching_ref) TYPE zif_ghes219=>response_git_list_matching_ref
      RAISING cx_static_check.
    METHODS parse_repos_list_webhooks
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_webhooks) TYPE zif_ghes219=>response_repos_list_webhooks
      RAISING cx_static_check.
    METHODS parse_repos_list_invitations
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_invitation) TYPE zif_ghes219=>response_repos_list_invitation
      RAISING cx_static_check.
    METHODS parse_issues_list_for_repo
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_for_repo) TYPE zif_ghes219=>response_issues_list_for_repo
      RAISING cx_static_check.
    METHODS parse_issues_list_comments_for
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_comments_) TYPE zif_ghes219=>response_issues_list_comments_
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_issue
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_is) TYPE zif_ghes219=>response_reactions_list_for_is
      RAISING cx_static_check.
    METHODS parse_issues_list_events_for_r
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_events_fo) TYPE zif_ghes219=>response_issues_list_events_fo
      RAISING cx_static_check.
    METHODS parse_issues_list_comments
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_comments) TYPE zif_ghes219=>response_issues_list_comments
      RAISING cx_static_check.
    METHODS parse_issues_list_events
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_events) TYPE zif_ghes219=>response_issues_list_events
      RAISING cx_static_check.
    METHODS parse_issues_list_labels_on_is
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_labels_on) TYPE zif_ghes219=>response_issues_list_labels_on
      RAISING cx_static_check.
    METHODS parse_issues_add_labels
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_add_labels) TYPE zif_ghes219=>response_issues_add_labels
      RAISING cx_static_check.
    METHODS parse_issues_set_labels
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_set_labels) TYPE zif_ghes219=>response_issues_set_labels
      RAISING cx_static_check.
    METHODS parse_issues_remove_label
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_remove_label) TYPE zif_ghes219=>response_issues_remove_label
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_iss01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_01) TYPE zif_ghes219=>response_reactions_list_for_01
      RAISING cx_static_check.
    METHODS parse_issues_list_events_for_t
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_events_01) TYPE zif_ghes219=>response_issues_list_events_01
      RAISING cx_static_check.
    METHODS parse_repos_list_deploy_keys
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_deploy_key) TYPE zif_ghes219=>response_repos_list_deploy_key
      RAISING cx_static_check.
    METHODS parse_issues_list_labels_for_r
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_labels_fo) TYPE zif_ghes219=>response_issues_list_labels_fo
      RAISING cx_static_check.
    METHODS parse_issues_list_milestones
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_milestone) TYPE zif_ghes219=>response_issues_list_milestone
      RAISING cx_static_check.
    METHODS parse_issues_list_labels_for_m
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_labels_01) TYPE zif_ghes219=>response_issues_list_labels_01
      RAISING cx_static_check.
    METHODS parse_activity_list_repo_notif
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_repo_no) TYPE zif_ghes219=>response_activity_list_repo_no
      RAISING cx_static_check.
    METHODS parse_activity_mark_repo_notif
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_mark_repo_no) TYPE zif_ghes219=>response_activity_mark_repo_no
      RAISING cx_static_check.
    METHODS parse_repos_list_pages_builds
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_pages_buil) TYPE zif_ghes219=>response_repos_list_pages_buil
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_list_03
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_li06) TYPE zif_ghes219=>response_enterprise_admin_li06
      RAISING cx_static_check.
    METHODS parse_projects_list_for_repo
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_list_for_rep) TYPE zif_ghes219=>response_projects_list_for_rep
      RAISING cx_static_check.
    METHODS parse_pulls_list
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list) TYPE zif_ghes219=>response_pulls_list
      RAISING cx_static_check.
    METHODS parse_pulls_list_review_commen
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_review_com) TYPE zif_ghes219=>response_pulls_list_review_com
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_pull_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_pu) TYPE zif_ghes219=>response_reactions_list_for_pu
      RAISING cx_static_check.
    METHODS parse_pulls_list_review_comm01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_review_c01) TYPE zif_ghes219=>response_pulls_list_review_c01
      RAISING cx_static_check.
    METHODS parse_pulls_list_commits
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_commits) TYPE zif_ghes219=>response_pulls_list_commits
      RAISING cx_static_check.
    METHODS parse_pulls_list_files
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_files) TYPE zif_ghes219=>response_pulls_list_files
      RAISING cx_static_check.
    METHODS parse_pulls_merge
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_merge) TYPE zif_ghes219=>response_pulls_merge
      RAISING cx_static_check.
    METHODS parse_pulls_merge01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_merge01) TYPE zif_ghes219=>response_pulls_merge01
      RAISING cx_static_check.
    METHODS parse_pulls_list_reviews
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_reviews) TYPE zif_ghes219=>response_pulls_list_reviews
      RAISING cx_static_check.
    METHODS parse_pulls_list_comments_for_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_comments_f) TYPE zif_ghes219=>response_pulls_list_comments_f
      RAISING cx_static_check.
    METHODS parse_pulls_update_branch
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_update_branch) TYPE zif_ghes219=>response_pulls_update_branch
      RAISING cx_static_check.
    METHODS parse_repos_list_releases
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_releases) TYPE zif_ghes219=>response_repos_list_releases
      RAISING cx_static_check.
    METHODS parse_repos_list_release_asset
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_release_as) TYPE zif_ghes219=>response_repos_list_release_as
      RAISING cx_static_check.
    METHODS parse_repos_get_code_frequency
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_code_freque) TYPE zif_ghes219=>response_repos_get_code_freque
      RAISING cx_static_check.
    METHODS parse_repos_get_commit_activit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_commit_acti) TYPE zif_ghes219=>response_repos_get_commit_acti
      RAISING cx_static_check.
    METHODS parse_repos_get_contributors_s
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_contributor) TYPE zif_ghes219=>response_repos_get_contributor
      RAISING cx_static_check.
    METHODS parse_repos_get_punch_card_sta
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_punch_card_) TYPE zif_ghes219=>response_repos_get_punch_card_
      RAISING cx_static_check.
    METHODS parse_activity_list_watchers_f
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_watcher) TYPE zif_ghes219=>response_activity_list_watcher
      RAISING cx_static_check.
    METHODS parse_repos_list_tags
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_tags) TYPE zif_ghes219=>response_repos_list_tags
      RAISING cx_static_check.
    METHODS parse_repos_list_teams
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_teams) TYPE zif_ghes219=>response_repos_list_teams
      RAISING cx_static_check.
    METHODS parse_repos_list_public
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_public) TYPE zif_ghes219=>response_repos_list_public
      RAISING cx_static_check.
    METHODS parse_search_code
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_code) TYPE zif_ghes219=>response_search_code
      RAISING cx_static_check.
    METHODS parse_search_commits
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_commits) TYPE zif_ghes219=>response_search_commits
      RAISING cx_static_check.
    METHODS parse_search_issues_and_pull_r
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_issues_and_pul) TYPE zif_ghes219=>response_search_issues_and_pul
      RAISING cx_static_check.
    METHODS parse_search_labels
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_labels) TYPE zif_ghes219=>response_search_labels
      RAISING cx_static_check.
    METHODS parse_search_repos
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_repos) TYPE zif_ghes219=>response_search_repos
      RAISING cx_static_check.
    METHODS parse_search_topics
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_topics) TYPE zif_ghes219=>response_search_topics
      RAISING cx_static_check.
    METHODS parse_search_users
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_users) TYPE zif_ghes219=>response_search_users
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_get_all
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_get_) TYPE zif_ghes219=>response_enterprise_admin_get_
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_add_aut
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_add_) TYPE zif_ghes219=>response_enterprise_admin_add_
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_remove_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_remo) TYPE zif_ghes219=>response_enterprise_admin_remo
      RAISING cx_static_check.
    METHODS parse_teams_list_discussions
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_discussion) TYPE zif_ghes219=>response_teams_list_discussion
      RAISING cx_static_check.
    METHODS parse_teams_list_discussion_co
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_discussi01) TYPE zif_ghes219=>response_teams_list_discussi01
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_team_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_te) TYPE zif_ghes219=>response_reactions_list_for_te
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_tea01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_02) TYPE zif_ghes219=>response_reactions_list_for_02
      RAISING cx_static_check.
    METHODS parse_teams_list_members
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_members) TYPE zif_ghes219=>response_teams_list_members
      RAISING cx_static_check.
    METHODS parse_teams_list_projects
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_projects) TYPE zif_ghes219=>response_teams_list_projects
      RAISING cx_static_check.
    METHODS parse_teams_add_or_update_proj
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_add_or_update_p) TYPE zif_ghes219=>response_teams_add_or_update_p
      RAISING cx_static_check.
    METHODS parse_teams_list_repos
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_repos) TYPE zif_ghes219=>response_teams_list_repos
      RAISING cx_static_check.
    METHODS parse_teams_list_child
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_child) TYPE zif_ghes219=>response_teams_list_child
      RAISING cx_static_check.
    METHODS parse_users_list_emails_for_au
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_emails_for) TYPE zif_ghes219=>response_users_list_emails_for
      RAISING cx_static_check.
    METHODS parse_users_add_email_for_auth
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_add_email_for_a) TYPE zif_ghes219=>response_users_add_email_for_a
      RAISING cx_static_check.
    METHODS parse_users_list_followers_for
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_followers_) TYPE zif_ghes219=>response_users_list_followers_
      RAISING cx_static_check.
    METHODS parse_users_list_followed_by_a
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_followed_b) TYPE zif_ghes219=>response_users_list_followed_b
      RAISING cx_static_check.
    METHODS parse_users_list_gpg_keys_for_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_gpg_keys_f) TYPE zif_ghes219=>response_users_list_gpg_keys_f
      RAISING cx_static_check.
    METHODS parse_apps_list_installations_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_apps_list_installat01) TYPE zif_ghes219=>response_apps_list_installat01
      RAISING cx_static_check.
    METHODS parse_apps_list_installation_r
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_apps_list_installat02) TYPE zif_ghes219=>response_apps_list_installat02
      RAISING cx_static_check.
    METHODS parse_issues_list_for_authenti
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_for_authe) TYPE zif_ghes219=>response_issues_list_for_authe
      RAISING cx_static_check.
    METHODS parse_users_list_public_ssh_ke
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_public_ssh) TYPE zif_ghes219=>response_users_list_public_ssh
      RAISING cx_static_check.
    METHODS parse_orgs_list_memberships_fo
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_memberships) TYPE zif_ghes219=>response_orgs_list_memberships
      RAISING cx_static_check.
    METHODS parse_orgs_list_for_authentica
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_for_authent) TYPE zif_ghes219=>response_orgs_list_for_authent
      RAISING cx_static_check.
    METHODS parse_users_list_public_emails
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_public_ema) TYPE zif_ghes219=>response_users_list_public_ema
      RAISING cx_static_check.
    METHODS parse_repos_list_for_authentic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_for_authen) TYPE zif_ghes219=>response_repos_list_for_authen
      RAISING cx_static_check.
    METHODS parse_repos_list_invitations_f
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_invitati01) TYPE zif_ghes219=>response_repos_list_invitati01
      RAISING cx_static_check.
    METHODS parse_activity_list_repos_star
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_repos_s) TYPE zif_ghes219=>response_activity_list_repos_s
      RAISING cx_static_check.
    METHODS parse_activity_list_watched_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_watched) TYPE zif_ghes219=>response_activity_list_watched
      RAISING cx_static_check.
    METHODS parse_teams_list_for_authentic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_for_authen) TYPE zif_ghes219=>response_teams_list_for_authen
      RAISING cx_static_check.
    METHODS parse_users_list
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list) TYPE zif_ghes219=>response_users_list
      RAISING cx_static_check.
    METHODS parse_activity_list_events_for
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_events_) TYPE zif_ghes219=>response_activity_list_events_
      RAISING cx_static_check.
    METHODS parse_activity_list_org_events
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_org_eve) TYPE zif_ghes219=>response_activity_list_org_eve
      RAISING cx_static_check.
    METHODS parse_activity_list_public_e02
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_publi03) TYPE zif_ghes219=>response_activity_list_publi03
      RAISING cx_static_check.
    METHODS parse_users_list_followers_f01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_follower01) TYPE zif_ghes219=>response_users_list_follower01
      RAISING cx_static_check.
    METHODS parse_users_list_following_for
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_following_) TYPE zif_ghes219=>response_users_list_following_
      RAISING cx_static_check.
    METHODS parse_gists_list_for_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_for_user) TYPE zif_ghes219=>response_gists_list_for_user
      RAISING cx_static_check.
    METHODS parse_users_list_gpg_keys_fo01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_gpg_keys01) TYPE zif_ghes219=>response_users_list_gpg_keys01
      RAISING cx_static_check.
    METHODS parse_users_list_public_keys_f
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_public_key) TYPE zif_ghes219=>response_users_list_public_key
      RAISING cx_static_check.
    METHODS parse_orgs_list_for_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_for_user) TYPE zif_ghes219=>response_orgs_list_for_user
      RAISING cx_static_check.
    METHODS parse_projects_list_for_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_list_for_use) TYPE zif_ghes219=>response_projects_list_for_use
      RAISING cx_static_check.
    METHODS parse_activity_list_received_e
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_receive) TYPE zif_ghes219=>response_activity_list_receive
      RAISING cx_static_check.
    METHODS parse_activity_list_received_p
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_recei01) TYPE zif_ghes219=>response_activity_list_recei01
      RAISING cx_static_check.
    METHODS parse_repos_list_for_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_for_user) TYPE zif_ghes219=>response_repos_list_for_user
      RAISING cx_static_check.
    METHODS parse_activity_list_repos_watc
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_repos_w) TYPE zif_ghes219=>response_activity_list_repos_w
      RAISING cx_static_check.
ENDCLASS.

CLASS zcl_ghes219 IMPLEMENTATION.
  METHOD constructor.
    mi_client = ii_client.
  ENDMETHOD.
...
* todo, array, events
    global_hook-config-url = mo_json->value_string( iv_prefix && '/config/url' ).
    global_hook-config-content_type = mo_json->value_string( iv_prefix && '/config/content_type' ).
    global_hook-config-insecure_ssl = mo_json->value_string( iv_prefix && '/config/insecure_ssl' ).
    global_hook-config-secret = mo_json->value_string( iv_prefix && '/config/secret' ).
...
* todo, array, events
    global_hook_2-config-url = mo_json->value_string( iv_prefix && '/config/url' ).
    global_hook_2-config-content_type = mo_json->value_string( iv_prefix && '/config/content_type' ).
    global_hook_2-config-insecure_ssl = mo_json->value_string( iv_prefix && '/config/insecure_ssl' ).
  ...
  METHOD parse_ldap_mapping_team.
    ...
    ldap_mapping_team-parent = mo_json->value_string( iv_prefix && '/parent' ).
  ENDMETHOD.
  ...
  METHOD parse_pre_receive_environment.
    ...
    pre_receive_environment-download-url = mo_json->value_string( iv_prefix && '/download/url' ).
    pre_receive_environment-download-state = mo_json->value_string( iv_prefix && '/download/state' ).
    pre_receive_environment-download-downloaded_at = mo_json->value_string( iv_prefix && '/download/downloaded_at' ).
    pre_receive_environment-download-message = mo_json->value_string( iv_prefix && '/download/message' ).
  ENDMETHOD.
  ...
  METHOD parse_pre_receive_hook.
    ...
    pre_receive_hook-script_repository-id = mo_json->value_string( iv_prefix && '/script_repository/id' ).
    pre_receive_hook-script_repository-full_name = mo_json->value_string( iv_prefix && '/script_repository/full_name' ).
    pre_receive_hook-script_repository-url = mo_json->value_string( iv_prefix && '/script_repository/url' ).
    pre_receive_hook-script_repository-html_url = mo_json->value_string( iv_prefix && '/script_repository/html_url' ).
    pre_receive_hook-environment-id = mo_json->value_string( iv_prefix && '/environment/id' ).
    pre_receive_hook-environment-name = mo_json->value_string( iv_prefix && '/environment/name' ).
    pre_receive_hook-environment-image_url = mo_json->value_string( iv_prefix && '/environment/image_url' ).
    pre_receive_hook-environment-url = mo_json->value_string( iv_prefix && '/environment/url' ).
    pre_receive_hook-environment-html_url = mo_json->value_string( iv_prefix && '/environment/html_url' ).
    pre_receive_hook-environment-default_environment = mo_json->value_boolean( iv_prefix && '/environment/default_environment' ).
    pre_receive_hook-environment-created_at = mo_json->value_string( iv_prefix && '/environment/created_at' ).
    pre_receive_hook-environment-hooks_count = mo_json->value_string( iv_prefix && '/environment/hooks_count' ).
    pre_receive_hook-environment-download-url = mo_json->value_string( iv_prefix && '/environment/download/url' ).
    pre_receive_hook-environment-download-state = mo_json->value_string( iv_prefix && '/environment/download/state' ).
    pre_receive_hook-environment-download-downloaded_at = mo_json->value_string( iv_prefix && '/environment/download/downloaded_at' ).
    pre_receive_hook-environment-download-message = mo_json->value_string( iv_prefix && '/environment/download/message' ).
  ...
  METHOD parse_nullable_scoped_installa.
    nullable_scoped_installation-permissions = parse_app_permissions( iv_prefix ).
...
* todo, array, single_file_paths
    ...
    nullable_scoped_installation-account = parse_simple_user( iv_prefix ).
  ENDMETHOD.
...
* todo, array, scopes
    ...
    authorization-user = parse_nullable_simple_user( iv_prefix ).
    authorization-installation = parse_nullable_scoped_installa( iv_prefix ).
  ENDMETHOD.
  ...
  METHOD parse_integration.
    ...
    integration-owner = parse_nullable_simple_user( iv_prefix ).
...
* todo, array, errors
  ...
  METHOD parse_installation_ghes_2.
    ...
    installation_ghes_2-account = mo_json->value_string( iv_prefix && '/account' ).
    ...
    installation_ghes_2-permissions-deployments = mo_json->value_string( iv_prefix && '/permissions/deployments' ).
    installation_ghes_2-permissions-checks = mo_json->value_string( iv_prefix && '/permissions/checks' ).
    installation_ghes_2-permissions-metadata = mo_json->value_string( iv_prefix && '/permissions/metadata' ).
    installation_ghes_2-permissions-contents = mo_json->value_string( iv_prefix && '/permissions/contents' ).
    installation_ghes_2-permissions-pull_requests = mo_json->value_string( iv_prefix && '/permissions/pull_requests' ).
    installation_ghes_2-permissions-statuses = mo_json->value_string( iv_prefix && '/permissions/statuses' ).
    installation_ghes_2-permissions-issues = mo_json->value_string( iv_prefix && '/permissions/issues' ).
    installation_ghes_2-permissions-organization_administration = mo_json->value_string( iv_prefix && '/permissions/organization_administration' ).
* todo, array, events
    ...
    installation_ghes_2-suspended_by = parse_nullable_simple_user( iv_prefix ).
  ...
  METHOD parse_repository.
    ...
    repository-license = parse_nullable_license_simple( iv_prefix ).
    repository-organization = parse_nullable_simple_user( iv_prefix ).
...
* todo, array, topics
    ...
    repository-template_repository-anonymous_access_enabled = mo_json->value_boolean( iv_prefix && '/template_repository/anonymous_access_enabled' ).
...
* todo, array, scopes
    application_grant-user = parse_nullable_simple_user( iv_prefix ).
  ENDMETHOD.

  METHOD parse_authorization_with_user.
    authorization_with_user-id = mo_json->value_string( iv_prefix && '/id' ).
    authorization_with_user-url = mo_json->value_string( iv_prefix && '/url' ).
* todo, array, scopes
    authorization_with_user-token = mo_json->value_string( iv_prefix && '/token' ).
    authorization_with_user-token_last_eight = mo_json->value_string( iv_prefix && '/token_last_eight' ).
    authorization_with_user-hashed_token = mo_json->value_string( iv_prefix && '/hashed_token' ).
    authorization_with_user-app-url = mo_json->value_string( iv_prefix && '/app/url' ).
    authorization_with_user-app-name = mo_json->value_string( iv_prefix && '/app/name' ).
    authorization_with_user-app-client_id = mo_json->value_string( iv_prefix && '/app/client_id' ).
    authorization_with_user-note = mo_json->value_string( iv_prefix && '/note' ).
    authorization_with_user-note_url = mo_json->value_string( iv_prefix && '/note_url' ).
    authorization_with_user-updated_at = mo_json->value_string( iv_prefix && '/updated_at' ).
    authorization_with_user-created_at = mo_json->value_string( iv_prefix && '/created_at' ).
    authorization_with_user-fingerprint = mo_json->value_string( iv_prefix && '/fingerprint' ).
    authorization_with_user-user-login = mo_json->value_string( iv_prefix && '/user/login' ).
    authorization_with_user-user-id = mo_json->value_string( iv_prefix && '/user/id' ).
    authorization_with_user-user-node_id = mo_json->value_string( iv_prefix && '/user/node_id' ).
    authorization_with_user-user-avatar_url = mo_json->value_string( iv_prefix && '/user/avatar_url' ).
    authorization_with_user-user-gravatar_id = mo_json->value_string( iv_prefix && '/user/gravatar_id' ).
    authorization_with_user-user-url = mo_json->value_string( iv_prefix && '/user/url' ).
    authorization_with_user-user-html_url = mo_json->value_string( iv_prefix && '/user/html_url' ).
    authorization_with_user-user-followers_url = mo_json->value_string( iv_prefix && '/user/followers_url' ).
    authorization_with_user-user-following_url = mo_json->value_string( iv_prefix && '/user/following_url' ).
    authorization_with_user-user-gists_url = mo_json->value_string( iv_prefix && '/user/gists_url' ).
    authorization_with_user-user-starred_url = mo_json->value_string( iv_prefix && '/user/starred_url' ).
    authorization_with_user-user-subscriptions_url = mo_json->value_string( iv_prefix && '/user/subscriptions_url' ).
    authorization_with_user-user-organizations_url = mo_json->value_string( iv_prefix && '/user/organizations_url' ).
    authorization_with_user-user-repos_url = mo_json->value_string( iv_prefix && '/user/repos_url' ).
    authorization_with_user-user-events_url = mo_json->value_string( iv_prefix && '/user/events_url' ).
    authorization_with_user-user-received_events_url = mo_json->value_string( iv_prefix && '/user/received_events_url' ).
    authorization_with_user-user-type = mo_json->value_string( iv_prefix && '/user/type' ).
    authorization_with_user-user-site_admin = mo_json->value_boolean( iv_prefix && '/user/site_admin' ).
  ENDMETHOD.
  ...
  METHOD parse_nullable_milestone.
    ...
    nullable_milestone-creator = parse_nullable_simple_user( iv_prefix ).
...
* todo, handle type string
  ...
  METHOD parse_nullable_integration.
    ...
    nullable_integration-owner = parse_nullable_simple_user( iv_prefix ).
...
* todo, array, assignees
  ...
  METHOD parse_issue_comment.
    ...
    issue_comment-user = parse_nullable_simple_user( iv_prefix ).
    ...
    issue_comment-performed_via_github_app = parse_nullable_integration( iv_prefix ).
...
* todo, array, current_user_organizations
  ...
  METHOD parse_base_gist.
    ...
    base_gist-user = parse_nullable_simple_user( iv_prefix ).
    base_gist-comments_url = mo_json->value_string( iv_prefix && '/comments_url' ).
    base_gist-owner = parse_simple_user( iv_prefix ).
...
* todo, array, history
  ...
  METHOD parse_gist_history.
    gist_history-user = parse_nullable_simple_user( iv_prefix ).
...
* todo, array, history
    ...
    gist_simple-fork_of-user = parse_nullable_simple_user( iv_prefix ).
    gist_simple-fork_of-comments_url = mo_json->value_string( iv_prefix && '/fork_of/comments_url' ).
    gist_simple-fork_of-owner = parse_nullable_simple_user( iv_prefix ).
...
* todo, array, history
  ...
  METHOD parse_gist_comment.
    ...
    gist_comment-user = parse_nullable_simple_user( iv_prefix ).
  ...
  METHOD parse_gist_commit.
    ...
    gist_commit-user = parse_nullable_simple_user( iv_prefix ).
...
* todo, array, dependabot
    ...
    api_overview-github_services_sha = mo_json->value_string( iv_prefix && '/github_services_sha' ).
  ENDMETHOD.
...
* todo, array, topics
    ...
    nullable_repository-template_repository-anonymous_access_enabled = mo_json->value_boolean( iv_prefix && '/template_repository/anonymous_access_enabled' ).
    ...
    nullable_repository-anonymous_access_enabled = mo_json->value_boolean( iv_prefix && '/anonymous_access_enabled' ).
  ENDMETHOD.
...
* todo, handle type string
  ...
  METHOD parse_project.
    ...
    project-creator = parse_nullable_simple_user( iv_prefix ).
  ...
  METHOD parse_team.
    ...
    team-parent = parse_nullable_team_simple( iv_prefix ).
  ENDMETHOD.
  ...
  METHOD parse_team_full.
    ...
    team_full-parent = parse_nullable_team_simple( iv_prefix ).
  ...
  METHOD parse_project_card.
    ...
    project_card-creator = parse_nullable_simple_user( iv_prefix ).
...
* todo, array, topics
    ...
    full_repository-template_repository = parse_nullable_repository( iv_prefix ).
    ...
    full_repository-organization = parse_nullable_simple_user( iv_prefix ).
...
* todo, array, contexts
  ...
  METHOD parse_commit.
    ...
    commit-commit-author = parse_nullable_git_user( iv_prefix ).
    commit-commit-committer = parse_nullable_git_user( iv_prefix ).
    ...
    commit-author = parse_nullable_simple_user( iv_prefix ).
    commit-committer = parse_nullable_simple_user( iv_prefix ).
* todo, array, parents
...
* todo, array, teams
  ...
  METHOD parse_deployment_simple.
    ...
    deployment_simple-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ENDMETHOD.
...
* todo, array, pull_requests
    check_suite-app = parse_nullable_integration( iv_prefix ).
...
* todo, array, auto_trigger_checks
  ...
  METHOD parse_repository_invitation.
    ...
    repository_invitation-invitee = parse_nullable_simple_user( iv_prefix ).
    repository_invitation-inviter = parse_nullable_simple_user( iv_prefix ).
  ...
  METHOD parse_commit_comment.
    ...
    commit_comment-user = parse_nullable_simple_user( iv_prefix ).
  ...
  METHOD parse_reaction.
    ...
    reaction-user = parse_nullable_simple_user( iv_prefix ).
...
* todo, array, schemas
  ...
  METHOD parse_pull_request_simple.
    ...
    pull_request_simple-user = parse_nullable_simple_user( iv_prefix ).
    pull_request_simple-body = mo_json->value_string( iv_prefix && '/body' ).
* todo, array, labels
    pull_request_simple-milestone = parse_nullable_milestone( iv_prefix ).
    ...
    pull_request_simple-assignee = parse_nullable_simple_user( iv_prefix ).
* todo, array, assignees
...
* todo, array, requested_teams
    ...
    pull_request_simple-head-user = parse_nullable_simple_user( iv_prefix ).
    ...
    pull_request_simple-base-user = parse_nullable_simple_user( iv_prefix ).
...
* todo, array, parents
  ...
  METHOD parse_deployment.
    ...
    deployment-creator = parse_nullable_simple_user( iv_prefix ).
    ...
    deployment-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ENDMETHOD.
  ...
  METHOD parse_deployment_status.
    ...
    deployment_status-creator = parse_nullable_simple_user( iv_prefix ).
    ...
    deployment_status-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ENDMETHOD.
...
* todo, array, events
  ...
  METHOD parse_issue_event.
    ...
    issue_event-actor = parse_nullable_simple_user( iv_prefix ).
    ...
    issue_event-review_requester = parse_nullable_simple_user( iv_prefix ).
    issue_event-requested_reviewer = parse_nullable_simple_user( iv_prefix ).
    ...
    issue_event-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ENDMETHOD.
  ...
  METHOD parse_labeled_issue_event.
    ...
    labeled_issue_event-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ...
  METHOD parse_unlabeled_issue_event.
    ...
    unlabeled_issue_event-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ...
  METHOD parse_unassigned_issue_event.
    ...
    unassigned_issue_event-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ...
  METHOD parse_milestoned_issue_event.
    ...
    milestoned_issue_event-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ...
  METHOD parse_demilestoned_issue_event.
    ...
    demilestoned_issue_event-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ...
  METHOD parse_renamed_issue_event.
    ...
    renamed_issue_event-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ...
  METHOD parse_review_requested_issue_e.
    ...
    review_requested_issue_event-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ...
  METHOD parse_review_request_removed_i.
    ...
    review_request_removed_issue_e-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ...
  METHOD parse_review_dismissed_issue_e.
    ...
    review_dismissed_issue_event-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ...
  METHOD parse_locked_issue_event.
    ...
    locked_issue_event-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ...
  METHOD parse_added_to_project_issue_e.
    ...
    added_to_project_issue_event-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ...
  METHOD parse_moved_column_in_project_.
    ...
    moved_column_in_project_issue_-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ...
  METHOD parse_removed_from_project_iss.
    ...
    removed_from_project_issue_eve-performed_via_github_app = parse_nullable_integration( iv_prefix ).
...
* todo, handle type string
  ...
  METHOD parse_timeline_comment_event.
    ...
    timeline_comment_event-performed_via_github_app = parse_nullable_integration( iv_prefix ).
...
* todo, array, comments
  ...
  METHOD parse_timeline_assigned_issue_.
    ...
    timeline_assigned_issue_event-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ...
  METHOD parse_timeline_unassigned_issu.
    ...
    timeline_unassigned_issue_even-performed_via_github_app = parse_nullable_integration( iv_prefix ).
  ...
  METHOD parse_license_content.
    ...
    license_content-license = parse_nullable_license_simple( iv_prefix ).
  ENDMETHOD.
  ...
  METHOD parse_milestone.
    ...
    milestone-creator = parse_nullable_simple_user( iv_prefix ).
...
* todo, array, domains
  ...
  METHOD parse_page_build.
    ...
    page_build-pusher = parse_nullable_simple_user( iv_prefix ).
  ...
  METHOD parse_pull_request.
    ...
    pull_request-user = parse_nullable_simple_user( iv_prefix ).
    pull_request-body = mo_json->value_string( iv_prefix && '/body' ).
* todo, array, labels
    pull_request-milestone = parse_nullable_milestone( iv_prefix ).
    ...
    pull_request-assignee = parse_nullable_simple_user( iv_prefix ).
* todo, array, assignees
* todo, array, requested_reviewers
* todo, array, requested_teams
...
* todo, array, topics
    ...
    pull_request-base-repo-license = parse_nullable_license_simple( iv_prefix ).
...
* todo, array, topics
    ...
    pull_request-merged_by = parse_nullable_simple_user( iv_prefix ).
  ...
  METHOD parse_legacy_review_comment.
    ...
    legacy_review_comment-id = mo_json->value_string( iv_prefix && '/id' ).
    legacy_review_comment-node_id = mo_json->value_string( iv_prefix && '/node_id' ).
    legacy_review_comment-diff_hunk = mo_json->value_string( iv_prefix && '/diff_hunk' ).
    legacy_review_comment-path = mo_json->value_string( iv_prefix && '/path' ).
    legacy_review_comment-position = mo_json->value_string( iv_prefix && '/position' ).
    legacy_review_comment-original_position = mo_json->value_string( iv_prefix && '/original_position' ).
    legacy_review_comment-commit_id = mo_json->value_string( iv_prefix && '/commit_id' ).
    legacy_review_comment-original_commit_id = mo_json->value_string( iv_prefix && '/original_commit_id' ).
    legacy_review_comment-in_reply_to_id = mo_json->value_string( iv_prefix && '/in_reply_to_id' ).
    legacy_review_comment-user-login = mo_json->value_string( iv_prefix && '/user/login' ).
    legacy_review_comment-user-id = mo_json->value_string( iv_prefix && '/user/id' ).
    legacy_review_comment-user-node_id = mo_json->value_string( iv_prefix && '/user/node_id' ).
    legacy_review_comment-user-avatar_url = mo_json->value_string( iv_prefix && '/user/avatar_url' ).
    legacy_review_comment-user-gravatar_id = mo_json->value_string( iv_prefix && '/user/gravatar_id' ).
    legacy_review_comment-user-url = mo_json->value_string( iv_prefix && '/user/url' ).
    legacy_review_comment-user-html_url = mo_json->value_string( iv_prefix && '/user/html_url' ).
    legacy_review_comment-user-followers_url = mo_json->value_string( iv_prefix && '/user/followers_url' ).
    legacy_review_comment-user-following_url = mo_json->value_string( iv_prefix && '/user/following_url' ).
    legacy_review_comment-user-gists_url = mo_json->value_string( iv_prefix && '/user/gists_url' ).
    legacy_review_comment-user-starred_url = mo_json->value_string( iv_prefix && '/user/starred_url' ).
    legacy_review_comment-user-subscriptions_url = mo_json->value_string( iv_prefix && '/user/subscriptions_url' ).
    legacy_review_comment-user-organizations_url = mo_json->value_string( iv_prefix && '/user/organizations_url' ).
    legacy_review_comment-user-repos_url = mo_json->value_string( iv_prefix && '/user/repos_url' ).
    legacy_review_comment-user-events_url = mo_json->value_string( iv_prefix && '/user/events_url' ).
    legacy_review_comment-user-received_events_url = mo_json->value_string( iv_prefix && '/user/received_events_url' ).
    legacy_review_comment-user-type = mo_json->value_string( iv_prefix && '/user/type' ).
    legacy_review_comment-user-site_admin = mo_json->value_boolean( iv_prefix && '/user/site_admin' ).
    legacy_review_comment-body = mo_json->value_string( iv_prefix && '/body' ).
    legacy_review_comment-created_at = mo_json->value_string( iv_prefix && '/created_at' ).
    legacy_review_comment-updated_at = mo_json->value_string( iv_prefix && '/updated_at' ).
    legacy_review_comment-html_url = mo_json->value_string( iv_prefix && '/html_url' ).
    legacy_review_comment-pull_request_url = mo_json->value_string( iv_prefix && '/pull_request_url' ).
    legacy_review_comment-author_association = mo_json->value_string( iv_prefix && '/author_association' ).
    legacy_review_comment-_links-self-href = mo_json->value_string( iv_prefix && '/_links/self/href' ).
    legacy_review_comment-_links-html-href = mo_json->value_string( iv_prefix && '/_links/html/href' ).
    legacy_review_comment-_links-pull_request-href = mo_json->value_string( iv_prefix && '/_links/pull_request/href' ).
  ENDMETHOD.
...
* todo, array, teams
  ...
  METHOD parse_pull_request_review.
    ...
    pull_request_review-user = parse_nullable_simple_user( iv_prefix ).
  ...
  METHOD parse_review_comment.
    ...
    review_comment-user = parse_nullable_simple_user( iv_prefix ).
  ...
  METHOD parse_release_asset.
    ...
    release_asset-uploader = parse_nullable_simple_user( iv_prefix ).
  ENDMETHOD.
...
* todo, array, days
  ...
  METHOD parse_contributor_activity.
    contributor_activity-author = parse_nullable_simple_user( iv_prefix ).
...
* todo, array, line_numbers
  ...
  METHOD parse_commit_search_result_ite.
    ...
    commit_search_result_item-commit-committer = parse_nullable_git_user( iv_prefix ).
    ...
    commit_search_result_item-author = parse_nullable_simple_user( iv_prefix ).
    commit_search_result_item-committer = parse_nullable_git_user( iv_prefix ).
* todo, array, parents
...
* todo, array, assignees
    issue_search_result_item-user = parse_nullable_simple_user( iv_prefix ).
* todo, array, labels
    issue_search_result_item-state = mo_json->value_string( iv_prefix && '/state' ).
    issue_search_result_item-assignee = parse_nullable_simple_user( iv_prefix ).
    issue_search_result_item-milestone = parse_nullable_milestone( iv_prefix ).
...
* todo, number, score
  ...
  METHOD parse_repo_search_result_item.
    ...
    repo_search_result_item-owner = parse_nullable_simple_user( iv_prefix ).
...
* todo, array, connection_services
  ENDMETHOD.

  METHOD parse_enterprise_settings.
    enterprise_settings-enterprise-private_mode = mo_json->value_boolean( iv_prefix && '/enterprise/private_mode' ).
    enterprise_settings-enterprise-public_pages = mo_json->value_boolean( iv_prefix && '/enterprise/public_pages' ).
    enterprise_settings-enterprise-subdomain_isolation = mo_json->value_boolean( iv_prefix && '/enterprise/subdomain_isolation' ).
    enterprise_settings-enterprise-signup_enabled = mo_json->value_boolean( iv_prefix && '/enterprise/signup_enabled' ).
    enterprise_settings-enterprise-github_hostname = mo_json->value_string( iv_prefix && '/enterprise/github_hostname' ).
    enterprise_settings-enterprise-identicons_host = mo_json->value_string( iv_prefix && '/enterprise/identicons_host' ).
    enterprise_settings-enterprise-http_proxy = mo_json->value_string( iv_prefix && '/enterprise/http_proxy' ).
    enterprise_settings-enterprise-auth_mode = mo_json->value_string( iv_prefix && '/enterprise/auth_mode' ).
    enterprise_settings-enterprise-expire_sessions = mo_json->value_boolean( iv_prefix && '/enterprise/expire_sessions' ).
    enterprise_settings-enterprise-admin_password = mo_json->value_string( iv_prefix && '/enterprise/admin_password' ).
    enterprise_settings-enterprise-configuration_id = mo_json->value_string( iv_prefix && '/enterprise/configuration_id' ).
    enterprise_settings-enterprise-configuration_run_count = mo_json->value_string( iv_prefix && '/enterprise/configuration_run_count' ).
    enterprise_settings-enterprise-avatar-enabled = mo_json->value_boolean( iv_prefix && '/enterprise/avatar/enabled' ).
    enterprise_settings-enterprise-avatar-uri = mo_json->value_string( iv_prefix && '/enterprise/avatar/uri' ).
    enterprise_settings-enterprise-customer-name = mo_json->value_string( iv_prefix && '/enterprise/customer/name' ).
    enterprise_settings-enterprise-customer-email = mo_json->value_string( iv_prefix && '/enterprise/customer/email' ).
    enterprise_settings-enterprise-customer-uuid = mo_json->value_string( iv_prefix && '/enterprise/customer/uuid' ).
    enterprise_settings-enterprise-customer-secret_key_data = mo_json->value_string( iv_prefix && '/enterprise/customer/secret_key_data' ).
    enterprise_settings-enterprise-customer-public_key_data = mo_json->value_string( iv_prefix && '/enterprise/customer/public_key_data' ).
    enterprise_settings-enterprise-license-seats = mo_json->value_string( iv_prefix && '/enterprise/license/seats' ).
    enterprise_settings-enterprise-license-evaluation = mo_json->value_boolean( iv_prefix && '/enterprise/license/evaluation' ).
    enterprise_settings-enterprise-license-perpetual = mo_json->value_boolean( iv_prefix && '/enterprise/license/perpetual' ).
    enterprise_settings-enterprise-license-unlimited_seating = mo_json->value_boolean( iv_prefix && '/enterprise/license/unlimited_seating' ).
    enterprise_settings-enterprise-license-support_key = mo_json->value_string( iv_prefix && '/enterprise/license/support_key' ).
    enterprise_settings-enterprise-license-ssh_allowed = mo_json->value_boolean( iv_prefix && '/enterprise/license/ssh_allowed' ).
    enterprise_settings-enterprise-license-cluster_support = mo_json->value_boolean( iv_prefix && '/enterprise/license/cluster_support' ).
    enterprise_settings-enterprise-license-expire_at = mo_json->value_string( iv_prefix && '/enterprise/license/expire_at' ).
    enterprise_settings-enterprise-github_ssl-enabled = mo_json->value_boolean( iv_prefix && '/enterprise/github_ssl/enabled' ).
    enterprise_settings-enterprise-github_ssl-cert = mo_json->value_string( iv_prefix && '/enterprise/github_ssl/cert' ).
    enterprise_settings-enterprise-github_ssl-key = mo_json->value_string( iv_prefix && '/enterprise/github_ssl/key' ).
    enterprise_settings-enterprise-ldap-host = mo_json->value_string( iv_prefix && '/enterprise/ldap/host' ).
    enterprise_settings-enterprise-ldap-port = mo_json->value_string( iv_prefix && '/enterprise/ldap/port' ).
* todo, array, base
    enterprise_settings-enterprise-ldap-uid = mo_json->value_string( iv_prefix && '/enterprise/ldap/uid' ).
    enterprise_settings-enterprise-ldap-bind_dn = mo_json->value_string( iv_prefix && '/enterprise/ldap/bind_dn' ).
    enterprise_settings-enterprise-ldap-password = mo_json->value_string( iv_prefix && '/enterprise/ldap/password' ).
    enterprise_settings-enterprise-ldap-method = mo_json->value_string( iv_prefix && '/enterprise/ldap/method' ).
    enterprise_settings-enterprise-ldap-search_strategy = mo_json->value_string( iv_prefix && '/enterprise/ldap/search_strategy' ).
* todo, array, user_groups
    enterprise_settings-enterprise-ldap-admin_group = mo_json->value_string( iv_prefix && '/enterprise/ldap/admin_group' ).
    enterprise_settings-enterprise-ldap-virtual_attribute_enabled = mo_json->value_boolean( iv_prefix && '/enterprise/ldap/virtual_attribute_enabled' ).
    enterprise_settings-enterprise-ldap-recursive_group_search = mo_json->value_boolean( iv_prefix && '/enterprise/ldap/recursive_group_search' ).
    enterprise_settings-enterprise-ldap-posix_support = mo_json->value_boolean( iv_prefix && '/enterprise/ldap/posix_support' ).
    enterprise_settings-enterprise-ldap-user_sync_emails = mo_json->value_boolean( iv_prefix && '/enterprise/ldap/user_sync_emails' ).
    enterprise_settings-enterprise-ldap-user_sync_keys = mo_json->value_boolean( iv_prefix && '/enterprise/ldap/user_sync_keys' ).
    enterprise_settings-enterprise-ldap-user_sync_interval = mo_json->value_string( iv_prefix && '/enterprise/ldap/user_sync_interval' ).
    enterprise_settings-enterprise-ldap-team_sync_interval = mo_json->value_string( iv_prefix && '/enterprise/ldap/team_sync_interval' ).
    enterprise_settings-enterprise-ldap-sync_enabled = mo_json->value_boolean( iv_prefix && '/enterprise/ldap/sync_enabled' ).
    enterprise_settings-enterprise-ldap-reconciliation-user = mo_json->value_string( iv_prefix && '/enterprise/ldap/reconciliation/user' ).
    enterprise_settings-enterprise-ldap-reconciliation-org = mo_json->value_string( iv_prefix && '/enterprise/ldap/reconciliation/org' ).
    enterprise_settings-enterprise-ldap-profile-uid = mo_json->value_string( iv_prefix && '/enterprise/ldap/profile/uid' ).
    enterprise_settings-enterprise-ldap-profile-name = mo_json->value_string( iv_prefix && '/enterprise/ldap/profile/name' ).
    enterprise_settings-enterprise-ldap-profile-mail = mo_json->value_string( iv_prefix && '/enterprise/ldap/profile/mail' ).
    enterprise_settings-enterprise-ldap-profile-key = mo_json->value_string( iv_prefix && '/enterprise/ldap/profile/key' ).
    enterprise_settings-enterprise-cas-url = mo_json->value_string( iv_prefix && '/enterprise/cas/url' ).
    enterprise_settings-enterprise-saml-sso_url = mo_json->value_string( iv_prefix && '/enterprise/saml/sso_url' ).
    enterprise_settings-enterprise-saml-certificate = mo_json->value_string( iv_prefix && '/enterprise/saml/certificate' ).
    enterprise_settings-enterprise-saml-certificate_path = mo_json->value_string( iv_prefix && '/enterprise/saml/certificate_path' ).
    enterprise_settings-enterprise-saml-issuer = mo_json->value_string( iv_prefix && '/enterprise/saml/issuer' ).
    enterprise_settings-enterprise-saml-idp_initiated_sso = mo_json->value_boolean( iv_prefix && '/enterprise/saml/idp_initiated_sso' ).
    enterprise_settings-enterprise-saml-disable_admin_demote = mo_json->value_boolean( iv_prefix && '/enterprise/saml/disable_admin_demote' ).
    enterprise_settings-enterprise-github_oauth-client_id = mo_json->value_string( iv_prefix && '/enterprise/github_oauth/client_id' ).
    enterprise_settings-enterprise-github_oauth-client_secret = mo_json->value_string( iv_prefix && '/enterprise/github_oauth/client_secret' ).
    enterprise_settings-enterprise-github_oauth-organization_name = mo_json->value_string( iv_prefix && '/enterprise/github_oauth/organization_name' ).
    enterprise_settings-enterprise-github_oauth-organization_team = mo_json->value_string( iv_prefix && '/enterprise/github_oauth/organization_team' ).
    enterprise_settings-enterprise-smtp-enabled = mo_json->value_boolean( iv_prefix && '/enterprise/smtp/enabled' ).
    enterprise_settings-enterprise-smtp-address = mo_json->value_string( iv_prefix && '/enterprise/smtp/address' ).
    enterprise_settings-enterprise-smtp-authentication = mo_json->value_string( iv_prefix && '/enterprise/smtp/authentication' ).
    enterprise_settings-enterprise-smtp-port = mo_json->value_string( iv_prefix && '/enterprise/smtp/port' ).
    enterprise_settings-enterprise-smtp-domain = mo_json->value_string( iv_prefix && '/enterprise/smtp/domain' ).
    enterprise_settings-enterprise-smtp-username = mo_json->value_string( iv_prefix && '/enterprise/smtp/username' ).
    enterprise_settings-enterprise-smtp-user_name = mo_json->value_string( iv_prefix && '/enterprise/smtp/user_name' ).
    enterprise_settings-enterprise-smtp-enable_starttls_auto = mo_json->value_boolean( iv_prefix && '/enterprise/smtp/enable_starttls_auto' ).
    enterprise_settings-enterprise-smtp-password = mo_json->value_string( iv_prefix && '/enterprise/smtp/password' ).
    enterprise_settings-enterprise-smtp-discard_to_noreply_address = mo_json->value_boolean( iv_prefix && '/enterprise/smtp/discard-to-noreply-address' ).
    enterprise_settings-enterprise-smtp-support_address = mo_json->value_string( iv_prefix && '/enterprise/smtp/support_address' ).
    enterprise_settings-enterprise-smtp-support_address_type = mo_json->value_string( iv_prefix && '/enterprise/smtp/support_address_type' ).
    enterprise_settings-enterprise-smtp-noreply_address = mo_json->value_string( iv_prefix && '/enterprise/smtp/noreply_address' ).
    enterprise_settings-enterprise-ntp-primary_server = mo_json->value_string( iv_prefix && '/enterprise/ntp/primary_server' ).
    enterprise_settings-enterprise-ntp-secondary_server = mo_json->value_string( iv_prefix && '/enterprise/ntp/secondary_server' ).
    enterprise_settings-enterprise-timezone = mo_json->value_string( iv_prefix && '/enterprise/timezone' ).
    enterprise_settings-enterprise-snmp-enabled = mo_json->value_boolean( iv_prefix && '/enterprise/snmp/enabled' ).
    enterprise_settings-enterprise-snmp-community = mo_json->value_string( iv_prefix && '/enterprise/snmp/community' ).
    enterprise_settings-enterprise-syslog-enabled = mo_json->value_boolean( iv_prefix && '/enterprise/syslog/enabled' ).
    enterprise_settings-enterprise-syslog-server = mo_json->value_string( iv_prefix && '/enterprise/syslog/server' ).
    enterprise_settings-enterprise-syslog-protocol_name = mo_json->value_string( iv_prefix && '/enterprise/syslog/protocol_name' ).
    enterprise_settings-enterprise-assets = mo_json->value_string( iv_prefix && '/enterprise/assets' ).
    enterprise_settings-enterprise-pages-enabled = mo_json->value_boolean( iv_prefix && '/enterprise/pages/enabled' ).
    enterprise_settings-enterprise-collectd-enabled = mo_json->value_boolean( iv_prefix && '/enterprise/collectd/enabled' ).
    enterprise_settings-enterprise-collectd-server = mo_json->value_string( iv_prefix && '/enterprise/collectd/server' ).
    enterprise_settings-enterprise-collectd-port = mo_json->value_string( iv_prefix && '/enterprise/collectd/port' ).
    enterprise_settings-enterprise-collectd-encryption = mo_json->value_string( iv_prefix && '/enterprise/collectd/encryption' ).
    enterprise_settings-enterprise-collectd-username = mo_json->value_string( iv_prefix && '/enterprise/collectd/username' ).
    enterprise_settings-enterprise-collectd-password = mo_json->value_string( iv_prefix && '/enterprise/collectd/password' ).
    enterprise_settings-enterprise-mapping-enabled = mo_json->value_boolean( iv_prefix && '/enterprise/mapping/enabled' ).
    enterprise_settings-enterprise-mapping-tileserver = mo_json->value_string( iv_prefix && '/enterprise/mapping/tileserver' ).
    enterprise_settings-enterprise-mapping-basemap = mo_json->value_string( iv_prefix && '/enterprise/mapping/basemap' ).
    enterprise_settings-enterprise-mapping-token = mo_json->value_string( iv_prefix && '/enterprise/mapping/token' ).
    enterprise_settings-enterprise-load_balancer = mo_json->value_string( iv_prefix && '/enterprise/load_balancer' ).
* todo, array, run_list
  ENDMETHOD.
  ...
  METHOD parse_team_discussion.
    team_discussion-author = parse_nullable_simple_user( iv_prefix ).
  ...
  METHOD parse_team_discussion_comment.
    team_discussion_comment-author = parse_nullable_simple_user( iv_prefix ).
  ...
  METHOD parse_team_2.
    team_2-id = mo_json->value_string( iv_prefix && '/id' ).
    team_2-node_id = mo_json->value_string( iv_prefix && '/node_id' ).
    team_2-url = mo_json->value_string( iv_prefix && '/url' ).
    team_2-name = mo_json->value_string( iv_prefix && '/name' ).
    team_2-slug = mo_json->value_string( iv_prefix && '/slug' ).
    team_2-description = mo_json->value_string( iv_prefix && '/description' ).
    team_2-privacy = mo_json->value_string( iv_prefix && '/privacy' ).
    team_2-permission = mo_json->value_string( iv_prefix && '/permission' ).
    team_2-members_url = mo_json->value_string( iv_prefix && '/members_url' ).
    team_2-repositories_url = mo_json->value_string( iv_prefix && '/repositories_url' ).
    team_2-parent-id = mo_json->value_string( iv_prefix && '/parent/id' ).
    team_2-parent-node_id = mo_json->value_string( iv_prefix && '/parent/node_id' ).
    team_2-parent-url = mo_json->value_string( iv_prefix && '/parent/url' ).
    team_2-parent-html_url = mo_json->value_string( iv_prefix && '/parent/html_url' ).
    team_2-parent-name = mo_json->value_string( iv_prefix && '/parent/name' ).
    team_2-parent-slug = mo_json->value_string( iv_prefix && '/parent/slug' ).
    team_2-parent-description = mo_json->value_string( iv_prefix && '/parent/description' ).
    team_2-parent-privacy = mo_json->value_string( iv_prefix && '/parent/privacy' ).
    team_2-parent-permission = mo_json->value_string( iv_prefix && '/parent/permission' ).
    team_2-parent-members_url = mo_json->value_string( iv_prefix && '/parent/members_url' ).
    team_2-parent-repositories_url = mo_json->value_string( iv_prefix && '/parent/repositories_url' ).
  ENDMETHOD.
...
* todo, array, contexts
  ...
  METHOD parse_enterprise_admin_list_gl.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA global_hook TYPE zif_ghes219=>global_hook.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR global_hook.
      global_hook = parse_global_hook( iv_prefix && '/' && lv_member ).
      APPEND global_hook TO response_enterprise_admin_list.
    ENDLOOP.
  ENDMETHOD.
  ...
  METHOD parse_enterprise_admin_list_pu.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA public_key_full TYPE zif_ghes219=>public_key_full.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_enterprise_admin_sync_ld.
    response_enterprise_admin_sync-status = mo_json->value_string( iv_prefix && '/status' ).
  ENDMETHOD.

  METHOD parse_enterprise_admin_sync_01.
    response_enterprise_admin_sy01-status = mo_json->value_string( iv_prefix && '/status' ).
  ENDMETHOD.

  METHOD parse_enterprise_admin_update_.
    response_enterprise_admin_upda-message = mo_json->value_string( iv_prefix && '/message' ).
    response_enterprise_admin_upda-url = mo_json->value_string( iv_prefix && '/url' ).
  ENDMETHOD.

  METHOD parse_enterprise_admin_list_pr.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA pre_receive_environment TYPE zif_ghes219=>pre_receive_environment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR pre_receive_environment.
      pre_receive_environment = parse_pre_receive_environment( iv_prefix && '/' && lv_member ).
      APPEND pre_receive_environment TO response_enterprise_admin_li02.
    ENDLOOP.
  ENDMETHOD.

  METHOD parse_enterprise_admin_updat01.
    response_enterprise_admin_up01-message = mo_json->value_string( iv_prefix && '/message' ).
* todo, array, errors
  ENDMETHOD.

  METHOD parse_enterprise_admin_delete_.
    response_enterprise_admin_dele-message = mo_json->value_string( iv_prefix && '/message' ).
* todo, array, errors
  ENDMETHOD.

  METHOD parse_enterprise_admin_start_p.
    response_enterprise_admin_star-message = mo_json->value_string( iv_prefix && '/message' ).
* todo, array, errors
  ENDMETHOD.
  ...
  METHOD parse_enterprise_admin_list_01.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA pre_receive_hook TYPE zif_ghes219=>pre_receive_hook.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR pre_receive_hook.
      pre_receive_hook = parse_pre_receive_hook( iv_prefix && '/' && lv_member ).
      APPEND pre_receive_hook TO response_enterprise_admin_li03.
    ENDLOOP.
  ENDMETHOD.

  METHOD parse_enterprise_admin_list_pe.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA authorization TYPE zif_ghes219=>authorization.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR authorization.
      authorization = parse_authorization( iv_prefix && '/' && lv_member ).
      APPEND authorization TO response_enterprise_admin_li04.
    ENDLOOP.
  ENDMETHOD.

  METHOD parse_enterprise_admin_updat02.
    response_enterprise_admin_up02-message = mo_json->value_string( iv_prefix && '/message' ).
    response_enterprise_admin_up02-url = mo_json->value_string( iv_prefix && '/url' ).
  ENDMETHOD.

  METHOD parse_apps_list_installations.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA installation_ghes_2 TYPE zif_ghes219=>installation_ghes_2.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR installation_ghes_2.
      installation_ghes_2 = parse_installation_ghes_2( iv_prefix && '/' && lv_member ).
      APPEND installation_ghes_2 TO response_apps_list_installatio.
    ENDLOOP.
  ENDMETHOD.
  ...
  METHOD parse_codes_of_conduct_get_all.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA code_of_conduct TYPE zif_ghes219=>code_of_conduct.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_activity_list_public_eve.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA event TYPE zif_ghes219=>event.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR event.
  ...
  METHOD parse_gists_list.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA base_gist TYPE zif_ghes219=>base_gist.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR base_gist.
  ...
  METHOD parse_gists_list_comments.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA gist_comment TYPE zif_ghes219=>gist_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR gist_comment.
  ...
  METHOD parse_gists_list_commits.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA gist_commit TYPE zif_ghes219=>gist_commit.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR gist_commit.
  ...
  METHOD parse_gists_list_forks.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA gist_simple TYPE zif_ghes219=>gist_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR gist_simple.
...
* todo, array, repositories
  ...
  METHOD parse_issues_list.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA issue TYPE zif_ghes219=>issue.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR issue.
  ...
  METHOD parse_licenses_get_all_commonl.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA license_simple TYPE zif_ghes219=>license_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_activity_list_notificati.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA thread TYPE zif_ghes219=>thread.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR thread.
  ...
  METHOD parse_orgs_list.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA organization_simple TYPE zif_ghes219=>organization_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_orgs_list_webhooks.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA org_hook TYPE zif_ghes219=>org_hook.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR org_hook.
...
* todo, array, installations
  ...
  METHOD parse_orgs_list_members.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA simple_user TYPE zif_ghes219=>simple_user.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR simple_user.
  ...
  METHOD parse_enterprise_admin_list_02.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA org_pre_receive_hook TYPE zif_ghes219=>org_pre_receive_hook.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR org_pre_receive_hook.
      org_pre_receive_hook = parse_org_pre_receive_hook( iv_prefix && '/' && lv_member ).
      APPEND org_pre_receive_hook TO response_enterprise_admin_li05.
    ENDLOOP.
  ENDMETHOD.
  ...
  METHOD parse_projects_list_for_org.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA project TYPE zif_ghes219=>project.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR project.
  ...
  METHOD parse_repos_list_for_org.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA minimal_repository TYPE zif_ghes219=>minimal_repository.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_teams_list.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA team TYPE zif_ghes219=>team.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR team.
...
* todo, array, errors
  ...
  METHOD parse_projects_list_cards.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA project_card TYPE zif_ghes219=>project_card.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR project_card.
...
* todo, array, errors
  ...
  METHOD parse_projects_list_columns.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA project_column TYPE zif_ghes219=>project_column.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_list_branches.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA short_branch TYPE zif_ghes219=>short_branch.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR short_branch.
...
* todo, handle type array, no item_ref
  ...
  METHOD parse_repos_get_apps_with_acce.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA integration TYPE zif_ghes219=>integration.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR integration.
  ...
  METHOD parse_checks_list_annotations.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA check_annotation TYPE zif_ghes219=>check_annotation.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
...
* todo, array, check_runs
  ...
  METHOD parse_repos_list_collaborators.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA collaborator TYPE zif_ghes219=>collaborator.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR collaborator.
  ...
  METHOD parse_repos_list_commit_commen.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA commit_comment TYPE zif_ghes219=>commit_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_reactions_list_for_commi.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA reaction TYPE zif_ghes219=>reaction.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR reaction.
  ...
  METHOD parse_repos_list_commits.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA commit TYPE zif_ghes219=>commit.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR commit.
  ...
  METHOD parse_repos_list_branches_for_.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA branch_short TYPE zif_ghes219=>branch_short.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR branch_short.
  ...
  METHOD parse_repos_list_pull_requests.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA pull_request_simple TYPE zif_ghes219=>pull_request_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
...
* todo, array, check_suites
  ...
  METHOD parse_repos_list_commit_status.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA status TYPE zif_ghes219=>status.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR status.
  ...
  METHOD parse_repos_list_contributors.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA contributor TYPE zif_ghes219=>contributor.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR contributor.
  ...
  METHOD parse_repos_list_deployments.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA deployment TYPE zif_ghes219=>deployment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR deployment.
  ...
  METHOD parse_repos_list_deployment_st.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA deployment_status TYPE zif_ghes219=>deployment_status.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_git_list_matching_refs.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA git_ref TYPE zif_ghes219=>git_ref.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR git_ref.
  ...
  METHOD parse_repos_list_webhooks.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA hook TYPE zif_ghes219=>hook.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR hook.
  ...
  METHOD parse_repos_list_invitations.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA repository_invitation TYPE zif_ghes219=>repository_invitation.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_issues_list_for_repo.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA issue_simple TYPE zif_ghes219=>issue_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR issue_simple.
  ...
  METHOD parse_issues_list_comments_for.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA issue_comment TYPE zif_ghes219=>issue_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR issue_comment.
  ...
  METHOD parse_issues_list_events_for_r.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA issue_event TYPE zif_ghes219=>issue_event.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR issue_event.
  ...
  METHOD parse_issues_list_events.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA issue_event_for_issue TYPE zif_ghes219=>issue_event_for_issue.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_issues_list_labels_on_is.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA label TYPE zif_ghes219=>label.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR label.
  ...
  METHOD parse_issues_list_events_for_t.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA timeline_issue_events TYPE zif_ghes219=>timeline_issue_events.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_list_deploy_keys.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA deploy_key TYPE zif_ghes219=>deploy_key.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR deploy_key.
  ...
  METHOD parse_issues_list_milestones.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA milestone TYPE zif_ghes219=>milestone.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR milestone.
  ...
  METHOD parse_repos_list_pages_builds.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA page_build TYPE zif_ghes219=>page_build.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR page_build.
  ...
  METHOD parse_enterprise_admin_list_03.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA repository_pre_receive_hook TYPE zif_ghes219=>repository_pre_receive_hook.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR repository_pre_receive_hook.
      repository_pre_receive_hook = parse_repository_pre_receive_h( iv_prefix && '/' && lv_member ).
      APPEND repository_pre_receive_hook TO response_enterprise_admin_li06.
    ENDLOOP.
  ENDMETHOD.
  ...
  METHOD parse_pulls_list_review_commen.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA pull_request_review_comment TYPE zif_ghes219=>pull_request_review_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_pulls_list_files.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA diff_entry TYPE zif_ghes219=>diff_entry.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR diff_entry.
  ...
  METHOD parse_pulls_list_reviews.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA pull_request_review TYPE zif_ghes219=>pull_request_review.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_pulls_list_comments_for_.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA review_comment TYPE zif_ghes219=>review_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_list_releases.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA release TYPE zif_ghes219=>release.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR release.
  ...
  METHOD parse_repos_list_release_asset.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA release_asset TYPE zif_ghes219=>release_asset.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR release_asset.
  ...
  METHOD parse_repos_get_code_frequency.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA code_frequency_stat TYPE zif_ghes219=>code_frequency_stat.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_get_commit_activit.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA commit_activity TYPE zif_ghes219=>commit_activity.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_get_contributors_s.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA contributor_activity TYPE zif_ghes219=>contributor_activity.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
...
* todo, array, items
  ...
  METHOD parse_enterprise_admin_get_all.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA ssh_key TYPE zif_ghes219=>ssh_key.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR ssh_key.
      ssh_key = parse_ssh_key( iv_prefix && '/' && lv_member ).
      APPEND ssh_key TO response_enterprise_admin_get_.
    ENDLOOP.
  ENDMETHOD.

  METHOD parse_enterprise_admin_add_aut.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA ssh_key TYPE zif_ghes219=>ssh_key.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR ssh_key.
      ssh_key = parse_ssh_key( iv_prefix && '/' && lv_member ).
      APPEND ssh_key TO response_enterprise_admin_add_.
    ENDLOOP.
  ENDMETHOD.

  METHOD parse_enterprise_admin_remove_.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA ssh_key TYPE zif_ghes219=>ssh_key.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR ssh_key.
      ssh_key = parse_ssh_key( iv_prefix && '/' && lv_member ).
      APPEND ssh_key TO response_enterprise_admin_remo.
    ENDLOOP.
  ENDMETHOD.

  METHOD parse_teams_list_discussions.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA team_discussion TYPE zif_ghes219=>team_discussion.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_teams_list_discussion_co.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA team_discussion_comment TYPE zif_ghes219=>team_discussion_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_teams_list_members.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA simple_user TYPE zif_ghes219=>simple_user.
    lt_members = mo_json->members( iv_prefix && '/' ).
  ...
  METHOD parse_teams_list_projects.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA team_project TYPE zif_ghes219=>team_project.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR team_project.
      team_project = parse_team_project( iv_prefix && '/' && lv_member ).
      APPEND team_project TO response_teams_list_projects.
    ENDLOOP.
  ENDMETHOD.
  ...
  METHOD parse_teams_list_repos.
    ...
    LOOP AT lt_members INTO lv_member.
      CLEAR minimal_repository.
      minimal_repository = parse_minimal_repository( iv_prefix && '/' && lv_member ).
      APPEND minimal_repository TO response_teams_list_repos.
    ENDLOOP.
  ENDMETHOD.

  METHOD parse_teams_list_child.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA team_2 TYPE zif_ghes219=>team_2.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR team_2.
      team_2 = parse_team_2( iv_prefix && '/' && lv_member ).
      APPEND team_2 TO response_teams_list_child.
    ENDLOOP.
  ENDMETHOD.
  ...
  METHOD parse_users_list_emails_for_au.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA email TYPE zif_ghes219=>email.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR email.
  ...
  METHOD parse_users_list_gpg_keys_for_.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA gpg_key TYPE zif_ghes219=>gpg_key.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR gpg_key.
...
* todo, array, repositories
  ...
  METHOD parse_orgs_list_memberships_fo.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA org_membership TYPE zif_ghes219=>org_membership.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_list_for_authentic.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA repository TYPE zif_ghes219=>repository.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR repository.
  ...
  METHOD parse_teams_list_for_authentic.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA team_full TYPE zif_ghes219=>team_full.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR team_full.
  ...
  METHOD parse_users_list_public_keys_f.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA key_simple TYPE zif_ghes219=>key_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR key_simple.
...
*  json = json && '"events":' not simple
  ...
  METHOD json_enterprise_admin_create_o.
    json = json && '{'.
    json = json && |"login": "{ data-login }",|.
    json = json && |"admin": "{ data-admin }",|.
    json = json && |"profile_name": "{ data-profile_name }",|.
    json = substring( val = json off = 0 len = strlen( json ) - 1 ).
    json = json && '}'.
  ENDMETHOD.
  ...
  METHOD json_enterprise_admin_create_p.
    json = json && '{'.
    json = json && |"name": "{ data-name }",|.
    json = json && |"image_url": "{ data-image_url }",|.
    json = substring( val = json off = 0 len = strlen( json ) - 1 ).
    json = json && '}'.
  ENDMETHOD.
...
*  json = json && '"team_ids":' not simple
  ...
  METHOD zif_ghes219~enterprise_admin_list_global_w.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_enterprise_admin_list_gl( '' ).
  ENDMETHOD.

  METHOD zif_ghes219~enterprise_admin_create_global.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/admin/hooks'.
  ...
  METHOD zif_ghes219~enterprise_admin_get_global_we.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_update_global.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/admin/hooks/{hook_id}'.
    lv_temp = hook_id.
  ...
  METHOD zif_ghes219~enterprise_admin_delete_global.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/admin/hooks/{hook_id}'.
    lv_temp = hook_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~enterprise_admin_ping_global_w.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~enterprise_admin_list_public_k.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_enterprise_admin_list_pu( '' ).
  ENDMETHOD.

  METHOD zif_ghes219~enterprise_admin_delete_public.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~enterprise_admin_update_ldap_m.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_sync_ldap_map.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_enterprise_admin_sync_ld( '' ).
  ENDMETHOD.

  METHOD zif_ghes219~enterprise_admin_update_ldap01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_sync_ldap_m01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_enterprise_admin_sync_01( '' ).
  ENDMETHOD.

  METHOD zif_ghes219~enterprise_admin_create_org.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_update_org_na.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~enterprise_admin_list_pre_rece.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_enterprise_admin_list_pr( '' ).
  ENDMETHOD.

  METHOD zif_ghes219~enterprise_admin_create_pre_re.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/admin/pre-receive-environments'.
    mi_client->request->set_method( 'POST' ).
  ...
  METHOD zif_ghes219~enterprise_admin_get_pre_recei.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_update_pre_re.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/admin/pre-receive-environments/{pre_receive_environment_id}'.
    lv_temp = pre_receive_environment_id.
  ...
  METHOD zif_ghes219~enterprise_admin_delete_pre_re.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/admin/pre-receive-environments/{pre_receive_environment_id}'.
    lv_temp = pre_receive_environment_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~enterprise_admin_start_pre_rec.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~enterprise_admin_get_download_.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_list_pre_re01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_create_pre_01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/admin/pre-receive-hooks'.
    mi_client->request->set_method( 'POST' ).
  ...
  METHOD zif_ghes219~enterprise_admin_get_pre_rec01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_update_pre_01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/admin/pre-receive-hooks/{pre_receive_hook_id}'.
    lv_temp = pre_receive_hook_id.
  ...
  METHOD zif_ghes219~enterprise_admin_delete_pre_01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/admin/pre-receive-hooks/{pre_receive_hook_id}'.
    lv_temp = pre_receive_hook_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~enterprise_admin_list_personal.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_enterprise_admin_list_pe( '' ).
  ENDMETHOD.

  METHOD zif_ghes219~enterprise_admin_delete_person.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~enterprise_admin_create_user.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_update_userna.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~enterprise_admin_delete_user.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/admin/users/{username}'.
    REPLACE ALL OCCURRENCES OF '{username}' IN lv_uri WITH username.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~enterprise_admin_create_impers.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_delete_impers.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/admin/users/{username}/authorizations'.
    REPLACE ALL OCCURRENCES OF '{username}' IN lv_uri WITH username.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~apps_get_authenticated.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~apps_create_from_manifest.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~apps_list_installations.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~apps_get_installation.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~apps_delete_installation.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/app/installations/{installation_id}'.
    lv_temp = installation_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~apps_create_installation_acces.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~oauth_authorizations_revoke_gr.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/applications/{client_id}/grants/{access_token}'.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~oauth_authorizations_check_aut.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/applications/{client_id}/tokens/{access_token}'.
    REPLACE ALL OCCURRENCES OF '{client_id}' IN lv_uri WITH client_id.
    REPLACE ALL OCCURRENCES OF '{access_token}' IN lv_uri WITH access_token.
    mi_client->request->set_method( 'GET' ).
    mi_client->request->set_header_field( name = '~request_uri' value = lv_uri ).
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_authorization_with_user( '' ).
  ENDMETHOD.

  METHOD zif_ghes219~oauth_authorizations_reset_aut.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/applications/{client_id}/tokens/{access_token}'.
    REPLACE ALL OCCURRENCES OF '{client_id}' IN lv_uri WITH client_id.
  ...
  METHOD zif_ghes219~oauth_authorizations_revoke_au.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/applications/{client_id}/tokens/{access_token}'.
    REPLACE ALL OCCURRENCES OF '{client_id}' IN lv_uri WITH client_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~apps_get_by_slug.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~codes_of_conduct_get_all_codes.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~codes_of_conduct_get_conduct_c.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_get_license_i.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_get_all_stats.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_get_comment_s.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_get_all_sta01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_get_hooks_sta.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_get_issue_sta.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_get_milestone.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_get_org_stats.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_get_pages_sta.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_get_pull_requ.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_get_repo_stat.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_get_user_stat.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~activity_list_public_events.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~activity_get_feeds.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~gists_create.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/gists'.
    mi_client->request->set_method( 'POST' ).
  ...
  METHOD zif_ghes219~gists_list_public.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~gists_list_starred.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~gists_update.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/gists/{gist_id}'.
    REPLACE ALL OCCURRENCES OF '{gist_id}' IN lv_uri WITH gist_id.
  ...
  METHOD zif_ghes219~gists_delete.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/gists/{gist_id}'.
    REPLACE ALL OCCURRENCES OF '{gist_id}' IN lv_uri WITH gist_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~gists_list_comments.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~gists_create_comment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/gists/{gist_id}/comments'.
    REPLACE ALL OCCURRENCES OF '{gist_id}' IN lv_uri WITH gist_id.
  ...
  METHOD zif_ghes219~gists_get_comment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~gists_update_comment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/gists/{gist_id}/comments/{comment_id}'.
    REPLACE ALL OCCURRENCES OF '{gist_id}' IN lv_uri WITH gist_id.
  ...
  METHOD zif_ghes219~gists_delete_comment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/gists/{gist_id}/comments/{comment_id}'.
    REPLACE ALL OCCURRENCES OF '{gist_id}' IN lv_uri WITH gist_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~gists_list_commits.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~gists_list_forks.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~gists_check_is_starred.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~gists_unstar.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/gists/{gist_id}/star'.
    REPLACE ALL OCCURRENCES OF '{gist_id}' IN lv_uri WITH gist_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~gists_get_revision.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~gitignore_get_all_templates.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~gitignore_get_template.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~apps_list_repos_accessible_to_.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_list.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~licenses_get_all_commonly_used.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~licenses_get.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~markdown_render.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~markdown_render_raw.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~activity_list_public_events_fo.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~activity_list_notifications_fo.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~activity_mark_notifications_as.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/notifications'.
    mi_client->request->set_method( 'PUT' ).
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~activity_get_thread.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~activity_mark_thread_as_read.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/notifications/threads/{thread_id}'.
    lv_temp = thread_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~activity_get_thread_subscripti.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~activity_set_thread_subscripti.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/notifications/threads/{thread_id}/subscription'.
    lv_temp = thread_id.
  ...
  METHOD zif_ghes219~activity_delete_thread_subscri.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/notifications/threads/{thread_id}/subscription'.
    lv_temp = thread_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~meta_get_octocat.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~orgs_update.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
  ...
  METHOD zif_ghes219~activity_list_public_org_event.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~orgs_list_webhooks.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~orgs_create_webhook.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/hooks'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
  ...
  METHOD zif_ghes219~orgs_get_webhook.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~orgs_update_webhook.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/hooks/{hook_id}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
  ...
  METHOD zif_ghes219~orgs_delete_webhook.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/hooks/{hook_id}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~orgs_ping_webhook.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~apps_get_org_installation.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~orgs_list_app_installations.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_list_for_org.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~orgs_list_members.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~orgs_check_membership_for_user.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~orgs_remove_member.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/members/{username}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~orgs_get_membership_for_user.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~orgs_set_membership_for_user.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/memberships/{username}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
  ...
  METHOD zif_ghes219~orgs_remove_membership_for_use.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/memberships/{username}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~orgs_list_outside_collaborator.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~orgs_convert_member_to_outside.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~orgs_remove_outside_collaborat.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/outside_collaborators/{username}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~enterprise_admin_list_pre_re02.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_get_pre_rec02.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_update_pre_02.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/pre-receive-hooks/{pre_receive_hook_id}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
  ...
  METHOD zif_ghes219~enterprise_admin_remove_pre_re.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/pre-receive-hooks/{pre_receive_hook_id}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
  ...
  METHOD zif_ghes219~projects_list_for_org.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~projects_create_for_org.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/projects'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
  ...
  METHOD zif_ghes219~orgs_list_public_members.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~orgs_check_public_membership_f.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~orgs_set_public_membership_for.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/public_members/{username}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~orgs_remove_public_membership_.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/public_members/{username}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_list_for_org.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_create_in_org.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/repos'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
  ...
  METHOD zif_ghes219~teams_create.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/teams'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
  ...
  METHOD zif_ghes219~teams_get_by_name.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~projects_get_card.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~projects_update_card.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/projects/columns/cards/{card_id}'.
    lv_temp = card_id.
  ...
  METHOD zif_ghes219~projects_delete_card.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/projects/columns/cards/{card_id}'.
    lv_temp = card_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~projects_move_card.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~projects_get_column.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~projects_update_column.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/projects/columns/{column_id}'.
    lv_temp = column_id.
  ...
  METHOD zif_ghes219~projects_delete_column.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/projects/columns/{column_id}'.
    lv_temp = column_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~projects_list_cards.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~projects_create_card.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/projects/columns/{column_id}/cards'.
    lv_temp = column_id.
  ...
  METHOD zif_ghes219~projects_move_column.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~projects_get.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~projects_update.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/projects/{project_id}'.
    lv_temp = project_id.
  ...
  METHOD zif_ghes219~projects_delete.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/projects/{project_id}'.
    lv_temp = project_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~projects_list_collaborators.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~projects_add_collaborator.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~projects_remove_collaborator.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/projects/{project_id}/collaborators/{username}'.
    lv_temp = project_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~projects_get_permission_for_us.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~projects_list_columns.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~projects_create_column.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/projects/{project_id}/columns'.
    lv_temp = project_id.
  ...
  METHOD zif_ghes219~rate_limit_get.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~reactions_delete.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_update.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_delete.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~issues_list_assignees.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_check_user_can_be_assig.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_list_branches.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_get_branch.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_get_branch_protection.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_update_branch_protection.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_delete_branch_protection.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_get_admin_branch_protect.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_set_admin_branch_protect.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/enforce_admins'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_delete_admin_branch_prot.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/enforce_admins'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_get_pull_request_review_.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_update_pull_request_revi.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/required_pull_request_reviews'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_delete_pull_request_revi.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/required_pull_request_reviews'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_get_commit_signature_pro.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_create_commit_signature_.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/required_signatures'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_delete_commit_signature_.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/required_signatures'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_get_status_checks_protec.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_update_status_check_prot.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_remove_status_check_prot.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_get_all_status_check_con.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_add_status_check_context.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_set_status_check_context.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_remove_status_check_cont.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_get_access_restrictions.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_delete_access_restrictio.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/restrictions'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_get_apps_with_access_to_.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_add_app_access_restricti.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/apps'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_set_app_access_restricti.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/apps'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_remove_app_access_restri.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/apps'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_get_teams_with_access_to.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_add_team_access_restrict.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_set_team_access_restrict.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_remove_team_access_restr.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_get_users_with_access_to.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_add_user_access_restrict.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/users'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_set_user_access_restrict.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/users'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_remove_user_access_restr.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/users'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~checks_create.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~checks_update.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/check-runs/{check_run_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~checks_list_annotations.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~checks_create_suite.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~checks_set_suites_preferences.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~checks_get_suite.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~checks_list_for_suite.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~checks_rerequest_suite.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_list_collaborators.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_check_collaborator.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_add_collaborator.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/collaborators/{username}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_remove_collaborator.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/collaborators/{username}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_get_collaborator_permiss.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_list_commit_comments_for.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_get_commit_comment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_update_commit_comment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/comments/{comment_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_delete_commit_comment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/comments/{comment_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~reactions_list_for_commit_comm.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~reactions_create_for_commit_co.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/comments/{comment_id}/reactions'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_list_commits.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_list_branches_for_head_c.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_list_comments_for_commit.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_create_commit_comment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/commits/{commit_sha}/comments'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_list_pull_requests_assoc.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_get_commit.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~checks_list_for_ref.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~checks_list_suites_for_ref.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_get_combined_status_for_.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_list_commit_statuses_for.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_create_or_update_file_co.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/contents/{path}'.
    REPLACE ALL OCCURRENCES OF '{path}' IN lv_uri WITH path.
  ...
  METHOD zif_ghes219~repos_delete_file.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/contents/{path}'.
    REPLACE ALL OCCURRENCES OF '{path}' IN lv_uri WITH path.
  ...
  METHOD zif_ghes219~repos_list_contributors.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_list_deployments.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_create_deployment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/deployments'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_get_deployment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_list_deployment_statuses.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_create_deployment_status.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/deployments/{deployment_id}/statuses'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_get_deployment_status.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~activity_list_repo_events.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_list_forks.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_create_fork.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/forks'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~git_create_blob.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~git_get_blob.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~git_create_commit.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~git_get_commit.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~git_list_matching_refs.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~git_get_ref.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~git_create_ref.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~git_update_ref.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~git_delete_ref.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/git/refs/{ref}'.
    REPLACE ALL OCCURRENCES OF '{ref}' IN lv_uri WITH ref.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~git_create_tag.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~git_get_tag.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~git_create_tree.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~git_get_tree.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_list_webhooks.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_create_webhook.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/hooks'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_get_webhook.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_update_webhook.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/hooks/{hook_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_delete_webhook.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/hooks/{hook_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_ping_webhook.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_test_push_webhook.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~apps_get_repo_installation.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_list_invitations.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_update_invitation.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_delete_invitation.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/invitations/{invitation_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~issues_list_for_repo.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_create.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/issues'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~issues_list_comments_for_repo.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_get_comment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_update_comment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/issues/comments/{comment_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~issues_delete_comment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/issues/comments/{comment_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~reactions_list_for_issue_comme.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~reactions_create_for_issue_com.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/issues/comments/{comment_id}/reactions'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~issues_list_events_for_repo.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_get_event.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_update.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/issues/{issue_number}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~issues_add_assignees.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_remove_assignees.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/issues/{issue_number}/assignees'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~issues_list_comments.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_create_comment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/issues/{issue_number}/comments'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~issues_list_events.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_list_labels_on_issue.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_add_labels.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/issues/{issue_number}/labels'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~issues_set_labels.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/issues/{issue_number}/labels'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~issues_remove_all_labels.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/issues/{issue_number}/labels'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~issues_remove_label.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_lock.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~issues_unlock.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/issues/{issue_number}/lock'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~reactions_list_for_issue.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~reactions_create_for_issue.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/issues/{issue_number}/reactions'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~issues_list_events_for_timelin.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_list_deploy_keys.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_create_deploy_key.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/keys'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_get_deploy_key.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_delete_deploy_key.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/keys/{key_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~issues_list_labels_for_repo.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_create_label.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/labels'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~issues_get_label.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_update_label.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/labels/{name}'.
    REPLACE ALL OCCURRENCES OF '{name}' IN lv_uri WITH name.
  ...
  METHOD zif_ghes219~issues_delete_label.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/labels/{name}'.
    REPLACE ALL OCCURRENCES OF '{name}' IN lv_uri WITH name.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_list_languages.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~licenses_get_for_repo.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_merge.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_list_milestones.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_create_milestone.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/milestones'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~issues_get_milestone.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~issues_update_milestone.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/milestones/{milestone_number}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~issues_delete_milestone.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/milestones/{milestone_number}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~issues_list_labels_for_milesto.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~activity_list_repo_notificatio.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~activity_mark_repo_notificatio.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/notifications'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_get_pages.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_create_pages_site.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pages'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_update_information_about.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pages'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_delete_pages_site.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pages'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_list_pages_builds.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_request_pages_build.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pages/builds'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_get_latest_pages_build.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_get_pages_build.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_list_pre_re03.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_get_pre_rec03.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_update_pre_03.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pre-receive-hooks/{pre_receive_hook_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~enterprise_admin_remove_pre_01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pre-receive-hooks/{pre_receive_hook_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~projects_list_for_repo.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~projects_create_for_repo.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/projects'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~pulls_create.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pulls'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~pulls_list_review_comments_for.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~pulls_get_review_comment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~pulls_update_review_comment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pulls/comments/{comment_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~pulls_delete_review_comment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pulls/comments/{comment_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~reactions_list_for_pull_reques.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~reactions_create_for_pull_requ.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pulls/comments/{comment_id}/reactions'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~pulls_update.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pulls/{pull_number}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~pulls_list_review_comments.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~pulls_create_review_comment_al.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pulls/{pull_number}/comments'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_legacy_review_comment( '' ).
  ENDMETHOD.

  METHOD zif_ghes219~pulls_create_reply_for_review_.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~pulls_list_commits.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~pulls_list_files.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~pulls_check_if_merged.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~pulls_merge.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pulls/{pull_number}/merge'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~pulls_list_requested_reviewers.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~pulls_request_reviewers.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pulls/{pull_number}/requested_reviewers'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~pulls_remove_requested_reviewe.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pulls/{pull_number}/requested_reviewers'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~pulls_list_reviews.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~pulls_create_review.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pulls/{pull_number}/reviews'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~pulls_get_review.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~pulls_update_review.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~pulls_delete_pending_review.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~pulls_list_comments_for_review.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~pulls_dismiss_review.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~pulls_submit_review.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~pulls_update_branch.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_get_readme.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_get_readme_in_directory.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_list_releases.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_create_release.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/releases'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_get_release_asset.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_update_release_asset.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/releases/assets/{asset_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_delete_release_asset.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/releases/assets/{asset_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_get_latest_release.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_get_release_by_tag.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_get_release.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_update_release.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/releases/{release_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_delete_release.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/releases/{release_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_list_release_assets.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_upload_release_asset.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/releases/{release_id}/assets'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~activity_list_stargazers_for_r.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_get_code_frequency_stats.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_get_commit_activity_stat.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_get_contributors_stats.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_get_participation_stats.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_get_punch_card_stats.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_create_commit_status.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~activity_list_watchers_for_rep.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~activity_get_repo_subscription.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~activity_set_repo_subscription.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/subscription'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~activity_delete_repo_subscript.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/subscription'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_list_tags.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_download_tarball_archive.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_list_teams.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_get_all_topics.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_replace_all_topics.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/topics'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
  ...
  METHOD zif_ghes219~repos_transfer.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_download_zipball_archive.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_create_using_template.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_list_public.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~search_code.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~search_commits.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~search_issues_and_pull_request.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~search_labels.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~search_repos.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~search_topics.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~search_users.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_get_configura.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_start_configu.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~enterprise_admin_get_maintenan.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_enable_or_dis.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/setup/api/maintenance'.
    mi_client->request->set_method( 'POST' ).
  ...
  METHOD zif_ghes219~enterprise_admin_get_settings.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_set_settings.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/setup/api/settings'.
    mi_client->request->set_method( 'PUT' ).
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~enterprise_admin_get_all_autho.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_enterprise_admin_get_all( '' ).
  ENDMETHOD.

  METHOD zif_ghes219~enterprise_admin_add_authorize.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/setup/api/settings/authorized-keys'.
    mi_client->request->set_method( 'POST' ).
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_enterprise_admin_add_aut( '' ).
  ENDMETHOD.

  METHOD zif_ghes219~enterprise_admin_remove_author.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/setup/api/settings/authorized-keys'.
    mi_client->request->set_method( 'DELETE' ).
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_enterprise_admin_remove_( '' ).
  ENDMETHOD.

  METHOD zif_ghes219~enterprise_admin_create_enterp.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~enterprise_admin_upgrade_licen.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~teams_update.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/teams/{team_id}'.
    lv_temp = team_id.
  ...
  METHOD zif_ghes219~teams_delete.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/teams/{team_id}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~teams_list_discussions.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_teams_list_discussions( '' ).
  ENDMETHOD.

  METHOD zif_ghes219~teams_create_discussion.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/teams/{team_id}/discussions'.
    lv_temp = team_id.
  ...
  METHOD zif_ghes219~teams_get_discussion.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~teams_update_discussion.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/teams/{team_id}/discussions/{discussion_number}'.
    lv_temp = team_id.
  ...
  METHOD zif_ghes219~teams_delete_discussion.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/teams/{team_id}/discussions/{discussion_number}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~teams_list_discussion_comments.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~teams_create_discussion_commen.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/teams/{team_id}/discussions/{discussion_number}/comments'.
    lv_temp = team_id.
  ...
  METHOD zif_ghes219~teams_get_discussion_comment.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~teams_update_discussion_commen.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}'.
    lv_temp = team_id.
  ...
  METHOD zif_ghes219~teams_delete_discussion_commen.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~reactions_list_for_team_discus.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~reactions_create_for_team_disc.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}/reactions'.
    lv_temp = team_id.
  ...
  METHOD zif_ghes219~reactions_list_for_team_disc01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~reactions_create_for_team_di01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/teams/{team_id}/discussions/{discussion_number}/reactions'.
    lv_temp = team_id.
  ...
  METHOD zif_ghes219~teams_list_members.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_teams_list_members( '' ).
  ENDMETHOD.

  METHOD zif_ghes219~teams_get_membership_for_user.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~teams_add_or_update_membership.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/teams/{team_id}/memberships/{username}'.
    lv_temp = team_id.
  ...
  METHOD zif_ghes219~teams_remove_membership_for_us.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/teams/{team_id}/memberships/{username}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~teams_list_projects.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_teams_list_projects( '' ).
  ENDMETHOD.

  METHOD zif_ghes219~teams_check_permissions_for_pr.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~teams_add_or_update_project_pe.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/teams/{team_id}/projects/{project_id}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~teams_remove_project.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/teams/{team_id}/projects/{project_id}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~teams_list_repos.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_teams_list_repos( '' ).
  ENDMETHOD.

  METHOD zif_ghes219~teams_check_permissions_for_re.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_minimal_repository( '' ).
  ENDMETHOD.

  METHOD zif_ghes219~teams_add_or_update_repo_permi.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/teams/{team_id}/repos/{owner}/{repo}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~teams_remove_repo.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/teams/{team_id}/repos/{owner}/{repo}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~teams_list_child.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_teams_list_child( '' ).
  ENDMETHOD.

  METHOD zif_ghes219~users_get_authenticated.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~users_update_authenticated.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/user'.
    mi_client->request->set_method( 'PATCH' ).
  ...
  METHOD zif_ghes219~users_list_emails_for_authenti.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~users_add_email_for_authentica.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/user/emails'.
    mi_client->request->set_method( 'POST' ).
  ...
  METHOD zif_ghes219~users_delete_email_for_authent.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/user/emails'.
    mi_client->request->set_method( 'DELETE' ).
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~users_list_followers_for_authe.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~users_list_followed_by_authent.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~users_check_person_is_followed.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~users_follow.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/user/following/{username}'.
    REPLACE ALL OCCURRENCES OF '{username}' IN lv_uri WITH username.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~users_unfollow.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/user/following/{username}'.
    REPLACE ALL OCCURRENCES OF '{username}' IN lv_uri WITH username.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~users_list_gpg_keys_for_authen.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~users_create_gpg_key_for_authe.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/user/gpg_keys'.
    mi_client->request->set_method( 'POST' ).
  ...
  METHOD zif_ghes219~users_get_gpg_key_for_authenti.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~users_delete_gpg_key_for_authe.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/user/gpg_keys/{gpg_key_id}'.
    lv_temp = gpg_key_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~apps_list_installations_for_au.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~apps_list_installation_repos_f.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~apps_add_repo_to_installation.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~apps_remove_repo_from_installa.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/user/installations/{installation_id}/repositories/{repository_id}'.
    lv_temp = installation_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~issues_list_for_authenticated_.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~users_list_public_ssh_keys_for.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~users_create_public_ssh_key_fo.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/user/keys'.
    mi_client->request->set_method( 'POST' ).
  ...
  METHOD zif_ghes219~users_get_public_ssh_key_for_a.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~users_delete_public_ssh_key_fo.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/user/keys/{key_id}'.
    lv_temp = key_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~orgs_list_memberships_for_auth.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~orgs_get_membership_for_authen.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~orgs_update_membership_for_aut.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/user/memberships/orgs/{org}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
  ...
  METHOD zif_ghes219~orgs_list_for_authenticated_us.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~projects_create_for_authentica.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~users_list_public_emails_for_a.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_list_for_authenticated_u.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_create_for_authenticated.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/user/repos'.
    mi_client->request->set_method( 'POST' ).
  ...
  METHOD zif_ghes219~repos_list_invitations_for_aut.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_accept_invitation.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~repos_decline_invitation.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/user/repository_invitations/{invitation_id}'.
    lv_temp = invitation_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~activity_list_repos_starred_by.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~activity_check_repo_is_starred.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~activity_star_repo_for_authent.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/user/starred/{owner}/{repo}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~activity_unstar_repo_for_authe.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/user/starred/{owner}/{repo}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~activity_list_watched_repos_fo.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~teams_list_for_authenticated_u.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~users_get_by_username.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~activity_list_events_for_authe.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~activity_list_org_events_for_a.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~activity_list_public_events_01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~users_list_followers_for_user.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~users_list_following_for_user.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~users_check_following_for_user.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~gists_list_for_user.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~users_list_gpg_keys_for_user.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~users_get_context_for_user.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~apps_get_user_installation.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~users_list_public_keys_for_use.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~orgs_list_for_user.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~projects_list_for_user.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~activity_list_received_events_.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~activity_list_received_public_.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~repos_list_for_user.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_promote_user_.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~enterprise_admin_demote_site_a.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/users/{username}/site_admin'.
    REPLACE ALL OCCURRENCES OF '{username}' IN lv_uri WITH username.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~activity_list_repos_starred_01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~activity_list_repos_watched_by.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes219~enterprise_admin_suspend_user.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~enterprise_admin_unsuspend_use.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/users/{username}/suspended'.
    REPLACE ALL OCCURRENCES OF '{username}' IN lv_uri WITH username.
...
* todo, handle more responses
  ...
  METHOD zif_ghes219~meta_get_zen.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
