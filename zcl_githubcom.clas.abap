CLASS zcl_githubcom DEFINITION PUBLIC.
* Generated by abap-openapi-client
* GitHub v3 REST API
  PUBLIC SECTION.
    INTERFACES zif_githubcom.
  ...
  PROTECTED SECTION.
    ...
    METHODS parse_simple_user
      ...
      RETURNING VALUE(simple_user) TYPE zif_githubcom=>simple_user
      RAISING cx_static_check.
    METHODS parse_integration
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(integration) TYPE zif_githubcom=>integration
      RAISING cx_static_check.
    METHODS parse_basic_error
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(basic_error) TYPE zif_githubcom=>basic_error
      RAISING cx_static_check.
    METHODS parse_validation_error_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(validation_error_simple) TYPE zif_githubcom=>validation_error_simple
      RAISING cx_static_check.
    METHODS parse_webhook_config_url
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(webhook_config_url) TYPE zif_githubcom=>webhook_config_url
      RAISING cx_static_check.
    METHODS parse_webhook_config_content_t
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(webhook_config_content_type) TYPE zif_githubcom=>webhook_config_content_type
      RAISING cx_static_check.
    METHODS parse_webhook_config_secret
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(webhook_config_secret) TYPE zif_githubcom=>webhook_config_secret
      RAISING cx_static_check.
    METHODS parse_webhook_config_insecure_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(webhook_config_insecure_ssl) TYPE zif_githubcom=>webhook_config_insecure_ssl
      RAISING cx_static_check.
    ...
    METHODS parse_installation
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(installation) TYPE zif_githubcom=>installation
      RAISING cx_static_check.
    METHODS parse_app_permissions
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(app_permissions) TYPE zif_githubcom=>app_permissions
      RAISING cx_static_check.
    METHODS parse_license_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(license_simple) TYPE zif_githubcom=>license_simple
      RAISING cx_static_check.
    METHODS parse_repository
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repository) TYPE zif_githubcom=>repository
      RAISING cx_static_check.
    ...
    METHODS parse_application_grant
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(application_grant) TYPE zif_githubcom=>application_grant
      RAISING cx_static_check.
    METHODS parse_scoped_installation
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(scoped_installation) TYPE zif_githubcom=>scoped_installation
      RAISING cx_static_check.
    METHODS parse_authorization
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(authorization) TYPE zif_githubcom=>authorization
      RAISING cx_static_check.
    ...
    METHODS parse_allowed_actions
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(allowed_actions) TYPE zif_githubcom=>allowed_actions
      RAISING cx_static_check.
    METHODS parse_selected_actions_url
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(selected_actions_url) TYPE zif_githubcom=>selected_actions_url
      RAISING cx_static_check.
    METHODS parse_actions_enterprise_permi
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(actions_enterprise_permissions) TYPE zif_githubcom=>actions_enterprise_permissions
      RAISING cx_static_check.
    METHODS parse_organization_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(organization_simple) TYPE zif_githubcom=>organization_simple
      RAISING cx_static_check.
    METHODS parse_selected_actions
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(selected_actions) TYPE zif_githubcom=>selected_actions
      RAISING cx_static_check.
    ...
    METHODS parse_runner_application
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(runner_application) TYPE zif_githubcom=>runner_application
      RAISING cx_static_check.
    METHODS parse_authentication_token
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(authentication_token) TYPE zif_githubcom=>authentication_token
      RAISING cx_static_check.
    ...
    METHODS parse_combined_billing_usage
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(combined_billing_usage) TYPE zif_githubcom=>combined_billing_usage
      RAISING cx_static_check.
    METHODS parse_actor
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(actor) TYPE zif_githubcom=>actor
      RAISING cx_static_check.
    METHODS parse_label
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(label) TYPE zif_githubcom=>label
      RAISING cx_static_check.
    METHODS parse_milestone
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(milestone) TYPE zif_githubcom=>milestone
      RAISING cx_static_check.
    METHODS parse_author_association
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(author_association) TYPE zif_githubcom=>author_association
      RAISING cx_static_check.
    METHODS parse_issue_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_simple) TYPE zif_githubcom=>issue_simple
      RAISING cx_static_check.
    METHODS parse_reaction_rollup
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(reaction_rollup) TYPE zif_githubcom=>reaction_rollup
      RAISING cx_static_check.
    METHODS parse_issue_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_comment) TYPE zif_githubcom=>issue_comment
      RAISING cx_static_check.
    METHODS parse_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(event) TYPE zif_githubcom=>event
      RAISING cx_static_check.
    METHODS parse_link_with_type
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(link_with_type) TYPE zif_githubcom=>link_with_type
      RAISING cx_static_check.
    METHODS parse_feed
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(feed) TYPE zif_githubcom=>feed
      RAISING cx_static_check.
    METHODS parse_base_gist
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(base_gist) TYPE zif_githubcom=>base_gist
      RAISING cx_static_check.
    METHODS parse_gist_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gist_simple) TYPE zif_githubcom=>gist_simple
      RAISING cx_static_check.
    METHODS parse_gist_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gist_comment) TYPE zif_githubcom=>gist_comment
      RAISING cx_static_check.
    METHODS parse_gist_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gist_commit) TYPE zif_githubcom=>gist_commit
      RAISING cx_static_check.
    METHODS parse_gitignore_template
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gitignore_template) TYPE zif_githubcom=>gitignore_template
      RAISING cx_static_check.
    METHODS parse_issue
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue) TYPE zif_githubcom=>issue
      RAISING cx_static_check.
    METHODS parse_license
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(license) TYPE zif_githubcom=>license
      RAISING cx_static_check.
    METHODS parse_marketplace_listing_plan
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(marketplace_listing_plan) TYPE zif_githubcom=>marketplace_listing_plan
      RAISING cx_static_check.
    METHODS parse_marketplace_purchase
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(marketplace_purchase) TYPE zif_githubcom=>marketplace_purchase
      RAISING cx_static_check.
    ...
    METHODS parse_thread
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(thread) TYPE zif_githubcom=>thread
      RAISING cx_static_check.
    ...
    METHODS parse_enabled_repositories
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enabled_repositories) TYPE zif_githubcom=>enabled_repositories
      RAISING cx_static_check.
    ...
    METHODS parse_organization_actions_sec
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(organization_actions_secret) TYPE zif_githubcom=>organization_actions_secret
      RAISING cx_static_check.
    ...
    METHODS parse_org_hook
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(org_hook) TYPE zif_githubcom=>org_hook
      RAISING cx_static_check.
    METHODS parse_interaction_group
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(interaction_group) TYPE zif_githubcom=>interaction_group
      RAISING cx_static_check.
    METHODS parse_interaction_limit_respon
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(interaction_limit_response) TYPE zif_githubcom=>interaction_limit_response
      RAISING cx_static_check.
    METHODS parse_interaction_expiry
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(interaction_expiry) TYPE zif_githubcom=>interaction_expiry
      RAISING cx_static_check.
    METHODS parse_interaction_limit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(interaction_limit) TYPE zif_githubcom=>interaction_limit
      RAISING cx_static_check.
    METHODS parse_team_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_simple) TYPE zif_githubcom=>team_simple
      RAISING cx_static_check.
    METHODS parse_team
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team) TYPE zif_githubcom=>team
      RAISING cx_static_check.
    METHODS parse_org_membership
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(org_membership) TYPE zif_githubcom=>org_membership
      RAISING cx_static_check.
    METHODS parse_migration
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(migration) TYPE zif_githubcom=>migration
      RAISING cx_static_check.
    ...
    METHODS parse_team_full
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_full) TYPE zif_githubcom=>team_full
      RAISING cx_static_check.
    METHODS parse_team_discussion
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_discussion) TYPE zif_githubcom=>team_discussion
      RAISING cx_static_check.
    METHODS parse_team_discussion_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_discussion_comment) TYPE zif_githubcom=>team_discussion_comment
      RAISING cx_static_check.
    METHODS parse_reaction
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(reaction) TYPE zif_githubcom=>reaction
      RAISING cx_static_check.
    METHODS parse_team_membership
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_membership) TYPE zif_githubcom=>team_membership
      RAISING cx_static_check.
    METHODS parse_team_project
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_project) TYPE zif_githubcom=>team_project
      RAISING cx_static_check.
    METHODS parse_team_repository
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_repository) TYPE zif_githubcom=>team_repository
      RAISING cx_static_check.
    METHODS parse_project_card
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(project_card) TYPE zif_githubcom=>project_card
      RAISING cx_static_check.
    ...
    METHODS parse_rate_limit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(rate_limit) TYPE zif_githubcom=>rate_limit
      RAISING cx_static_check.
    METHODS parse_rate_limit_overview
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(rate_limit_overview) TYPE zif_githubcom=>rate_limit_overview
      RAISING cx_static_check.
    METHODS parse_full_repository
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(full_repository) TYPE zif_githubcom=>full_repository
      RAISING cx_static_check.
    METHODS parse_artifact
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(artifact) TYPE zif_githubcom=>artifact
      RAISING cx_static_check.
    METHODS parse_job
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(job) TYPE zif_githubcom=>job
      RAISING cx_static_check.
    METHODS parse_actions_enabled
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(actions_enabled) TYPE zif_githubcom=>actions_enabled
      RAISING cx_static_check.
    ...
    METHODS parse_simple_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(simple_commit) TYPE zif_githubcom=>simple_commit
      RAISING cx_static_check.
    ...
    METHODS parse_actions_secret
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(actions_secret) TYPE zif_githubcom=>actions_secret
      RAISING cx_static_check.
    METHODS parse_workflow
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(workflow) TYPE zif_githubcom=>workflow
      RAISING cx_static_check.
    ...
    METHODS parse_protected_branch_pull_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(protected_branch_pull_request_) TYPE zif_githubcom=>protected_branch_pull_request_
      RAISING cx_static_check.
    METHODS parse_branch_restriction_polic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(branch_restriction_policy) TYPE zif_githubcom=>branch_restriction_policy
      RAISING cx_static_check.
    METHODS parse_branch_protection
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(branch_protection) TYPE zif_githubcom=>branch_protection
      RAISING cx_static_check.
    METHODS parse_short_branch
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(short_branch) TYPE zif_githubcom=>short_branch
      RAISING cx_static_check.
    METHODS parse_git_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_user) TYPE zif_githubcom=>git_user
      RAISING cx_static_check.
    ...
    METHODS parse_branch_with_protection
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(branch_with_protection) TYPE zif_githubcom=>branch_with_protection
      RAISING cx_static_check.
    METHODS parse_status_check_policy
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(status_check_policy) TYPE zif_githubcom=>status_check_policy
      RAISING cx_static_check.
    ...
    METHODS parse_check_run
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(check_run) TYPE zif_githubcom=>check_run
      RAISING cx_static_check.
    METHODS parse_check_annotation
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(check_annotation) TYPE zif_githubcom=>check_annotation
      RAISING cx_static_check.
    METHODS parse_check_suite
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(check_suite) TYPE zif_githubcom=>check_suite
      RAISING cx_static_check.
    ...
    METHODS parse_code_scanning_alert_ref
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_alert_ref) TYPE zif_githubcom=>code_scanning_alert_ref
      RAISING cx_static_check.
    ...
    METHODS parse_code_scanning_alert_code
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_alert_code_scann) TYPE zif_githubcom=>code_scanning_alert_code_scann
      RAISING cx_static_check.
    ...
    METHODS parse_code_scanning_alert_inst
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_alert_instances) TYPE zif_githubcom=>code_scanning_alert_instances
      RAISING cx_static_check.
    METHODS parse_code_scanning_alert_co01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_alert_code_sca01) TYPE zif_githubcom=>code_scanning_alert_code_sca01
      RAISING cx_static_check.
    METHODS parse_code_scanning_alert_set_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_alert_set_state) TYPE zif_githubcom=>code_scanning_alert_set_state
      RAISING cx_static_check.
    METHODS parse_code_scanning_analysis_r
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_analysis_ref) TYPE zif_githubcom=>code_scanning_analysis_ref
      RAISING cx_static_check.
    ...
    METHODS parse_code_scanning_analysis03
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_analysis_code_sc) TYPE zif_githubcom=>code_scanning_analysis_code_sc
      RAISING cx_static_check.
    ...
    METHODS parse_collaborator
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(collaborator) TYPE zif_githubcom=>collaborator
      RAISING cx_static_check.
    ...
    METHODS parse_commit_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(commit_comment) TYPE zif_githubcom=>commit_comment
      RAISING cx_static_check.
    ...
    METHODS parse_branch_short
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(branch_short) TYPE zif_githubcom=>branch_short
      RAISING cx_static_check.
    METHODS parse_link
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(link) TYPE zif_githubcom=>link
      RAISING cx_static_check.
    METHODS parse_auto_merge
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(auto_merge) TYPE zif_githubcom=>auto_merge
      RAISING cx_static_check.
    METHODS parse_pull_request_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_simple) TYPE zif_githubcom=>pull_request_simple
      RAISING cx_static_check.
    METHODS parse_simple_commit_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(simple_commit_status) TYPE zif_githubcom=>simple_commit_status
      RAISING cx_static_check.
    METHODS parse_combined_commit_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(combined_commit_status) TYPE zif_githubcom=>combined_commit_status
      RAISING cx_static_check.
    METHODS parse_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(status) TYPE zif_githubcom=>status
      RAISING cx_static_check.
    METHODS parse_code_of_conduct_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_of_conduct_simple) TYPE zif_githubcom=>code_of_conduct_simple
      RAISING cx_static_check.
    METHODS parse_community_health_file
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(community_health_file) TYPE zif_githubcom=>community_health_file
      RAISING cx_static_check.
    ...
    METHODS parse_content_directory
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_directory) TYPE zif_githubcom=>content_directory
      RAISING cx_static_check.
    METHODS parse_content_file
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_file) TYPE zif_githubcom=>content_file
      RAISING cx_static_check.
    METHODS parse_content_symlink
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_symlink) TYPE zif_githubcom=>content_symlink
      RAISING cx_static_check.
    METHODS parse_content_submodule
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_submodule) TYPE zif_githubcom=>content_submodule
      RAISING cx_static_check.
    METHODS parse_file_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(file_commit) TYPE zif_githubcom=>file_commit
      RAISING cx_static_check.
    ...
    METHODS parse_short_blob
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(short_blob) TYPE zif_githubcom=>short_blob
      RAISING cx_static_check.
    METHODS parse_blob
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(blob) TYPE zif_githubcom=>blob
      RAISING cx_static_check.
    METHODS parse_git_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_commit) TYPE zif_githubcom=>git_commit
      RAISING cx_static_check.
    METHODS parse_git_ref
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_ref) TYPE zif_githubcom=>git_ref
      RAISING cx_static_check.
    METHODS parse_git_tag
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_tag) TYPE zif_githubcom=>git_tag
      RAISING cx_static_check.
    METHODS parse_git_tree
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_tree) TYPE zif_githubcom=>git_tree
      RAISING cx_static_check.
    METHODS parse_hook_response
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(hook_response) TYPE zif_githubcom=>hook_response
      RAISING cx_static_check.
    METHODS parse_hook
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(hook) TYPE zif_githubcom=>hook
      RAISING cx_static_check.
    METHODS parse_import
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(import) TYPE zif_githubcom=>import
      RAISING cx_static_check.
    METHODS parse_porter_author
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(porter_author) TYPE zif_githubcom=>porter_author
      RAISING cx_static_check.
    ...
    METHODS parse_issue_event_label
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_label) TYPE zif_githubcom=>issue_event_label
      RAISING cx_static_check.
    METHODS parse_issue_event_dismissed_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_dismissed_review) TYPE zif_githubcom=>issue_event_dismissed_review
      RAISING cx_static_check.
    METHODS parse_issue_event_milestone
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_milestone) TYPE zif_githubcom=>issue_event_milestone
      RAISING cx_static_check.
    METHODS parse_issue_event_project_card
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_project_card) TYPE zif_githubcom=>issue_event_project_card
      RAISING cx_static_check.
    METHODS parse_issue_event_rename
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_rename) TYPE zif_githubcom=>issue_event_rename
      RAISING cx_static_check.
    METHODS parse_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event) TYPE zif_githubcom=>issue_event
      RAISING cx_static_check.
    METHODS parse_issue_event_for_issue
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_for_issue) TYPE zif_githubcom=>issue_event_for_issue
      RAISING cx_static_check.
    METHODS parse_deploy_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(deploy_key) TYPE zif_githubcom=>deploy_key
      RAISING cx_static_check.
    METHODS parse_language
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(language) TYPE zif_githubcom=>language
      RAISING cx_static_check.
    METHODS parse_license_content
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(license_content) TYPE zif_githubcom=>license_content
      RAISING cx_static_check.
    METHODS parse_pages_source_hash
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pages_source_hash) TYPE zif_githubcom=>pages_source_hash
      RAISING cx_static_check.
    METHODS parse_page
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(page) TYPE zif_githubcom=>page
      RAISING cx_static_check.
    METHODS parse_page_build
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(page_build) TYPE zif_githubcom=>page_build
      RAISING cx_static_check.
    ...
    METHODS parse_pull_request
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request) TYPE zif_githubcom=>pull_request
      RAISING cx_static_check.
    METHODS parse_pull_request_review_comm
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_review_comment) TYPE zif_githubcom=>pull_request_review_comment
      RAISING cx_static_check.
    METHODS parse_pull_request_merge_resul
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_merge_result) TYPE zif_githubcom=>pull_request_merge_result
      RAISING cx_static_check.
    METHODS parse_pull_request_review_requ
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_review_request) TYPE zif_githubcom=>pull_request_review_request
      RAISING cx_static_check.
    METHODS parse_pull_request_review
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_review) TYPE zif_githubcom=>pull_request_review
      RAISING cx_static_check.
    METHODS parse_review_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(review_comment) TYPE zif_githubcom=>review_comment
      RAISING cx_static_check.
    METHODS parse_release_asset
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(release_asset) TYPE zif_githubcom=>release_asset
      RAISING cx_static_check.
    ...
    METHODS parse_code_frequency_stat
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_frequency_stat) TYPE zif_githubcom=>code_frequency_stat
      RAISING cx_static_check.
    METHODS parse_commit_activity
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(commit_activity) TYPE zif_githubcom=>commit_activity
      RAISING cx_static_check.
    METHODS parse_contributor_activity
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(contributor_activity) TYPE zif_githubcom=>contributor_activity
      RAISING cx_static_check.
    METHODS parse_participation_stats
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(participation_stats) TYPE zif_githubcom=>participation_stats
      RAISING cx_static_check.
    METHODS parse_repository_subscription
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repository_subscription) TYPE zif_githubcom=>repository_subscription
      RAISING cx_static_check.
    METHODS parse_tag
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(tag) TYPE zif_githubcom=>tag
      RAISING cx_static_check.
    METHODS parse_topic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(topic) TYPE zif_githubcom=>topic
      RAISING cx_static_check.
    METHODS parse_traffic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(traffic) TYPE zif_githubcom=>traffic
      RAISING cx_static_check.
    METHODS parse_clone_traffic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(clone_traffic) TYPE zif_githubcom=>clone_traffic
      RAISING cx_static_check.
    METHODS parse_content_traffic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_traffic) TYPE zif_githubcom=>content_traffic
      RAISING cx_static_check.
    METHODS parse_referrer_traffic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(referrer_traffic) TYPE zif_githubcom=>referrer_traffic
      RAISING cx_static_check.
    METHODS parse_view_traffic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(view_traffic) TYPE zif_githubcom=>view_traffic
      RAISING cx_static_check.
    METHODS parse_scim_group_list_enterpri
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(scim_group_list_enterprise) TYPE zif_githubcom=>scim_group_list_enterprise
      RAISING cx_static_check.
    METHODS parse_scim_enterprise_group
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(scim_enterprise_group) TYPE zif_githubcom=>scim_enterprise_group
      RAISING cx_static_check.
    METHODS parse_scim_user_list_enterpris
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(scim_user_list_enterprise) TYPE zif_githubcom=>scim_user_list_enterprise
      RAISING cx_static_check.
    METHODS parse_scim_enterprise_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(scim_enterprise_user) TYPE zif_githubcom=>scim_enterprise_user
      RAISING cx_static_check.
    METHODS parse_scim_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(scim_user) TYPE zif_githubcom=>scim_user
      RAISING cx_static_check.
    METHODS parse_scim_user_list
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(scim_user_list) TYPE zif_githubcom=>scim_user_list
      RAISING cx_static_check.
    METHODS parse_search_result_text_match
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(search_result_text_matches) TYPE zif_githubcom=>search_result_text_matches
      RAISING cx_static_check.
    METHODS parse_code_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_search_result_item) TYPE zif_githubcom=>code_search_result_item
      RAISING cx_static_check.
    METHODS parse_commit_search_result_ite
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(commit_search_result_item) TYPE zif_githubcom=>commit_search_result_item
      RAISING cx_static_check.
    METHODS parse_issue_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_search_result_item) TYPE zif_githubcom=>issue_search_result_item
      RAISING cx_static_check.
    METHODS parse_label_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(label_search_result_item) TYPE zif_githubcom=>label_search_result_item
      RAISING cx_static_check.
    METHODS parse_repo_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repo_search_result_item) TYPE zif_githubcom=>repo_search_result_item
      RAISING cx_static_check.
    METHODS parse_topic_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(topic_search_result_item) TYPE zif_githubcom=>topic_search_result_item
      RAISING cx_static_check.
    METHODS parse_user_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(user_search_result_item) TYPE zif_githubcom=>user_search_result_item
      RAISING cx_static_check.
    ...
    METHODS parse_public_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(public_user) TYPE zif_githubcom=>public_user
      RAISING cx_static_check.
    METHODS parse_email
      IMPORTING iv_prefix TYPE string
    ...
    METHODS parse_gpg_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gpg_key) TYPE zif_githubcom=>gpg_key
      RAISING cx_static_check.
    METHODS parse_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(key) TYPE zif_githubcom=>key
      RAISING cx_static_check.
    METHODS parse_marketplace_account
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(marketplace_account) TYPE zif_githubcom=>marketplace_account
      RAISING cx_static_check.
    METHODS parse_user_marketplace_purchas
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(user_marketplace_purchase) TYPE zif_githubcom=>user_marketplace_purchase
      RAISING cx_static_check.
    ...
    METHODS json_apps_create_installation_
      IMPORTING data TYPE zif_githubcom=>bodyapps_create_installation_a
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_delete_authorization
      IMPORTING data TYPE zif_githubcom=>bodyapps_delete_authorization
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_check_token
      IMPORTING data TYPE zif_githubcom=>bodyapps_check_token
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_reset_token
      IMPORTING data TYPE zif_githubcom=>bodyapps_reset_token
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_delete_token
      IMPORTING data TYPE zif_githubcom=>bodyapps_delete_token
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_oauth_authorizations_crea
      IMPORTING data TYPE zif_githubcom=>bodyoauth_authorizations_creat
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_oauth_authorizations_get_
      IMPORTING data TYPE zif_githubcom=>bodyoauth_authorizations_get_o
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_oauth_authorizations_ge01
      IMPORTING data TYPE zif_githubcom=>bodyoauth_authorizations_get01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_oauth_authorizations_upda
      IMPORTING data TYPE zif_githubcom=>bodyoauth_authorizations_updat
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_oauth_authorizations_dele
      IMPORTING data TYPE zif_githubcom=>bodyoauth_authorizations_delet
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_enterprise_admin_set_gith
      IMPORTING data TYPE zif_githubcom=>bodyenterprise_admin_set_githu
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_set_sele
      IMPORTING data TYPE zif_githubcom=>bodyenterprise_admin_set_selec
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_s
      IMPORTING data TYPE zif_githubcom=>bodyenterprise_admin_create_se
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_s
      IMPORTING data TYPE zif_githubcom=>bodyenterprise_admin_update_se
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete_s
      IMPORTING data TYPE zif_githubcom=>bodyenterprise_admin_delete_se
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_set_org_
      IMPORTING data TYPE zif_githubcom=>bodyenterprise_admin_set_org_a
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_gists_update
      IMPORTING data TYPE zif_githubcom=>bodygists_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_delete
      IMPORTING data TYPE zif_githubcom=>bodygists_delete
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_create_comment
      IMPORTING data TYPE zif_githubcom=>bodygists_create_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_update_comment
      IMPORTING data TYPE zif_githubcom=>bodygists_update_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_delete_comment
      IMPORTING data TYPE zif_githubcom=>bodygists_delete_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_markdown_render
      IMPORTING data TYPE zif_githubcom=>bodymarkdown_render
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_mark_notificatio
      IMPORTING data TYPE zif_githubcom=>bodyactivity_mark_notification
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_set_thread_subsc
      IMPORTING data TYPE zif_githubcom=>bodyactivity_set_thread_subscr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_delete_thread_su
      IMPORTING data TYPE zif_githubcom=>bodyactivity_delete_thread_sub
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_update
      IMPORTING data TYPE zif_githubcom=>bodyorgs_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_set_github_action
      IMPORTING data TYPE zif_githubcom=>bodyactions_set_github_actions
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_set_selected_repo
      IMPORTING data TYPE zif_githubcom=>bodyactions_set_selected_repos
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_create_self_hoste
      IMPORTING data TYPE zif_githubcom=>bodyactions_create_self_hosted
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_update_self_hoste
      IMPORTING data TYPE zif_githubcom=>bodyactions_update_self_hosted
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_delete_self_hoste
      IMPORTING data TYPE zif_githubcom=>bodyactions_delete_self_hosted
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_set_repo_access_t
      IMPORTING data TYPE zif_githubcom=>bodyactions_set_repo_access_to
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_actions_create_or_update_
      IMPORTING data TYPE zif_githubcom=>bodyactions_create_or_update_o
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_delete_org_secret
      IMPORTING data TYPE zif_githubcom=>bodyactions_delete_org_secret
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_orgs_update_webhook
      IMPORTING data TYPE zif_githubcom=>bodyorgs_update_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_delete_webhook
      IMPORTING data TYPE zif_githubcom=>bodyorgs_delete_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_update_webhook_confi
      IMPORTING data TYPE zif_githubcom=>bodyorgs_update_webhook_config
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_create_invitation
      IMPORTING data TYPE zif_githubcom=>bodyorgs_create_invitation
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_set_membership_for_u
      IMPORTING data TYPE zif_githubcom=>bodyorgs_set_membership_for_us
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_remove_membership_fo
      IMPORTING data TYPE zif_githubcom=>bodyorgs_remove_membership_for
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_migrations_start_for_org
      IMPORTING data TYPE zif_githubcom=>bodymigrations_start_for_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_for_org
      IMPORTING data TYPE zif_githubcom=>bodyprojects_create_for_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_in_org
      IMPORTING data TYPE zif_githubcom=>bodyrepos_create_in_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create
      IMPORTING data TYPE zif_githubcom=>bodyteams_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_in_org
      IMPORTING data TYPE zif_githubcom=>bodyteams_update_in_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_in_org
      IMPORTING data TYPE zif_githubcom=>bodyteams_delete_in_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_discussion_i
      IMPORTING data TYPE zif_githubcom=>bodyteams_create_discussion_in
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_discussion_i
      IMPORTING data TYPE zif_githubcom=>bodyteams_update_discussion_in
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_discussion_i
      IMPORTING data TYPE zif_githubcom=>bodyteams_delete_discussion_in
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_discussion_c
      IMPORTING data TYPE zif_githubcom=>bodyteams_create_discussion_co
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_discussion_c
      IMPORTING data TYPE zif_githubcom=>bodyteams_update_discussion_co
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_discussion_c
      IMPORTING data TYPE zif_githubcom=>bodyteams_delete_discussion_co
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_team
      IMPORTING data TYPE zif_githubcom=>bodyreactions_create_for_team_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_teams_add_or_update_membe
      IMPORTING data TYPE zif_githubcom=>bodyteams_add_or_update_member
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_membership_f
      IMPORTING data TYPE zif_githubcom=>bodyteams_remove_membership_fo
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_proje
      IMPORTING data TYPE zif_githubcom=>bodyteams_add_or_update_projec
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_project_in_o
      IMPORTING data TYPE zif_githubcom=>bodyteams_remove_project_in_or
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_repo_
      IMPORTING data TYPE zif_githubcom=>bodyteams_add_or_update_repo_p
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_repo_in_org
      IMPORTING data TYPE zif_githubcom=>bodyteams_remove_repo_in_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_or_update_id
      IMPORTING data TYPE zif_githubcom=>bodyteams_create_or_update_idp
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_update_card
      IMPORTING data TYPE zif_githubcom=>bodyprojects_update_card
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_delete_card
      IMPORTING data TYPE zif_githubcom=>bodyprojects_delete_card
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_move_card
      IMPORTING data TYPE zif_githubcom=>bodyprojects_move_card
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_update_column
      IMPORTING data TYPE zif_githubcom=>bodyprojects_update_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_delete_column
      IMPORTING data TYPE zif_githubcom=>bodyprojects_delete_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_card
      IMPORTING data TYPE zif_githubcom=>bodyprojects_create_card
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_move_column
      IMPORTING data TYPE zif_githubcom=>bodyprojects_move_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_update
      IMPORTING data TYPE zif_githubcom=>bodyprojects_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_delete
      IMPORTING data TYPE zif_githubcom=>bodyprojects_delete
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_add_collaborator
      IMPORTING data TYPE zif_githubcom=>bodyprojects_add_collaborator
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_remove_collabora
      IMPORTING data TYPE zif_githubcom=>bodyprojects_remove_collaborat
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_column
      IMPORTING data TYPE zif_githubcom=>bodyprojects_create_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update
      IMPORTING data TYPE zif_githubcom=>bodyrepos_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete
      IMPORTING data TYPE zif_githubcom=>bodyrepos_delete
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_actions_delete_repo_secre
      IMPORTING data TYPE zif_githubcom=>bodyactions_delete_repo_secret
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_repos_delete_branch_prote
      IMPORTING data TYPE zif_githubcom=>bodyrepos_delete_branch_protec
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_pull_request
      IMPORTING data TYPE zif_githubcom=>bodyrepos_update_pull_request_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_pull_request
      IMPORTING data TYPE zif_githubcom=>bodyrepos_delete_pull_request_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_status_check
      IMPORTING data TYPE zif_githubcom=>bodyrepos_update_status_check_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_checks_create
      IMPORTING data TYPE zif_githubcom=>bodychecks_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_update
      IMPORTING data TYPE zif_githubcom=>bodychecks_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_create_suite
      IMPORTING data TYPE zif_githubcom=>bodychecks_create_suite
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_set_suites_prefere
      IMPORTING data TYPE zif_githubcom=>bodychecks_set_suites_preferen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_code_scanning_update_aler
      IMPORTING data TYPE zif_githubcom=>bodycode_scanning_update_alert
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_repos_remove_collaborator
      IMPORTING data TYPE zif_githubcom=>bodyrepos_remove_collaborator
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_commit_comme
      IMPORTING data TYPE zif_githubcom=>bodyrepos_update_commit_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_commit_comme
      IMPORTING data TYPE zif_githubcom=>bodyrepos_delete_commit_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_comm
      IMPORTING data TYPE zif_githubcom=>bodyreactions_create_for_commi
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_repos_create_deployment
      IMPORTING data TYPE zif_githubcom=>bodyrepos_create_deployment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_deployment_s
      IMPORTING data TYPE zif_githubcom=>bodyrepos_create_deployment_st
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_repos_create_fork
      IMPORTING data TYPE zif_githubcom=>bodyrepos_create_fork
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_blob
      IMPORTING data TYPE zif_githubcom=>bodygit_create_blob
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_commit
      IMPORTING data TYPE zif_githubcom=>bodygit_create_commit
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_ref
      IMPORTING data TYPE zif_githubcom=>bodygit_create_ref
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_update_ref
      IMPORTING data TYPE zif_githubcom=>bodygit_update_ref
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_delete_ref
      IMPORTING data TYPE zif_githubcom=>bodygit_delete_ref
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_tag
      IMPORTING data TYPE zif_githubcom=>bodygit_create_tag
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_tree
      IMPORTING data TYPE zif_githubcom=>bodygit_create_tree
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_webhook
      IMPORTING data TYPE zif_githubcom=>bodyrepos_create_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_webhook
      IMPORTING data TYPE zif_githubcom=>bodyrepos_update_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_webhook
      IMPORTING data TYPE zif_githubcom=>bodyrepos_delete_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_webhook_conf
      IMPORTING data TYPE zif_githubcom=>bodyrepos_update_webhook_confi
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_migrations_start_import
      IMPORTING data TYPE zif_githubcom=>bodymigrations_start_import
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_migrations_update_import
      IMPORTING data TYPE zif_githubcom=>bodymigrations_update_import
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_migrations_cancel_import
      IMPORTING data TYPE zif_githubcom=>bodymigrations_cancel_import
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_migrations_map_commit_aut
      IMPORTING data TYPE zif_githubcom=>bodymigrations_map_commit_auth
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_migrations_set_lfs_prefer
      IMPORTING data TYPE zif_githubcom=>bodymigrations_set_lfs_prefere
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_invitation
      IMPORTING data TYPE zif_githubcom=>bodyrepos_update_invitation
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_invitation
      IMPORTING data TYPE zif_githubcom=>bodyrepos_delete_invitation
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create
      IMPORTING data TYPE zif_githubcom=>bodyissues_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update_comment
      IMPORTING data TYPE zif_githubcom=>bodyissues_update_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_delete_comment
      IMPORTING data TYPE zif_githubcom=>bodyissues_delete_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_issu
      IMPORTING data TYPE zif_githubcom=>bodyreactions_create_for_issue
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update
      IMPORTING data TYPE zif_githubcom=>bodyissues_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_add_assignees
      IMPORTING data TYPE zif_githubcom=>bodyissues_add_assignees
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_remove_assignees
      IMPORTING data TYPE zif_githubcom=>bodyissues_remove_assignees
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_issues_lock
      IMPORTING data TYPE zif_githubcom=>bodyissues_lock
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_unlock
      IMPORTING data TYPE zif_githubcom=>bodyissues_unlock
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_is01
      IMPORTING data TYPE zif_githubcom=>bodyreactions_create_for_iss01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_deploy_key
      IMPORTING data TYPE zif_githubcom=>bodyrepos_create_deploy_key
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create_label
      IMPORTING data TYPE zif_githubcom=>bodyissues_create_label
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update_label
      IMPORTING data TYPE zif_githubcom=>bodyissues_update_label
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_delete_label
      IMPORTING data TYPE zif_githubcom=>bodyissues_delete_label
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_merge
      IMPORTING data TYPE zif_githubcom=>bodyrepos_merge
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create_milestone
      IMPORTING data TYPE zif_githubcom=>bodyissues_create_milestone
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update_milestone
      IMPORTING data TYPE zif_githubcom=>bodyissues_update_milestone
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_delete_milestone
      IMPORTING data TYPE zif_githubcom=>bodyissues_delete_milestone
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_mark_repo_notifi
      IMPORTING data TYPE zif_githubcom=>bodyactivity_mark_repo_notific
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_pages_site
      IMPORTING data TYPE zif_githubcom=>bodyrepos_create_pages_site
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_information_
      IMPORTING data TYPE zif_githubcom=>bodyrepos_update_information_a
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_pages_site
      IMPORTING data TYPE zif_githubcom=>bodyrepos_delete_pages_site
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_for_repo
      IMPORTING data TYPE zif_githubcom=>bodyprojects_create_for_repo
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create
      IMPORTING data TYPE zif_githubcom=>bodypulls_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update_review_comme
      IMPORTING data TYPE zif_githubcom=>bodypulls_update_review_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_delete_review_comme
      IMPORTING data TYPE zif_githubcom=>bodypulls_delete_review_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_pull
      IMPORTING data TYPE zif_githubcom=>bodyreactions_create_for_pull_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_pulls_create_reply_for_re
      IMPORTING data TYPE zif_githubcom=>bodypulls_create_reply_for_rev
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_merge
      IMPORTING data TYPE zif_githubcom=>bodypulls_merge
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_request_reviewers
      IMPORTING data TYPE zif_githubcom=>bodypulls_request_reviewers
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_remove_requested_re
      IMPORTING data TYPE zif_githubcom=>bodypulls_remove_requested_rev
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create_review
      IMPORTING data TYPE zif_githubcom=>bodypulls_create_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update_review
      IMPORTING data TYPE zif_githubcom=>bodypulls_update_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_delete_pending_revi
      IMPORTING data TYPE zif_githubcom=>bodypulls_delete_pending_revie
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_dismiss_review
      IMPORTING data TYPE zif_githubcom=>bodypulls_dismiss_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_submit_review
      IMPORTING data TYPE zif_githubcom=>bodypulls_submit_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update_branch
      IMPORTING data TYPE zif_githubcom=>bodypulls_update_branch
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_release
      IMPORTING data TYPE zif_githubcom=>bodyrepos_create_release
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_release_asse
      IMPORTING data TYPE zif_githubcom=>bodyrepos_update_release_asset
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_release_asse
      IMPORTING data TYPE zif_githubcom=>bodyrepos_delete_release_asset
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_release
      IMPORTING data TYPE zif_githubcom=>bodyrepos_update_release
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_repos_create_commit_statu
      IMPORTING data TYPE zif_githubcom=>bodyrepos_create_commit_status
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_set_repo_subscri
      IMPORTING data TYPE zif_githubcom=>bodyactivity_set_repo_subscrip
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_delete_repo_subs
      IMPORTING data TYPE zif_githubcom=>bodyactivity_delete_repo_subsc
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_replace_all_topics
      IMPORTING data TYPE zif_githubcom=>bodyrepos_replace_all_topics
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_transfer
      IMPORTING data TYPE zif_githubcom=>bodyrepos_transfer
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_enterprise_admin_provisio
      IMPORTING data TYPE zif_githubcom=>bodyenterprise_admin_provision
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_set_info
      IMPORTING data TYPE zif_githubcom=>bodyenterprise_admin_set_infor
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_a
      IMPORTING data TYPE zif_githubcom=>bodyenterprise_admin_update_at
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete01
      IMPORTING data TYPE zif_githubcom=>bodyenterprise_admin_delete_sc
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_provis01
      IMPORTING data TYPE zif_githubcom=>bodyenterprise_admin_provisi01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_set_in01
      IMPORTING data TYPE zif_githubcom=>bodyenterprise_admin_set_inf01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update01
      IMPORTING data TYPE zif_githubcom=>bodyenterprise_admin_update_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete_u
      IMPORTING data TYPE zif_githubcom=>bodyenterprise_admin_delete_us
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_scim_provision_and_invite
      IMPORTING data TYPE zif_githubcom=>bodyscim_provision_and_invite_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_scim_set_information_for_
      IMPORTING data TYPE zif_githubcom=>bodyscim_set_information_for_p
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_scim_update_attribute_for
      IMPORTING data TYPE zif_githubcom=>bodyscim_update_attribute_for_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_scim_delete_user_from_org
      IMPORTING data TYPE zif_githubcom=>bodyscim_delete_user_from_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_legacy
      IMPORTING data TYPE zif_githubcom=>bodyteams_update_legacy
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_legacy
      IMPORTING data TYPE zif_githubcom=>bodyteams_delete_legacy
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_discussion_l
      IMPORTING data TYPE zif_githubcom=>bodyteams_create_discussion_le
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_discussion_l
      IMPORTING data TYPE zif_githubcom=>bodyteams_update_discussion_le
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_discussion_l
      IMPORTING data TYPE zif_githubcom=>bodyteams_delete_discussion_le
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_discussion01
      IMPORTING data TYPE zif_githubcom=>bodyteams_create_discussion_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_discussion01
      IMPORTING data TYPE zif_githubcom=>bodyteams_update_discussion_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_discussion01
      IMPORTING data TYPE zif_githubcom=>bodyteams_delete_discussion_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_te02
      IMPORTING data TYPE zif_githubcom=>bodyreactions_create_for_tea02
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_te03
      IMPORTING data TYPE zif_githubcom=>bodyreactions_create_for_tea03
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_mem01
      IMPORTING data TYPE zif_githubcom=>bodyteams_add_or_update_memb01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_membership01
      IMPORTING data TYPE zif_githubcom=>bodyteams_remove_membership_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_pro01
      IMPORTING data TYPE zif_githubcom=>bodyteams_add_or_update_proj01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_project_lega
      IMPORTING data TYPE zif_githubcom=>bodyteams_remove_project_legac
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_rep01
      IMPORTING data TYPE zif_githubcom=>bodyteams_add_or_update_repo01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_repo_legacy
      IMPORTING data TYPE zif_githubcom=>bodyteams_remove_repo_legacy
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_or_update_01
      IMPORTING data TYPE zif_githubcom=>bodyteams_create_or_update_i01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_users_add_email_for_authe
      IMPORTING data TYPE zif_githubcom=>bodyusers_add_email_for_authen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_users_delete_email_for_au
      IMPORTING data TYPE zif_githubcom=>bodyusers_delete_email_for_aut
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_users_create_gpg_key_for_
      IMPORTING data TYPE zif_githubcom=>bodyusers_create_gpg_key_for_a
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_users_create_public_ssh_k
      IMPORTING data TYPE zif_githubcom=>bodyusers_create_public_ssh_ke
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_update_membership_fo
      IMPORTING data TYPE zif_githubcom=>bodyorgs_update_membership_for
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_migrations_start_for_auth
      IMPORTING data TYPE zif_githubcom=>bodymigrations_start_for_authe
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_for_authe
      IMPORTING data TYPE zif_githubcom=>bodyprojects_create_for_authen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
...
CLASS zcl_githubcom IMPLEMENTATION.
  METHOD constructor.
    mi_client = ii_client.
  ENDMETHOD.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~oauth_authorizations_list_gran.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~oauth_authorizations_get_grant.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubcom~oauth_authorizations_delete_gr.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/applications/grants/{grant_id}'.
    lv_temp = grant_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~apps_revoke_grant_for_applicat.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~apps_check_authorization.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~apps_reset_authorization.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/applications/{client_id}/tokens/{access_token}'.
    REPLACE ALL OCCURRENCES OF '{client_id}' IN lv_uri WITH client_id.
  ...
  METHOD zif_githubcom~apps_revoke_authorization_for_.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/applications/{client_id}/tokens/{access_token}'.
    REPLACE ALL OCCURRENCES OF '{client_id}' IN lv_uri WITH client_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~oauth_authorizations_list_auth.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~oauth_authorizations_create_au.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/authorizations'.
    mi_client->request->set_method( 'POST' ).
  ...
  METHOD zif_githubcom~oauth_authorizations_get_or_cr.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubcom~oauth_authorizations_get_or_01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubcom~oauth_authorizations_get_autho.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubcom~oauth_authorizations_update_au.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/authorizations/{authorization_id}'.
    lv_temp = authorization_id.
  ...
  METHOD zif_githubcom~oauth_authorizations_delete_au.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/authorizations/{authorization_id}'.
    lv_temp = authorization_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~reactions_delete_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_get_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubcom~teams_update_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}'.
    lv_temp = team_id.
  ...
  METHOD zif_githubcom~teams_delete_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_list_discussions_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_create_discussion_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}/discussions'.
    lv_temp = team_id.
  ...
  METHOD zif_githubcom~teams_get_discussion_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubcom~teams_update_discussion_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}/discussions/{discussion_number}'.
    lv_temp = team_id.
  ...
  METHOD zif_githubcom~teams_delete_discussion_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}/discussions/{discussion_number}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_list_discussion_commen01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_create_discussion_comm01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}/discussions/{discussion_number}/comments'.
    lv_temp = team_id.
  ...
  METHOD zif_githubcom~teams_get_discussion_comment_l.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubcom~teams_update_discussion_comm01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}'.
    lv_temp = team_id.
  ...
  METHOD zif_githubcom~teams_delete_discussion_comm01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~reactions_list_for_team_disc02.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~reactions_create_for_team_di02.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}/reactions'.
    lv_temp = team_id.
  ...
  METHOD zif_githubcom~reactions_list_for_team_disc03.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~reactions_create_for_team_di03.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}/discussions/{discussion_number}/reactions'.
    lv_temp = team_id.
  ...
  METHOD zif_githubcom~teams_list_pending_invitatio01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_list_members_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_get_member_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_add_member_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}/members/{username}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_remove_member_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}/members/{username}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_get_membership_for_use01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubcom~teams_add_or_update_membersh01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}/memberships/{username}'.
    lv_temp = team_id.
  ...
  METHOD zif_githubcom~teams_remove_membership_for_01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}/memberships/{username}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_list_projects_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_check_permissions_for_01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubcom~teams_add_or_update_project_01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}/projects/{project_id}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_remove_project_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}/projects/{project_id}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_list_repos_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_check_permissions_for_02.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_add_or_update_repo_per01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}/repos/{owner}/{repo}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_remove_repo_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}/repos/{owner}/{repo}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~teams_list_idp_groups_for_lega.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubcom~teams_create_or_update_idp_g01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/teams/{team_id}/team-sync/group-mappings'.
    lv_temp = team_id.
  ...
  METHOD zif_githubcom~teams_list_child_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~apps_add_repo_to_installation.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~migrations_list_repos_for_user.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~repos_accept_invitation.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubcom~repos_decline_invitation.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/user/repository_invitations/{invitation_id}'.
    lv_temp = invitation_id.
