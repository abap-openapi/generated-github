...
* Component schema: authorization-with-user, object
  TYPES: BEGIN OF subauthorization_with_user_use,
           login TYPE string,
           id TYPE i,
           node_id TYPE string,
           avatar_url TYPE string,
           ...
           type TYPE string,
           site_admin TYPE abap_bool,
         END OF subauthorization_with_user_use.
  TYPES: BEGIN OF subauthorization_with_user_app,
           url TYPE string,
           name TYPE string,
           client_id TYPE string,
         END OF subauthorization_with_user_app.
  TYPES: BEGIN OF authorization_with_user,
           ...
           token_last_eight TYPE string,
           hashed_token TYPE string,
           app TYPE subauthorization_with_user_app,
           note TYPE string,
           note_url TYPE string,
           updated_at TYPE string,
           created_at TYPE string,
           fingerprint TYPE string,
           user TYPE subauthorization_with_user_use,
...
* Component schema: enterprise-overview, object
  TYPES: BEGIN OF subenterprise_overview_comment,
           total_commit_comments TYPE i,
           total_gist_comments TYPE i,
           total_issue_comments TYPE i,
           total_pull_request_comments TYPE i,
         END OF subenterprise_overview_comment.
  TYPES: BEGIN OF subenterprise_overview_gists,
           total_gists TYPE i,
           private_gists TYPE i,
           public_gists TYPE i,
         END OF subenterprise_overview_gists.
  TYPES: BEGIN OF subenterprise_overview_milesto,
           total_milestones TYPE i,
           open_milestones TYPE i,
           closed_milestones TYPE i,
         END OF subenterprise_overview_milesto.
  TYPES: BEGIN OF subenterprise_overview_issues,
           total_issues TYPE i,
           open_issues TYPE i,
           closed_issues TYPE i,
         END OF subenterprise_overview_issues.
  TYPES: BEGIN OF subenterprise_overview_pulls,
           total_pulls TYPE i,
           merged_pulls TYPE i,
           mergeable_pulls TYPE i,
           unmergeable_pulls TYPE i,
         END OF subenterprise_overview_pulls.
  TYPES: BEGIN OF subenterprise_overview_users,
           total_users TYPE i,
           admin_users TYPE i,
           suspended_users TYPE i,
         END OF subenterprise_overview_users.
  TYPES: BEGIN OF subenterprise_overview_orgs,
           total_orgs TYPE i,
           disabled_orgs TYPE i,
           total_teams TYPE i,
           total_team_members TYPE i,
         END OF subenterprise_overview_orgs.
  TYPES: BEGIN OF subenterprise_overview_pages,
           total_pages TYPE i,
         END OF subenterprise_overview_pages.
  TYPES: BEGIN OF subenterprise_overview_hooks,
           total_hooks TYPE i,
           active_hooks TYPE i,
           inactive_hooks TYPE i,
         END OF subenterprise_overview_hooks.
  TYPES: BEGIN OF subenterprise_overview_repos,
           total_repos TYPE i,
           root_repos TYPE i,
           fork_repos TYPE i,
           org_repos TYPE i,
           total_pushes TYPE i,
           total_wikis TYPE i,
         END OF subenterprise_overview_repos.
  TYPES: BEGIN OF enterprise_overview,
           repos TYPE subenterprise_overview_repos,
           hooks TYPE subenterprise_overview_hooks,
           pages TYPE subenterprise_overview_pages,
           orgs TYPE subenterprise_overview_orgs,
           users TYPE subenterprise_overview_users,
           pulls TYPE subenterprise_overview_pulls,
           issues TYPE subenterprise_overview_issues,
           milestones TYPE subenterprise_overview_milesto,
           gists TYPE subenterprise_overview_gists,
...
* Component schema: branch-restriction-policy, object
  TYPES: BEGIN OF branch_restriction_policy,
           ...
           restrictions TYPE STANDARD TABLE OF string WITH DEFAULT KEY, " todo, handle array
...
* Component schema: legacy-review-comment, object
  TYPES: BEGIN OF subsublegacy_review_comment_02,
           href TYPE string,
         END OF subsublegacy_review_comment_02.
  TYPES: BEGIN OF subsublegacy_review_comment_01,
           href TYPE string,
         END OF subsublegacy_review_comment_01.
  TYPES: BEGIN OF subsublegacy_review_comment__l,
           href TYPE string,
         END OF subsublegacy_review_comment__l.
  TYPES: BEGIN OF sublegacy_review_comment__link,
           self TYPE subsublegacy_review_comment__l,
           html TYPE subsublegacy_review_comment_01,
           pull_request TYPE subsublegacy_review_comment_02,
         END OF sublegacy_review_comment__link.
  TYPES: BEGIN OF sublegacy_review_comment_user,
           login TYPE string,
           id TYPE i,
           node_id TYPE string,
           avatar_url TYPE string,
           ...
           type TYPE string,
           site_admin TYPE abap_bool,
         END OF sublegacy_review_comment_user.
  TYPES: BEGIN OF legacy_review_comment,
           ...
           original_commit_id TYPE string,
           in_reply_to_id TYPE i,
           user TYPE sublegacy_review_comment_user,
           body TYPE string,
           created_at TYPE string,
           updated_at TYPE string,
           html_url TYPE string,
           ...
           _links TYPE sublegacy_review_comment__link,
...
* Component schema: team-2, object
  TYPES: BEGIN OF subteam_2_parent,
           id TYPE i,
           node_id TYPE string,
           url TYPE string,
           html_url TYPE string,
...
* Component schema: response_git_get_all_refs, array
  TYPES response_git_get_all_refs TYPE STANDARD TABLE OF git_ref WITH DEFAULT KEY.
...
* Operation id: git/get-all-refs
* Parameter: owner, required, path
* Parameter: repo, required, path
* Parameter: per_page, optional, query
* Parameter: page, optional, query
* Response: 200
*     application/json, #/components/schemas/response_git_get_all_refs
  METHODS git_get_all_refs
    IMPORTING
      owner TYPE string
      repo TYPE string
      per_page TYPE i DEFAULT 30
      page TYPE i DEFAULT 1
    RETURNING
      VALUE(return_data) TYPE response_git_get_all_refs
    RAISING cx_static_check.
