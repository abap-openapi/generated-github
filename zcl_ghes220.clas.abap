...
* GitHub v3 REST API
  ...
  PROTECTED SECTION.
    ...
    METHODS parse_enterprise_public_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_public_key) TYPE zif_ghes220=>enterprise_public_key
      RAISING cx_static_check.
    ...
    METHODS parse_oauth_authorizations_lis
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_oauth_authorizations_) TYPE zif_ghes220=>response_oauth_authorizations_
      RAISING cx_static_check.
    METHODS parse_oauth_authorizations_l01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_oauth_authorization01) TYPE zif_ghes220=>response_oauth_authorization01
      RAISING cx_static_check.
    ...
    METHODS parse_activity_list_stargazers
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_stargaz) TYPE zif_ghes220=>response_activity_list_stargaz
      RAISING cx_static_check.
    ...
    METHODS parse_teams_add_member_legacy
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_add_member_lega) TYPE zif_ghes220=>response_teams_add_member_lega
      RAISING cx_static_check.
    ...
    METHODS parse_activity_list_repos_st01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_repos01) TYPE zif_ghes220=>response_activity_list_repos01
      RAISING cx_static_check.
...
* todo, array, contexts
  ...
  METHOD parse_enterprise_admin_list_pu.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA enterprise_public_key TYPE zif_ghes220=>enterprise_public_key.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
...
* todo, array, errors
  ...
  METHOD parse_oauth_authorizations_lis.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA application_grant TYPE zif_ghes220=>application_grant.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
...
* todo, handle more responses
  ...
  METHOD zif_ghes220~oauth_authorizations_get_grant.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes220~oauth_authorizations_delete_gr.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/applications/grants/{grant_id}'.
    lv_temp = grant_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes220~apps_revoke_grant_for_applicat.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes220~apps_check_authorization.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes220~apps_reset_authorization.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/applications/{client_id}/tokens/{access_token}'.
    REPLACE ALL OCCURRENCES OF '{client_id}' IN lv_uri WITH client_id.
  ...
  METHOD zif_ghes220~apps_revoke_authorization_for_.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/applications/{client_id}/tokens/{access_token}'.
    REPLACE ALL OCCURRENCES OF '{client_id}' IN lv_uri WITH client_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes220~oauth_authorizations_list_auth.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes220~oauth_authorizations_create_au.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/authorizations'.
    mi_client->request->set_method( 'POST' ).
  ...
  METHOD zif_ghes220~oauth_authorizations_get_or_01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes220~oauth_authorizations_get_autho.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes220~oauth_authorizations_update_au.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/authorizations/{authorization_id}'.
    lv_temp = authorization_id.
  ...
  METHOD zif_ghes220~oauth_authorizations_delete_au.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/authorizations/{authorization_id}'.
    lv_temp = authorization_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes220~codes_of_conduct_get_for_repo.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes220~teams_get_member_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes220~teams_add_member_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/members/{username}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_ghes220~teams_remove_member_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/members/{username}'.
    lv_temp = team_id.
