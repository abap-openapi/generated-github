...
* GitHub v3 REST API
  ...
  PROTECTED SECTION.
    ...
    METHODS parse_code_of_conduct_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_of_conduct_simple) TYPE zif_githubae=>code_of_conduct_simple
      RAISING cx_static_check.
    ...
    METHODS parse_pages_https_certificate
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pages_https_certificate) TYPE zif_githubae=>pages_https_certificate
      RAISING cx_static_check.
    METHODS parse_page
      IMPORTING iv_prefix TYPE string
