CLASS zcl_githubae DEFINITION PUBLIC.
* Generated by abap-openapi-client
* GitHub v3 REST API
  PUBLIC SECTION.
    INTERFACES zif_githubae.
  ...
  PROTECTED SECTION.
    ...
    METHODS parse_global_hook
      ...
      RETURNING VALUE(global_hook) TYPE zif_githubae=>global_hook
      RAISING cx_static_check.
    METHODS parse_global_hook_2
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(global_hook_2) TYPE zif_githubae=>global_hook_2
      RAISING cx_static_check.
    METHODS parse_enterprise_public_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_public_key) TYPE zif_githubae=>enterprise_public_key
      RAISING cx_static_check.
    METHODS parse_organization_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(organization_simple) TYPE zif_githubae=>organization_simple
      RAISING cx_static_check.
    METHODS parse_pre_receive_environment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pre_receive_environment) TYPE zif_githubae=>pre_receive_environment
      RAISING cx_static_check.
    METHODS parse_pre_receive_environment_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pre_receive_environment_downlo) TYPE zif_githubae=>pre_receive_environment_downlo
      RAISING cx_static_check.
    METHODS parse_simple_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(simple_user) TYPE zif_githubae=>simple_user
      RAISING cx_static_check.
    METHODS parse_app_permissions
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(app_permissions) TYPE zif_githubae=>app_permissions
      RAISING cx_static_check.
    METHODS parse_scoped_installation
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(scoped_installation) TYPE zif_githubae=>scoped_installation
      RAISING cx_static_check.
    METHODS parse_authorization
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(authorization) TYPE zif_githubae=>authorization
      RAISING cx_static_check.
    METHODS parse_integration
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(integration) TYPE zif_githubae=>integration
      RAISING cx_static_check.
    METHODS parse_basic_error
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(basic_error) TYPE zif_githubae=>basic_error
      RAISING cx_static_check.
    METHODS parse_validation_error_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(validation_error_simple) TYPE zif_githubae=>validation_error_simple
      RAISING cx_static_check.
    METHODS parse_webhook_config_url
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(webhook_config_url) TYPE zif_githubae=>webhook_config_url
      RAISING cx_static_check.
    METHODS parse_webhook_config_content_t
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(webhook_config_content_type) TYPE zif_githubae=>webhook_config_content_type
      RAISING cx_static_check.
    METHODS parse_webhook_config_secret
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(webhook_config_secret) TYPE zif_githubae=>webhook_config_secret
      RAISING cx_static_check.
    METHODS parse_webhook_config_insecure_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(webhook_config_insecure_ssl) TYPE zif_githubae=>webhook_config_insecure_ssl
      RAISING cx_static_check.
    ...
    METHODS parse_installation
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(installation) TYPE zif_githubae=>installation
      RAISING cx_static_check.
    METHODS parse_license_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(license_simple) TYPE zif_githubae=>license_simple
      RAISING cx_static_check.
    METHODS parse_repository
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repository) TYPE zif_githubae=>repository
      RAISING cx_static_check.
    ...
    METHODS parse_announcement_expiration
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(announcement_expiration) TYPE zif_githubae=>announcement_expiration
      RAISING cx_static_check.
    ...
    METHODS parse_license_info
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(license_info) TYPE zif_githubae=>license_info
      RAISING cx_static_check.
    ...
    METHODS parse_feed
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(feed) TYPE zif_githubae=>feed
      RAISING cx_static_check.
    METHODS parse_base_gist
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(base_gist) TYPE zif_githubae=>base_gist
      RAISING cx_static_check.
    ...
    METHODS parse_gist_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gist_commit) TYPE zif_githubae=>gist_commit
      RAISING cx_static_check.
    ...
    METHODS parse_issue
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue) TYPE zif_githubae=>issue
      RAISING cx_static_check.
    METHODS parse_license
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(license) TYPE zif_githubae=>license
      RAISING cx_static_check.
    METHODS parse_api_overview
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(api_overview) TYPE zif_githubae=>api_overview
      RAISING cx_static_check.
    METHODS parse_minimal_repository
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(minimal_repository) TYPE zif_githubae=>minimal_repository
      RAISING cx_static_check.
    METHODS parse_thread
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(thread) TYPE zif_githubae=>thread
      RAISING cx_static_check.
    ...
    METHODS parse_team_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_simple) TYPE zif_githubae=>team_simple
      RAISING cx_static_check.
    METHODS parse_team
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team) TYPE zif_githubae=>team
      RAISING cx_static_check.
    METHODS parse_team_full
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_full) TYPE zif_githubae=>team_full
      RAISING cx_static_check.
    METHODS parse_team_discussion
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_discussion) TYPE zif_githubae=>team_discussion
      RAISING cx_static_check.
    METHODS parse_team_discussion_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_discussion_comment) TYPE zif_githubae=>team_discussion_comment
      RAISING cx_static_check.
    METHODS parse_reaction
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(reaction) TYPE zif_githubae=>reaction
      RAISING cx_static_check.
    METHODS parse_team_membership
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_membership) TYPE zif_githubae=>team_membership
      RAISING cx_static_check.
    METHODS parse_team_project
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_project) TYPE zif_githubae=>team_project
      RAISING cx_static_check.
    METHODS parse_team_repository
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_repository) TYPE zif_githubae=>team_repository
      RAISING cx_static_check.
    METHODS parse_project_card
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(project_card) TYPE zif_githubae=>project_card
      RAISING cx_static_check.
    ...
    METHODS parse_rate_limit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(rate_limit) TYPE zif_githubae=>rate_limit
      RAISING cx_static_check.
    METHODS parse_rate_limit_overview
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(rate_limit_overview) TYPE zif_githubae=>rate_limit_overview
      RAISING cx_static_check.
    ...
    METHODS parse_protected_branch_pull_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(protected_branch_pull_request_) TYPE zif_githubae=>protected_branch_pull_request_
      RAISING cx_static_check.
    METHODS parse_branch_restriction_polic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(branch_restriction_policy) TYPE zif_githubae=>branch_restriction_policy
      RAISING cx_static_check.
    METHODS parse_branch_protection
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(branch_protection) TYPE zif_githubae=>branch_protection
      RAISING cx_static_check.
    METHODS parse_short_branch
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(short_branch) TYPE zif_githubae=>short_branch
      RAISING cx_static_check.
    METHODS parse_git_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_user) TYPE zif_githubae=>git_user
      RAISING cx_static_check.
    METHODS parse_verification
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(verification) TYPE zif_githubae=>verification
      RAISING cx_static_check.
    METHODS parse_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(commit) TYPE zif_githubae=>commit
      RAISING cx_static_check.
    METHODS parse_branch_with_protection
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(branch_with_protection) TYPE zif_githubae=>branch_with_protection
      RAISING cx_static_check.
    METHODS parse_status_check_policy
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(status_check_policy) TYPE zif_githubae=>status_check_policy
      RAISING cx_static_check.
    ...
    METHODS parse_check_run
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(check_run) TYPE zif_githubae=>check_run
      RAISING cx_static_check.
    ...
    METHODS parse_branch_short
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(branch_short) TYPE zif_githubae=>branch_short
      RAISING cx_static_check.
    METHODS parse_link
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(link) TYPE zif_githubae=>link
      RAISING cx_static_check.
    METHODS parse_auto_merge
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(auto_merge) TYPE zif_githubae=>auto_merge
      RAISING cx_static_check.
    METHODS parse_pull_request_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_simple) TYPE zif_githubae=>pull_request_simple
      RAISING cx_static_check.
    METHODS parse_simple_commit_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(simple_commit_status) TYPE zif_githubae=>simple_commit_status
      RAISING cx_static_check.
    METHODS parse_combined_commit_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(combined_commit_status) TYPE zif_githubae=>combined_commit_status
      RAISING cx_static_check.
    METHODS parse_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(status) TYPE zif_githubae=>status
      RAISING cx_static_check.
    METHODS parse_diff_entry
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(diff_entry) TYPE zif_githubae=>diff_entry
      RAISING cx_static_check.
    ...
    METHODS parse_content_directory
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_directory) TYPE zif_githubae=>content_directory
      RAISING cx_static_check.
    METHODS parse_content_file
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_file) TYPE zif_githubae=>content_file
      RAISING cx_static_check.
    METHODS parse_content_symlink
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_symlink) TYPE zif_githubae=>content_symlink
      RAISING cx_static_check.
    METHODS parse_content_submodule
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_submodule) TYPE zif_githubae=>content_submodule
      RAISING cx_static_check.
    METHODS parse_file_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(file_commit) TYPE zif_githubae=>file_commit
      RAISING cx_static_check.
    ...
    METHODS parse_short_blob
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(short_blob) TYPE zif_githubae=>short_blob
      RAISING cx_static_check.
    METHODS parse_blob
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(blob) TYPE zif_githubae=>blob
      RAISING cx_static_check.
    METHODS parse_git_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_commit) TYPE zif_githubae=>git_commit
      RAISING cx_static_check.
    METHODS parse_git_ref
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_ref) TYPE zif_githubae=>git_ref
      RAISING cx_static_check.
    METHODS parse_git_tag
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_tag) TYPE zif_githubae=>git_tag
      RAISING cx_static_check.
    METHODS parse_git_tree
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_tree) TYPE zif_githubae=>git_tree
      RAISING cx_static_check.
    METHODS parse_hook_response
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(hook_response) TYPE zif_githubae=>hook_response
      RAISING cx_static_check.
    METHODS parse_hook
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(hook) TYPE zif_githubae=>hook
      RAISING cx_static_check.
    METHODS parse_issue_event_label
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_label) TYPE zif_githubae=>issue_event_label
      RAISING cx_static_check.
    METHODS parse_issue_event_dismissed_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_dismissed_review) TYPE zif_githubae=>issue_event_dismissed_review
      RAISING cx_static_check.
    METHODS parse_issue_event_milestone
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_milestone) TYPE zif_githubae=>issue_event_milestone
      RAISING cx_static_check.
    METHODS parse_issue_event_project_card
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_project_card) TYPE zif_githubae=>issue_event_project_card
      RAISING cx_static_check.
    METHODS parse_issue_event_rename
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_rename) TYPE zif_githubae=>issue_event_rename
      RAISING cx_static_check.
    METHODS parse_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event) TYPE zif_githubae=>issue_event
      RAISING cx_static_check.
    METHODS parse_issue_event_for_issue
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_for_issue) TYPE zif_githubae=>issue_event_for_issue
      RAISING cx_static_check.
    METHODS parse_deploy_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(deploy_key) TYPE zif_githubae=>deploy_key
      RAISING cx_static_check.
    METHODS parse_language
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(language) TYPE zif_githubae=>language
      RAISING cx_static_check.
    ...
    METHODS parse_page
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(page) TYPE zif_githubae=>page
      RAISING cx_static_check.
    METHODS parse_page_build
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(page_build) TYPE zif_githubae=>page_build
      RAISING cx_static_check.
    METHODS parse_page_build_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(page_build_status) TYPE zif_githubae=>page_build_status
      RAISING cx_static_check.
    METHODS parse_pull_request
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request) TYPE zif_githubae=>pull_request
      RAISING cx_static_check.
    METHODS parse_pull_request_review_comm
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_review_comment) TYPE zif_githubae=>pull_request_review_comment
      RAISING cx_static_check.
    METHODS parse_pull_request_merge_resul
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_merge_result) TYPE zif_githubae=>pull_request_merge_result
      RAISING cx_static_check.
    METHODS parse_pull_request_review_requ
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_review_request) TYPE zif_githubae=>pull_request_review_request
      RAISING cx_static_check.
    METHODS parse_pull_request_review
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_review) TYPE zif_githubae=>pull_request_review
      RAISING cx_static_check.
    METHODS parse_review_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(review_comment) TYPE zif_githubae=>review_comment
      RAISING cx_static_check.
    METHODS parse_release_asset
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(release_asset) TYPE zif_githubae=>release_asset
      RAISING cx_static_check.
    ...
    METHODS parse_code_frequency_stat
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_frequency_stat) TYPE zif_githubae=>code_frequency_stat
      RAISING cx_static_check.
    METHODS parse_commit_activity
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(commit_activity) TYPE zif_githubae=>commit_activity
      RAISING cx_static_check.
    METHODS parse_contributor_activity
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(contributor_activity) TYPE zif_githubae=>contributor_activity
      RAISING cx_static_check.
    METHODS parse_participation_stats
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(participation_stats) TYPE zif_githubae=>participation_stats
      RAISING cx_static_check.
    METHODS parse_repository_subscription
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repository_subscription) TYPE zif_githubae=>repository_subscription
      RAISING cx_static_check.
    METHODS parse_tag
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(tag) TYPE zif_githubae=>tag
      RAISING cx_static_check.
    METHODS parse_topic
      IMPORTING iv_prefix TYPE string
    ...
    METHODS parse_code_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_search_result_item) TYPE zif_githubae=>code_search_result_item
      RAISING cx_static_check.
    METHODS parse_commit_search_result_ite
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(commit_search_result_item) TYPE zif_githubae=>commit_search_result_item
      RAISING cx_static_check.
    METHODS parse_issue_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_search_result_item) TYPE zif_githubae=>issue_search_result_item
      RAISING cx_static_check.
    METHODS parse_label_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(label_search_result_item) TYPE zif_githubae=>label_search_result_item
      RAISING cx_static_check.
    METHODS parse_repo_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repo_search_result_item) TYPE zif_githubae=>repo_search_result_item
      RAISING cx_static_check.
    METHODS parse_topic_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(topic_search_result_item) TYPE zif_githubae=>topic_search_result_item
      RAISING cx_static_check.
    METHODS parse_user_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(user_search_result_item) TYPE zif_githubae=>user_search_result_item
      RAISING cx_static_check.
    METHODS parse_private_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(private_user) TYPE zif_githubae=>private_user
      RAISING cx_static_check.
    METHODS parse_public_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(public_user) TYPE zif_githubae=>public_user
      RAISING cx_static_check.
    METHODS parse_gpg_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gpg_key) TYPE zif_githubae=>gpg_key
      RAISING cx_static_check.
    METHODS parse_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(key) TYPE zif_githubae=>key
      RAISING cx_static_check.
    ...
    METHODS json_enterprise_admin_update_g
      IMPORTING data TYPE zif_githubae=>bodyenterprise_admin_update_gl
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete_g
      IMPORTING data TYPE zif_githubae=>bodyenterprise_admin_delete_gl
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_o
      IMPORTING data TYPE zif_githubae=>bodyenterprise_admin_create_or
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_o
      IMPORTING data TYPE zif_githubae=>bodyenterprise_admin_update_or
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_p
      IMPORTING data TYPE zif_githubae=>bodyenterprise_admin_create_pr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_p
      IMPORTING data TYPE zif_githubae=>bodyenterprise_admin_update_pr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete_p
      IMPORTING data TYPE zif_githubae=>bodyenterprise_admin_delete_pr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_i
      IMPORTING data TYPE zif_githubae=>bodyenterprise_admin_create_im
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_apps_create_installation_
      IMPORTING data TYPE zif_githubae=>bodyapps_create_installation_a
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_delete_authorization
      IMPORTING data TYPE zif_githubae=>bodyapps_delete_authorization
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_check_token
      IMPORTING data TYPE zif_githubae=>bodyapps_check_token
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_reset_token
      IMPORTING data TYPE zif_githubae=>bodyapps_reset_token
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_gists_update
      IMPORTING data TYPE zif_githubae=>bodygists_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_delete
      IMPORTING data TYPE zif_githubae=>bodygists_delete
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_create_comment
      IMPORTING data TYPE zif_githubae=>bodygists_create_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_update_comment
      IMPORTING data TYPE zif_githubae=>bodygists_update_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_delete_comment
      IMPORTING data TYPE zif_githubae=>bodygists_delete_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_markdown_render
      IMPORTING data TYPE zif_githubae=>bodymarkdown_render
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_mark_notificatio
      IMPORTING data TYPE zif_githubae=>bodyactivity_mark_notification
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_set_thread_subsc
      IMPORTING data TYPE zif_githubae=>bodyactivity_set_thread_subscr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_delete_thread_su
      IMPORTING data TYPE zif_githubae=>bodyactivity_delete_thread_sub
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_orgs_create_webhook
      IMPORTING data TYPE zif_githubae=>bodyorgs_create_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_update_webhook
      IMPORTING data TYPE zif_githubae=>bodyorgs_update_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_delete_webhook
      IMPORTING data TYPE zif_githubae=>bodyorgs_delete_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_update_webhook_confi
      IMPORTING data TYPE zif_githubae=>bodyorgs_update_webhook_config
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_set_membership_for_u
      IMPORTING data TYPE zif_githubae=>bodyorgs_set_membership_for_us
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_repos_create_in_org
      IMPORTING data TYPE zif_githubae=>bodyrepos_create_in_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create
      IMPORTING data TYPE zif_githubae=>bodyteams_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_in_org
      IMPORTING data TYPE zif_githubae=>bodyteams_update_in_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_in_org
      IMPORTING data TYPE zif_githubae=>bodyteams_delete_in_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_discussion_i
      IMPORTING data TYPE zif_githubae=>bodyteams_create_discussion_in
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_discussion_i
      IMPORTING data TYPE zif_githubae=>bodyteams_update_discussion_in
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_discussion_i
      IMPORTING data TYPE zif_githubae=>bodyteams_delete_discussion_in
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_discussion_c
      IMPORTING data TYPE zif_githubae=>bodyteams_create_discussion_co
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_discussion_c
      IMPORTING data TYPE zif_githubae=>bodyteams_update_discussion_co
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_discussion_c
      IMPORTING data TYPE zif_githubae=>bodyteams_delete_discussion_co
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_team
      IMPORTING data TYPE zif_githubae=>bodyreactions_create_for_team_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_teams_remove_membership_f
      IMPORTING data TYPE zif_githubae=>bodyteams_remove_membership_fo
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_proje
      IMPORTING data TYPE zif_githubae=>bodyteams_add_or_update_projec
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_project_in_o
      IMPORTING data TYPE zif_githubae=>bodyteams_remove_project_in_or
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_repo_
      IMPORTING data TYPE zif_githubae=>bodyteams_add_or_update_repo_p
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_repo_in_org
      IMPORTING data TYPE zif_githubae=>bodyteams_remove_repo_in_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_update_card
      IMPORTING data TYPE zif_githubae=>bodyprojects_update_card
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_delete_card
      IMPORTING data TYPE zif_githubae=>bodyprojects_delete_card
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_move_card
      IMPORTING data TYPE zif_githubae=>bodyprojects_move_card
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_update_column
      IMPORTING data TYPE zif_githubae=>bodyprojects_update_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_delete_column
      IMPORTING data TYPE zif_githubae=>bodyprojects_delete_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_move_column
      IMPORTING data TYPE zif_githubae=>bodyprojects_move_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_update
      IMPORTING data TYPE zif_githubae=>bodyprojects_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_delete
      IMPORTING data TYPE zif_githubae=>bodyprojects_delete
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_add_collaborator
      IMPORTING data TYPE zif_githubae=>bodyprojects_add_collaborator
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_remove_collabora
      IMPORTING data TYPE zif_githubae=>bodyprojects_remove_collaborat
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_column
      IMPORTING data TYPE zif_githubae=>bodyprojects_create_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update
      IMPORTING data TYPE zif_githubae=>bodyrepos_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_repos_delete_branch_prote
      IMPORTING data TYPE zif_githubae=>bodyrepos_delete_branch_protec
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_pull_request
      IMPORTING data TYPE zif_githubae=>bodyrepos_update_pull_request_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_pull_request
      IMPORTING data TYPE zif_githubae=>bodyrepos_delete_pull_request_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_status_check
      IMPORTING data TYPE zif_githubae=>bodyrepos_update_status_check_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_repos_rename_branch
      IMPORTING data TYPE zif_githubae=>bodyrepos_rename_branch
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_create
      IMPORTING data TYPE zif_githubae=>bodychecks_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_update
      IMPORTING data TYPE zif_githubae=>bodychecks_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_create_suite
      IMPORTING data TYPE zif_githubae=>bodychecks_create_suite
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_repos_remove_collaborator
      IMPORTING data TYPE zif_githubae=>bodyrepos_remove_collaborator
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_commit_comme
      IMPORTING data TYPE zif_githubae=>bodyrepos_update_commit_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_commit_comme
      IMPORTING data TYPE zif_githubae=>bodyrepos_delete_commit_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_comm
      IMPORTING data TYPE zif_githubae=>bodyreactions_create_for_commi
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_repos_delete_file
      IMPORTING data TYPE zif_githubae=>bodyrepos_delete_file
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_deployment
      IMPORTING data TYPE zif_githubae=>bodyrepos_create_deployment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_git_create_blob
      IMPORTING data TYPE zif_githubae=>bodygit_create_blob
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_commit
      IMPORTING data TYPE zif_githubae=>bodygit_create_commit
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_ref
      IMPORTING data TYPE zif_githubae=>bodygit_create_ref
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_update_ref
      IMPORTING data TYPE zif_githubae=>bodygit_update_ref
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_delete_ref
      IMPORTING data TYPE zif_githubae=>bodygit_delete_ref
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_tag
      IMPORTING data TYPE zif_githubae=>bodygit_create_tag
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_tree
      IMPORTING data TYPE zif_githubae=>bodygit_create_tree
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_webhook
      IMPORTING data TYPE zif_githubae=>bodyrepos_create_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_webhook
      IMPORTING data TYPE zif_githubae=>bodyrepos_update_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_webhook
      IMPORTING data TYPE zif_githubae=>bodyrepos_delete_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_webhook_conf
      IMPORTING data TYPE zif_githubae=>bodyrepos_update_webhook_confi
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_invitation
      IMPORTING data TYPE zif_githubae=>bodyrepos_update_invitation
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_invitation
      IMPORTING data TYPE zif_githubae=>bodyrepos_delete_invitation
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create
      IMPORTING data TYPE zif_githubae=>bodyissues_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update_comment
      IMPORTING data TYPE zif_githubae=>bodyissues_update_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_delete_comment
      IMPORTING data TYPE zif_githubae=>bodyissues_delete_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_issu
      IMPORTING data TYPE zif_githubae=>bodyreactions_create_for_issue
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update
      IMPORTING data TYPE zif_githubae=>bodyissues_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_add_assignees
      IMPORTING data TYPE zif_githubae=>bodyissues_add_assignees
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_remove_assignees
      IMPORTING data TYPE zif_githubae=>bodyissues_remove_assignees
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_issues_lock
      IMPORTING data TYPE zif_githubae=>bodyissues_lock
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_unlock
      IMPORTING data TYPE zif_githubae=>bodyissues_unlock
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_is01
      IMPORTING data TYPE zif_githubae=>bodyreactions_create_for_iss01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_deploy_key
      IMPORTING data TYPE zif_githubae=>bodyrepos_create_deploy_key
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create_label
      IMPORTING data TYPE zif_githubae=>bodyissues_create_label
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update_label
      IMPORTING data TYPE zif_githubae=>bodyissues_update_label
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_repos_merge
      IMPORTING data TYPE zif_githubae=>bodyrepos_merge
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create_milestone
      IMPORTING data TYPE zif_githubae=>bodyissues_create_milestone
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update_milestone
      IMPORTING data TYPE zif_githubae=>bodyissues_update_milestone
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_delete_milestone
      IMPORTING data TYPE zif_githubae=>bodyissues_delete_milestone
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_mark_repo_notifi
      IMPORTING data TYPE zif_githubae=>bodyactivity_mark_repo_notific
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_pages_site
      IMPORTING data TYPE zif_githubae=>bodyrepos_create_pages_site
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_information_
      IMPORTING data TYPE zif_githubae=>bodyrepos_update_information_a
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_pages_site
      IMPORTING data TYPE zif_githubae=>bodyrepos_delete_pages_site
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_for_repo
      IMPORTING data TYPE zif_githubae=>bodyprojects_create_for_repo
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create
      IMPORTING data TYPE zif_githubae=>bodypulls_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update_review_comme
      IMPORTING data TYPE zif_githubae=>bodypulls_update_review_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_delete_review_comme
      IMPORTING data TYPE zif_githubae=>bodypulls_delete_review_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_pull
      IMPORTING data TYPE zif_githubae=>bodyreactions_create_for_pull_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update
      IMPORTING data TYPE zif_githubae=>bodypulls_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create_review_comme
      IMPORTING data TYPE zif_githubae=>bodypulls_create_review_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create_reply_for_re
      IMPORTING data TYPE zif_githubae=>bodypulls_create_reply_for_rev
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_merge
      IMPORTING data TYPE zif_githubae=>bodypulls_merge
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_request_reviewers
      IMPORTING data TYPE zif_githubae=>bodypulls_request_reviewers
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_remove_requested_re
      IMPORTING data TYPE zif_githubae=>bodypulls_remove_requested_rev
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create_review
      IMPORTING data TYPE zif_githubae=>bodypulls_create_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update_review
      IMPORTING data TYPE zif_githubae=>bodypulls_update_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_delete_pending_revi
      IMPORTING data TYPE zif_githubae=>bodypulls_delete_pending_revie
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_dismiss_review
      IMPORTING data TYPE zif_githubae=>bodypulls_dismiss_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_submit_review
      IMPORTING data TYPE zif_githubae=>bodypulls_submit_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update_branch
      IMPORTING data TYPE zif_githubae=>bodypulls_update_branch
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_release
      IMPORTING data TYPE zif_githubae=>bodyrepos_create_release
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_release_asse
      IMPORTING data TYPE zif_githubae=>bodyrepos_update_release_asset
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_release_asse
      IMPORTING data TYPE zif_githubae=>bodyrepos_delete_release_asset
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_release
      IMPORTING data TYPE zif_githubae=>bodyrepos_update_release
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_activity_set_repo_subscri
      IMPORTING data TYPE zif_githubae=>bodyactivity_set_repo_subscrip
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_delete_repo_subs
      IMPORTING data TYPE zif_githubae=>bodyactivity_delete_repo_subsc
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_replace_all_topics
      IMPORTING data TYPE zif_githubae=>bodyrepos_replace_all_topics
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_transfer
      IMPORTING data TYPE zif_githubae=>bodyrepos_transfer
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_teams_update_legacy
      IMPORTING data TYPE zif_githubae=>bodyteams_update_legacy
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_legacy
      IMPORTING data TYPE zif_githubae=>bodyteams_delete_legacy
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_discussion_l
      IMPORTING data TYPE zif_githubae=>bodyteams_create_discussion_le
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_discussion_l
      IMPORTING data TYPE zif_githubae=>bodyteams_update_discussion_le
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_discussion_l
      IMPORTING data TYPE zif_githubae=>bodyteams_delete_discussion_le
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_discussion01
      IMPORTING data TYPE zif_githubae=>bodyteams_create_discussion_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_discussion01
      IMPORTING data TYPE zif_githubae=>bodyteams_update_discussion_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_discussion01
      IMPORTING data TYPE zif_githubae=>bodyteams_delete_discussion_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_te02
      IMPORTING data TYPE zif_githubae=>bodyreactions_create_for_tea02
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_te03
      IMPORTING data TYPE zif_githubae=>bodyreactions_create_for_tea03
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_mem01
      IMPORTING data TYPE zif_githubae=>bodyteams_add_or_update_memb01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_membership01
      IMPORTING data TYPE zif_githubae=>bodyteams_remove_membership_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_pro01
      IMPORTING data TYPE zif_githubae=>bodyteams_add_or_update_proj01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_project_lega
      IMPORTING data TYPE zif_githubae=>bodyteams_remove_project_legac
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_rep01
      IMPORTING data TYPE zif_githubae=>bodyteams_add_or_update_repo01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_repo_legacy
      IMPORTING data TYPE zif_githubae=>bodyteams_remove_repo_legacy
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_users_create_gpg_key_for_
      IMPORTING data TYPE zif_githubae=>bodyusers_create_gpg_key_for_a
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_users_create_public_ssh_k
      IMPORTING data TYPE zif_githubae=>bodyusers_create_public_ssh_ke
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_repos_create_for_authenti
      IMPORTING data TYPE zif_githubae=>bodyrepos_create_for_authentic
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_suspend_
      IMPORTING data TYPE zif_githubae=>bodyenterprise_admin_suspend_u
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS parse_enterprise_admin_list_gl
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_list) TYPE zif_githubae=>response_enterprise_admin_list
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_list_pu
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_li01) TYPE zif_githubae=>response_enterprise_admin_li01
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_update_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_upda) TYPE zif_githubae=>response_enterprise_admin_upda
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_list_pr
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_li02) TYPE zif_githubae=>response_enterprise_admin_li02
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_updat01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_up01) TYPE zif_githubae=>response_enterprise_admin_up01
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_delete_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_dele) TYPE zif_githubae=>response_enterprise_admin_dele
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_start_p
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_star) TYPE zif_githubae=>response_enterprise_admin_star
      RAISING cx_static_check.
    ...
    METHODS parse_codes_of_conduct_get_all
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_codes_of_conduct_get_) TYPE zif_githubae=>response_codes_of_conduct_get_
      RAISING cx_static_check.
    ...
    METHODS parse_gists_list_public
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_public) TYPE zif_githubae=>response_gists_list_public
      RAISING cx_static_check.
    METHODS parse_gists_list_starred
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_starred) TYPE zif_githubae=>response_gists_list_starred
      RAISING cx_static_check.
    METHODS parse_gists_list_comments
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_comments) TYPE zif_githubae=>response_gists_list_comments
      RAISING cx_static_check.
    METHODS parse_gists_list_commits
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_commits) TYPE zif_githubae=>response_gists_list_commits
      RAISING cx_static_check.
    METHODS parse_gists_list_forks
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_forks) TYPE zif_githubae=>response_gists_list_forks
      RAISING cx_static_check.
    METHODS parse_gists_check_is_starred
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_check_is_starre) TYPE zif_githubae=>response_gists_check_is_starre
      RAISING cx_static_check.
    METHODS parse_gitignore_get_all_templa
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gitignore_get_all_tem) TYPE zif_githubae=>response_gitignore_get_all_tem
      RAISING cx_static_check.
    METHODS parse_apps_list_repos_accessib
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_apps_list_repos_acces) TYPE zif_githubae=>response_apps_list_repos_acces
      RAISING cx_static_check.
    METHODS parse_issues_list
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list) TYPE zif_githubae=>response_issues_list
      RAISING cx_static_check.
    ...
    METHODS parse_activity_mark_notificati
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_mark_notific) TYPE zif_githubae=>response_activity_mark_notific
      RAISING cx_static_check.
    ...
    METHODS parse_orgs_list_app_installati
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_app_install) TYPE zif_githubae=>response_orgs_list_app_install
      RAISING cx_static_check.
    METHODS parse_issues_list_for_org
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_for_org) TYPE zif_githubae=>response_issues_list_for_org
      RAISING cx_static_check.
    ...
    METHODS parse_repos_list_for_org
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_for_org) TYPE zif_githubae=>response_repos_list_for_org
      RAISING cx_static_check.
    METHODS parse_teams_list
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list) TYPE zif_githubae=>response_teams_list
      RAISING cx_static_check.
    METHODS parse_teams_list_discussions_i
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_discussion) TYPE zif_githubae=>response_teams_list_discussion
      RAISING cx_static_check.
    METHODS parse_teams_list_discussion_co
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_discussi01) TYPE zif_githubae=>response_teams_list_discussi01
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_team_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_te) TYPE zif_githubae=>response_reactions_list_for_te
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_tea01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_01) TYPE zif_githubae=>response_reactions_list_for_01
      RAISING cx_static_check.
    ...
    METHODS parse_teams_list_projects_in_o
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_projects_i) TYPE zif_githubae=>response_teams_list_projects_i
      RAISING cx_static_check.
    METHODS parse_teams_add_or_update_proj
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_add_or_update_p) TYPE zif_githubae=>response_teams_add_or_update_p
      RAISING cx_static_check.
    METHODS parse_teams_list_repos_in_org
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_repos_in_o) TYPE zif_githubae=>response_teams_list_repos_in_o
      RAISING cx_static_check.
    METHODS parse_teams_list_child_in_org
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_child_in_o) TYPE zif_githubae=>response_teams_list_child_in_o
      RAISING cx_static_check.
    METHODS parse_projects_delete_card
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_delete_card) TYPE zif_githubae=>response_projects_delete_card
      RAISING cx_static_check.
    METHODS parse_projects_move_card
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_move_card) TYPE zif_githubae=>response_projects_move_card
      RAISING cx_static_check.
    METHODS parse_projects_move_card01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_move_card01) TYPE zif_githubae=>response_projects_move_card01
      RAISING cx_static_check.
    METHODS parse_projects_move_card02
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_move_card02) TYPE zif_githubae=>response_projects_move_card02
      RAISING cx_static_check.
    METHODS parse_projects_list_cards
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_list_cards) TYPE zif_githubae=>response_projects_list_cards
      RAISING cx_static_check.
    METHODS parse_projects_create_card
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_create_card) TYPE zif_githubae=>response_projects_create_card
      RAISING cx_static_check.
    METHODS parse_projects_move_column
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_move_column) TYPE zif_githubae=>response_projects_move_column
      RAISING cx_static_check.
    METHODS parse_projects_update
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_update) TYPE zif_githubae=>response_projects_update
      RAISING cx_static_check.
    METHODS parse_projects_delete
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_delete) TYPE zif_githubae=>response_projects_delete
      RAISING cx_static_check.
    METHODS parse_projects_list_collaborat
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_list_collabo) TYPE zif_githubae=>response_projects_list_collabo
      RAISING cx_static_check.
    METHODS parse_projects_list_columns
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_list_columns) TYPE zif_githubae=>response_projects_list_columns
      RAISING cx_static_check.
    ...
    METHODS parse_repos_list_branches
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_branches) TYPE zif_githubae=>response_repos_list_branches
      RAISING cx_static_check.
    METHODS parse_repos_get_all_status_che
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_all_status_) TYPE zif_githubae=>response_repos_get_all_status_
      RAISING cx_static_check.
    METHODS parse_repos_add_status_check_c
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_add_status_chec) TYPE zif_githubae=>response_repos_add_status_chec
      RAISING cx_static_check.
    METHODS parse_repos_set_status_check_c
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_set_status_chec) TYPE zif_githubae=>response_repos_set_status_chec
      RAISING cx_static_check.
    METHODS parse_repos_remove_status_chec
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_remove_status_c) TYPE zif_githubae=>response_repos_remove_status_c
      RAISING cx_static_check.
    METHODS parse_repos_get_apps_with_acce
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_apps_with_a) TYPE zif_githubae=>response_repos_get_apps_with_a
      RAISING cx_static_check.
    METHODS parse_repos_add_app_access_res
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_add_app_access_) TYPE zif_githubae=>response_repos_add_app_access_
      RAISING cx_static_check.
    METHODS parse_repos_set_app_access_res
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_set_app_access_) TYPE zif_githubae=>response_repos_set_app_access_
      RAISING cx_static_check.
    METHODS parse_repos_remove_app_access_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_remove_app_acce) TYPE zif_githubae=>response_repos_remove_app_acce
      RAISING cx_static_check.
    METHODS parse_repos_get_teams_with_acc
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_teams_with_) TYPE zif_githubae=>response_repos_get_teams_with_
      RAISING cx_static_check.
    METHODS parse_repos_add_team_access_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_add_team_access) TYPE zif_githubae=>response_repos_add_team_access
      RAISING cx_static_check.
    METHODS parse_repos_set_team_access_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_set_team_access) TYPE zif_githubae=>response_repos_set_team_access
      RAISING cx_static_check.
    METHODS parse_repos_remove_team_access
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_remove_team_acc) TYPE zif_githubae=>response_repos_remove_team_acc
      RAISING cx_static_check.
    METHODS parse_repos_get_users_with_acc
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_users_with_) TYPE zif_githubae=>response_repos_get_users_with_
      RAISING cx_static_check.
    METHODS parse_repos_add_user_access_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_add_user_access) TYPE zif_githubae=>response_repos_add_user_access
      RAISING cx_static_check.
    METHODS parse_repos_set_user_access_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_set_user_access) TYPE zif_githubae=>response_repos_set_user_access
      RAISING cx_static_check.
    METHODS parse_repos_remove_user_access
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_remove_user_acc) TYPE zif_githubae=>response_repos_remove_user_acc
      RAISING cx_static_check.
    METHODS parse_checks_list_annotations
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_checks_list_annotatio) TYPE zif_githubae=>response_checks_list_annotatio
      RAISING cx_static_check.
    ...
    METHODS parse_repos_list_commit_commen
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_commit_com) TYPE zif_githubae=>response_repos_list_commit_com
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_commi
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_co) TYPE zif_githubae=>response_reactions_list_for_co
      RAISING cx_static_check.
    METHODS parse_repos_list_commits
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_commits) TYPE zif_githubae=>response_repos_list_commits
      RAISING cx_static_check.
    METHODS parse_repos_list_branches_for_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_branches_f) TYPE zif_githubae=>response_repos_list_branches_f
      RAISING cx_static_check.
    METHODS parse_repos_list_comments_for_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_comments_f) TYPE zif_githubae=>response_repos_list_comments_f
      RAISING cx_static_check.
    METHODS parse_repos_list_pull_requests
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_pull_reque) TYPE zif_githubae=>response_repos_list_pull_reque
      RAISING cx_static_check.
    METHODS parse_checks_list_for_ref
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_checks_list_for_ref) TYPE zif_githubae=>response_checks_list_for_ref
      RAISING cx_static_check.
    METHODS parse_checks_list_suites_for_r
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_checks_list_suites_fo) TYPE zif_githubae=>response_checks_list_suites_fo
      RAISING cx_static_check.
    METHODS parse_repos_list_commit_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_commit_sta) TYPE zif_githubae=>response_repos_list_commit_sta
      RAISING cx_static_check.
    METHODS parse_repos_list_contributors
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_contributo) TYPE zif_githubae=>response_repos_list_contributo
      RAISING cx_static_check.
    METHODS parse_repos_list_deployments
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_deployment) TYPE zif_githubae=>response_repos_list_deployment
      RAISING cx_static_check.
    ...
    METHODS parse_activity_list_repo_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_repo_ev) TYPE zif_githubae=>response_activity_list_repo_ev
      RAISING cx_static_check.
    METHODS parse_repos_list_forks
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_forks) TYPE zif_githubae=>response_repos_list_forks
      RAISING cx_static_check.
    METHODS parse_git_list_matching_refs
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_git_list_matching_ref) TYPE zif_githubae=>response_git_list_matching_ref
      RAISING cx_static_check.
    ...
    METHODS parse_repos_list_invitations
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_invitation) TYPE zif_githubae=>response_repos_list_invitation
      RAISING cx_static_check.
    METHODS parse_issues_list_for_repo
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_for_repo) TYPE zif_githubae=>response_issues_list_for_repo
      RAISING cx_static_check.
    METHODS parse_issues_list_comments_for
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_comments_) TYPE zif_githubae=>response_issues_list_comments_
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_issue
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_is) TYPE zif_githubae=>response_reactions_list_for_is
      RAISING cx_static_check.
    METHODS parse_issues_list_events_for_r
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_events_fo) TYPE zif_githubae=>response_issues_list_events_fo
      RAISING cx_static_check.
    METHODS parse_issues_list_comments
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_comments) TYPE zif_githubae=>response_issues_list_comments
      RAISING cx_static_check.
    METHODS parse_issues_list_events
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_events) TYPE zif_githubae=>response_issues_list_events
      RAISING cx_static_check.
    METHODS parse_issues_list_labels_on_is
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_labels_on) TYPE zif_githubae=>response_issues_list_labels_on
      RAISING cx_static_check.
    METHODS parse_issues_add_labels
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_add_labels) TYPE zif_githubae=>response_issues_add_labels
      RAISING cx_static_check.
    METHODS parse_issues_set_labels
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_set_labels) TYPE zif_githubae=>response_issues_set_labels
      RAISING cx_static_check.
    METHODS parse_issues_remove_label
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_remove_label) TYPE zif_githubae=>response_issues_remove_label
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_iss01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_02) TYPE zif_githubae=>response_reactions_list_for_02
      RAISING cx_static_check.
    METHODS parse_issues_list_events_for_t
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_events_01) TYPE zif_githubae=>response_issues_list_events_01
      RAISING cx_static_check.
    METHODS parse_repos_list_deploy_keys
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_deploy_key) TYPE zif_githubae=>response_repos_list_deploy_key
      RAISING cx_static_check.
    ...
    METHODS parse_issues_list_milestones
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_milestone) TYPE zif_githubae=>response_issues_list_milestone
      RAISING cx_static_check.
    METHODS parse_issues_list_labels_for_m
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_labels_01) TYPE zif_githubae=>response_issues_list_labels_01
      RAISING cx_static_check.
    ...
    METHODS parse_projects_list_for_repo
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_list_for_rep) TYPE zif_githubae=>response_projects_list_for_rep
      RAISING cx_static_check.
    METHODS parse_pulls_list
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list) TYPE zif_githubae=>response_pulls_list
      RAISING cx_static_check.
    METHODS parse_pulls_list_review_commen
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_review_com) TYPE zif_githubae=>response_pulls_list_review_com
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_pull_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_pu) TYPE zif_githubae=>response_reactions_list_for_pu
      RAISING cx_static_check.
    METHODS parse_pulls_list_review_comm01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_review_c01) TYPE zif_githubae=>response_pulls_list_review_c01
      RAISING cx_static_check.
    METHODS parse_pulls_list_commits
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_commits) TYPE zif_githubae=>response_pulls_list_commits
      RAISING cx_static_check.
    METHODS parse_pulls_list_files
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_files) TYPE zif_githubae=>response_pulls_list_files
      RAISING cx_static_check.
    METHODS parse_pulls_merge
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_merge) TYPE zif_githubae=>response_pulls_merge
      RAISING cx_static_check.
    METHODS parse_pulls_merge01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_merge01) TYPE zif_githubae=>response_pulls_merge01
      RAISING cx_static_check.
    METHODS parse_pulls_list_reviews
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_reviews) TYPE zif_githubae=>response_pulls_list_reviews
      RAISING cx_static_check.
    METHODS parse_pulls_list_comments_for_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_comments_f) TYPE zif_githubae=>response_pulls_list_comments_f
      RAISING cx_static_check.
    METHODS parse_pulls_update_branch
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_update_branch) TYPE zif_githubae=>response_pulls_update_branch
      RAISING cx_static_check.
    METHODS parse_repos_list_releases
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_releases) TYPE zif_githubae=>response_repos_list_releases
      RAISING cx_static_check.
    ...
    METHODS parse_repos_get_code_frequency
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_code_freque) TYPE zif_githubae=>response_repos_get_code_freque
      RAISING cx_static_check.
    METHODS parse_repos_get_commit_activit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_commit_acti) TYPE zif_githubae=>response_repos_get_commit_acti
      RAISING cx_static_check.
    METHODS parse_repos_get_contributors_s
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_contributor) TYPE zif_githubae=>response_repos_get_contributor
      RAISING cx_static_check.
    METHODS parse_repos_get_punch_card_sta
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_punch_card_) TYPE zif_githubae=>response_repos_get_punch_card_
      RAISING cx_static_check.
    METHODS parse_activity_list_watchers_f
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_watcher) TYPE zif_githubae=>response_activity_list_watcher
      RAISING cx_static_check.
    METHODS parse_repos_list_tags
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_tags) TYPE zif_githubae=>response_repos_list_tags
      RAISING cx_static_check.
    ...
    METHODS parse_search_code
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_code) TYPE zif_githubae=>response_search_code
      RAISING cx_static_check.
    METHODS parse_search_commits
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_commits) TYPE zif_githubae=>response_search_commits
      RAISING cx_static_check.
    METHODS parse_search_issues_and_pull_r
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_issues_and_pul) TYPE zif_githubae=>response_search_issues_and_pul
      RAISING cx_static_check.
    METHODS parse_search_labels
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_labels) TYPE zif_githubae=>response_search_labels
      RAISING cx_static_check.
    METHODS parse_search_repos
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_repos) TYPE zif_githubae=>response_search_repos
      RAISING cx_static_check.
    METHODS parse_search_topics
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_topics) TYPE zif_githubae=>response_search_topics
      RAISING cx_static_check.
    METHODS parse_search_users
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_users) TYPE zif_githubae=>response_search_users
      RAISING cx_static_check.
    METHODS parse_teams_list_discussions_l
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_discussi02) TYPE zif_githubae=>response_teams_list_discussi02
      RAISING cx_static_check.
    METHODS parse_teams_list_discussion_01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_discussi03) TYPE zif_githubae=>response_teams_list_discussi03
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_tea02
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_03) TYPE zif_githubae=>response_reactions_list_for_03
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_tea03
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_04) TYPE zif_githubae=>response_reactions_list_for_04
      RAISING cx_static_check.
    METHODS parse_teams_list_members_legac
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_members_le) TYPE zif_githubae=>response_teams_list_members_le
      RAISING cx_static_check.
    METHODS parse_teams_add_member_legacy
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_add_member_lega) TYPE zif_githubae=>response_teams_add_member_lega
      RAISING cx_static_check.
    METHODS parse_teams_add_or_update_me01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_add_or_update01) TYPE zif_githubae=>response_teams_add_or_update01
      RAISING cx_static_check.
    METHODS parse_teams_list_projects_lega
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_projects_l) TYPE zif_githubae=>response_teams_list_projects_l
      RAISING cx_static_check.
    METHODS parse_teams_add_or_update_pr01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_add_or_update02) TYPE zif_githubae=>response_teams_add_or_update02
      RAISING cx_static_check.
    METHODS parse_teams_list_repos_legacy
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_repos_lega) TYPE zif_githubae=>response_teams_list_repos_lega
      RAISING cx_static_check.
    METHODS parse_teams_list_child_legacy
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_child_lega) TYPE zif_githubae=>response_teams_list_child_lega
      RAISING cx_static_check.
    METHODS parse_users_list_followers_for
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_followers_) TYPE zif_githubae=>response_users_list_followers_
      RAISING cx_static_check.
    METHODS parse_users_list_followed_by_a
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_followed_b) TYPE zif_githubae=>response_users_list_followed_b
      RAISING cx_static_check.
    METHODS parse_users_list_gpg_keys_for_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_gpg_keys_f) TYPE zif_githubae=>response_users_list_gpg_keys_f
      RAISING cx_static_check.
    METHODS parse_apps_list_installations_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_apps_list_installat01) TYPE zif_githubae=>response_apps_list_installat01
      RAISING cx_static_check.
    METHODS parse_apps_list_installation_r
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_apps_list_installat02) TYPE zif_githubae=>response_apps_list_installat02
      RAISING cx_static_check.
    METHODS parse_issues_list_for_authenti
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_for_authe) TYPE zif_githubae=>response_issues_list_for_authe
      RAISING cx_static_check.
    METHODS parse_users_list_public_ssh_ke
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_public_ssh) TYPE zif_githubae=>response_users_list_public_ssh
      RAISING cx_static_check.
    ...
    METHODS parse_orgs_list_for_authentica
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_for_authent) TYPE zif_githubae=>response_orgs_list_for_authent
      RAISING cx_static_check.
    METHODS parse_repos_list_for_authentic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_for_authen) TYPE zif_githubae=>response_repos_list_for_authen
      RAISING cx_static_check.
    METHODS parse_repos_list_invitations_f
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_invitati01) TYPE zif_githubae=>response_repos_list_invitati01
      RAISING cx_static_check.
    METHODS parse_activity_list_repos_star
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_repos_s) TYPE zif_githubae=>response_activity_list_repos_s
      RAISING cx_static_check.
    METHODS parse_activity_list_watched_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_watched) TYPE zif_githubae=>response_activity_list_watched
      RAISING cx_static_check.
    METHODS parse_teams_list_for_authentic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_for_authen) TYPE zif_githubae=>response_teams_list_for_authen
      RAISING cx_static_check.
    METHODS parse_users_list
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list) TYPE zif_githubae=>response_users_list
      RAISING cx_static_check.
    METHODS parse_activity_list_events_for
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_events_) TYPE zif_githubae=>response_activity_list_events_
      RAISING cx_static_check.
    ...
    METHODS parse_users_list_following_for
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_following_) TYPE zif_githubae=>response_users_list_following_
      RAISING cx_static_check.
    METHODS parse_gists_list_for_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_for_user) TYPE zif_githubae=>response_gists_list_for_user
      RAISING cx_static_check.
    METHODS parse_users_list_gpg_keys_fo01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_gpg_keys01) TYPE zif_githubae=>response_users_list_gpg_keys01
      RAISING cx_static_check.
    METHODS parse_users_list_public_keys_f
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_public_key) TYPE zif_githubae=>response_users_list_public_key
      RAISING cx_static_check.
    METHODS parse_orgs_list_for_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_for_user) TYPE zif_githubae=>response_orgs_list_for_user
      RAISING cx_static_check.
    ...
    METHODS parse_activity_list_repos_watc
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_repos_w) TYPE zif_githubae=>response_activity_list_repos_w
      RAISING cx_static_check.
ENDCLASS.

CLASS zcl_githubae IMPLEMENTATION.
  METHOD constructor.
    mi_client = ii_client.
  ENDMETHOD.
...
* todo, array, contexts
  ...
  METHOD parse_enterprise_admin_list_gl.
    ...
    DATA global_hook TYPE zif_githubae=>global_hook.
  ...
  METHOD parse_enterprise_admin_list_pu.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA enterprise_public_key TYPE zif_githubae=>enterprise_public_key.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_enterprise_admin_list_pr.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA pre_receive_environment TYPE zif_githubae=>pre_receive_environment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
...
* todo, array, errors
  ...
  METHOD parse_enterprise_admin_list_pe.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA authorization TYPE zif_githubae=>authorization.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR authorization.
      authorization = parse_authorization( iv_prefix && '/' && lv_member ).
      APPEND authorization TO response_enterprise_admin_li03.
    ENDLOOP.
  ENDMETHOD.
  ...
  METHOD parse_apps_list_installations.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA installation TYPE zif_githubae=>installation.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR installation.
  ...
  METHOD parse_codes_of_conduct_get_all.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA code_of_conduct TYPE zif_githubae=>code_of_conduct.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_gists_list.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA base_gist TYPE zif_githubae=>base_gist.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR base_gist.
  ...
  METHOD parse_gists_list_comments.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA gist_comment TYPE zif_githubae=>gist_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR gist_comment.
  ...
  METHOD parse_gists_list_commits.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA gist_commit TYPE zif_githubae=>gist_commit.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR gist_commit.
  ...
  METHOD parse_gists_list_forks.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA gist_simple TYPE zif_githubae=>gist_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR gist_simple.
...
* todo, array, repositories
  ...
  METHOD parse_issues_list.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA issue TYPE zif_githubae=>issue.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR issue.
  ...
  METHOD parse_licenses_get_all_commonl.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA license_simple TYPE zif_githubae=>license_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_activity_list_notificati.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA thread TYPE zif_githubae=>thread.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR thread.
  ...
  METHOD parse_orgs_list.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA organization_simple TYPE zif_githubae=>organization_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_orgs_list_webhooks.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA org_hook TYPE zif_githubae=>org_hook.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR org_hook.
...
* todo, array, installations
  ...
  METHOD parse_projects_list_for_org.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA project TYPE zif_githubae=>project.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR project.
  ...
  METHOD parse_teams_list.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA team TYPE zif_githubae=>team.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR team.
  ...
  METHOD parse_teams_list_discussions_i.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA team_discussion TYPE zif_githubae=>team_discussion.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_teams_list_discussion_co.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA team_discussion_comment TYPE zif_githubae=>team_discussion_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
...
* todo, array, errors
  ...
  METHOD parse_teams_list_projects_in_o.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA team_project TYPE zif_githubae=>team_project.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR team_project.
...
* todo, array, errors
  ...
  METHOD parse_projects_list_cards.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA project_card TYPE zif_githubae=>project_card.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR project_card.
...
* todo, array, errors
  ...
  METHOD parse_projects_list_columns.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA project_column TYPE zif_githubae=>project_column.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_list_branches.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA short_branch TYPE zif_githubae=>short_branch.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR short_branch.
...
* todo, handle type array, no item_ref 
  ...
  METHOD parse_repos_get_apps_with_acce.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA integration TYPE zif_githubae=>integration.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR integration.
  ...
  METHOD parse_checks_list_annotations.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA check_annotation TYPE zif_githubae=>check_annotation.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
...
* todo, array, check_runs
  ...
  METHOD parse_repos_list_collaborators.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA collaborator TYPE zif_githubae=>collaborator.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR collaborator.
  ...
  METHOD parse_repos_list_commit_commen.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA commit_comment TYPE zif_githubae=>commit_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_list_commits.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA commit TYPE zif_githubae=>commit.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR commit.
  ...
  METHOD parse_repos_list_branches_for_.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA branch_short TYPE zif_githubae=>branch_short.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR branch_short.
  ...
  METHOD parse_repos_list_pull_requests.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA pull_request_simple TYPE zif_githubae=>pull_request_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
...
* todo, array, check_suites
  ...
  METHOD parse_repos_list_commit_status.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA status TYPE zif_githubae=>status.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR status.
  ...
  METHOD parse_repos_list_contributors.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA contributor TYPE zif_githubae=>contributor.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR contributor.
  ...
  METHOD parse_repos_list_deployment_st.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA deployment_status TYPE zif_githubae=>deployment_status.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_git_list_matching_refs.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA git_ref TYPE zif_githubae=>git_ref.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR git_ref.
  ...
  METHOD parse_repos_list_webhooks.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA hook TYPE zif_githubae=>hook.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR hook.
  ...
  METHOD parse_repos_list_invitations.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA repository_invitation TYPE zif_githubae=>repository_invitation.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_issues_list_for_repo.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA issue_simple TYPE zif_githubae=>issue_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR issue_simple.
  ...
  METHOD parse_issues_list_comments_for.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA issue_comment TYPE zif_githubae=>issue_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR issue_comment.
  ...
  METHOD parse_issues_list_events_for_r.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA issue_event TYPE zif_githubae=>issue_event.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR issue_event.
  ...
  METHOD parse_issues_list_events.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA issue_event_for_issue TYPE zif_githubae=>issue_event_for_issue.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_issues_list_labels_on_is.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA label TYPE zif_githubae=>label.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR label.
  ...
  METHOD parse_repos_list_deploy_keys.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA deploy_key TYPE zif_githubae=>deploy_key.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR deploy_key.
  ...
  METHOD parse_issues_list_milestones.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA milestone TYPE zif_githubae=>milestone.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR milestone.
  ...
  METHOD parse_repos_list_pages_builds.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA page_build TYPE zif_githubae=>page_build.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR page_build.
  ...
  METHOD parse_pulls_list_review_commen.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA pull_request_review_comment TYPE zif_githubae=>pull_request_review_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_pulls_list_files.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA diff_entry TYPE zif_githubae=>diff_entry.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR diff_entry.
  ...
  METHOD parse_pulls_list_reviews.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA pull_request_review TYPE zif_githubae=>pull_request_review.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_pulls_list_comments_for_.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA review_comment TYPE zif_githubae=>review_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_list_releases.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA release TYPE zif_githubae=>release.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR release.
  ...
  METHOD parse_repos_list_release_asset.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA release_asset TYPE zif_githubae=>release_asset.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR release_asset.
  ...
  METHOD parse_repos_get_code_frequency.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA code_frequency_stat TYPE zif_githubae=>code_frequency_stat.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_get_commit_activit.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA commit_activity TYPE zif_githubae=>commit_activity.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_get_contributors_s.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA contributor_activity TYPE zif_githubae=>contributor_activity.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_list_tags.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA tag TYPE zif_githubae=>tag.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR tag.
...
* todo, array, errors
  ...
  METHOD parse_users_list_gpg_keys_for_.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA gpg_key TYPE zif_githubae=>gpg_key.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR gpg_key.
...
* todo, array, repositories
  ...
  METHOD parse_users_list_public_ssh_ke.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA key TYPE zif_githubae=>key.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR key.
  ...
  METHOD parse_orgs_list_memberships_fo.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA org_membership TYPE zif_githubae=>org_membership.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_teams_list_for_authentic.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA team_full TYPE zif_githubae=>team_full.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR team_full.
  ...
  METHOD parse_users_list_public_keys_f.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA key_simple TYPE zif_githubae=>key_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR key_simple.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~apps_revoke_grant_for_applicat.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~apps_check_authorization.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~apps_reset_authorization.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/applications/{client_id}/tokens/{access_token}'.
    REPLACE ALL OCCURRENCES OF '{client_id}' IN lv_uri WITH client_id.
  ...
  METHOD zif_githubae~apps_revoke_authorization_for_.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/applications/{client_id}/tokens/{access_token}'.
    REPLACE ALL OCCURRENCES OF '{client_id}' IN lv_uri WITH client_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~reactions_delete_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~repos_rename_branch.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/repos/{owner}/{repo}/branches/{branch}/rename'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
    REPLACE ALL OCCURRENCES OF '{repo}' IN lv_uri WITH repo.
    REPLACE ALL OCCURRENCES OF '{branch}' IN lv_uri WITH branch.
    mi_client->request->set_method( 'POST' ).
...
* todo, handle more responses
  ...
  METHOD zif_githubae~codes_of_conduct_get_for_repo.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~teams_get_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubae~teams_update_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}'.
    lv_temp = team_id.
  ...
  METHOD zif_githubae~teams_delete_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~teams_list_discussions_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubae~teams_create_discussion_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/discussions'.
    lv_temp = team_id.
  ...
  METHOD zif_githubae~teams_get_discussion_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubae~teams_update_discussion_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/discussions/{discussion_number}'.
    lv_temp = team_id.
  ...
  METHOD zif_githubae~teams_delete_discussion_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/discussions/{discussion_number}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~teams_list_discussion_commen01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubae~teams_create_discussion_comm01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/discussions/{discussion_number}/comments'.
    lv_temp = team_id.
  ...
  METHOD zif_githubae~teams_get_discussion_comment_l.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubae~teams_update_discussion_comm01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}'.
    lv_temp = team_id.
  ...
  METHOD zif_githubae~teams_delete_discussion_comm01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~reactions_list_for_team_disc02.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubae~reactions_create_for_team_di02.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/discussions/{discussion_number}/comments/{comment_number}/reactions'.
    lv_temp = team_id.
  ...
  METHOD zif_githubae~reactions_list_for_team_disc03.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubae~reactions_create_for_team_di03.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/discussions/{discussion_number}/reactions'.
    lv_temp = team_id.
  ...
  METHOD zif_githubae~teams_list_members_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubae~teams_get_member_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~teams_add_member_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/members/{username}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~teams_remove_member_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/members/{username}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~teams_get_membership_for_use01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubae~teams_add_or_update_membersh01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/memberships/{username}'.
    lv_temp = team_id.
  ...
  METHOD zif_githubae~teams_remove_membership_for_01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/memberships/{username}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~teams_list_projects_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubae~teams_check_permissions_for_01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubae~teams_add_or_update_project_01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/projects/{project_id}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~teams_remove_project_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/projects/{project_id}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~teams_list_repos_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_githubae~teams_check_permissions_for_02.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~teams_add_or_update_repo_per01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/repos/{owner}/{repo}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~teams_remove_repo_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/teams/{team_id}/repos/{owner}/{repo}'.
    lv_temp = team_id.
...
* todo, handle more responses
  ...
  METHOD zif_githubae~teams_list_child_legacy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
