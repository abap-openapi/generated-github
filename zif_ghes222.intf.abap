...
* Component schema: runner-no-labels, object
  TYPES: BEGIN OF runner_no_labels,
           id TYPE f,
           name TYPE string,
           os TYPE string,
           status TYPE string,
           busy TYPE abap_bool,
         END OF runner_no_labels.
...
* Component schema: code-scanning-alert-items, object
  TYPES: BEGIN OF code_scanning_alert_items,
           ...
           instance TYPE code_scanning_alert_instance,
           classification TYPE code_scanning_alert_classifica,
...
* Component schema: code-scanning-analysis-sarif-file-2, string
...
* Component schema: response_enterprise_admin_list_self_h02, object
  TYPES: BEGIN OF response_enterprise_admin_li08,
           total_count TYPE f,
           runners TYPE STANDARD TABLE OF string WITH DEFAULT KEY, " todo, handle array
         END OF response_enterprise_admin_li08.

* Component schema: response_enterprise_admin_list_runner_a, array
  TYPES response_enterprise_admin_li09 TYPE STANDARD TABLE OF runner_application WITH DEFAULT KEY.
...
* Component schema: response_enterprise_admin_list_pre_re02, array
  TYPES response_enterprise_admin_li10 TYPE STANDARD TABLE OF org_pre_receive_hook WITH DEFAULT KEY.
...
* Component schema: response_enterprise_admin_list_pre_re03, array
  TYPES response_enterprise_admin_li11 TYPE STANDARD TABLE OF repository_pre_receive_hook WITH DEFAULT KEY.
...
*     application/json, #/components/schemas/response_enterprise_admin_list_runner_a
  METHODS enterprise_admin_list_runner_a
    IMPORTING
      enterprise TYPE string
    RETURNING
      VALUE(return_data) TYPE response_enterprise_admin_li09
    RAISING cx_static_check.
...
*     application/json, #/components/schemas/runner-no-labels
  METHODS enterprise_admin_get_self_ho01
    IMPORTING
      ...
      runner_id TYPE i
    RETURNING
      VALUE(return_data) TYPE runner_no_labels
    RAISING cx_static_check.
...
*     application/json, #/components/schemas/response_enterprise_admin_list_pre_re02
  METHODS enterprise_admin_list_pre_re02
    IMPORTING
      ...
      direction TYPE string DEFAULT 'desc'
    RETURNING
      VALUE(return_data) TYPE response_enterprise_admin_li10
    RAISING cx_static_check.
...
*     application/json, #/components/schemas/response_enterprise_admin_list_pre_re03
  METHODS enterprise_admin_list_pre_re03
    IMPORTING
      ...
      direction TYPE string DEFAULT 'desc'
    RETURNING
      VALUE(return_data) TYPE response_enterprise_admin_li11
    RAISING cx_static_check.
