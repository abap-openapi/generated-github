...
* GitHub v3 REST API
  ...
  PROTECTED SECTION.
    ...
    METHODS parse_public_key_full
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(public_key_full) TYPE zif_ghes221=>public_key_full
      RAISING cx_static_check.
    ...
    METHODS parse_nullable_simple_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(nullable_simple_user) TYPE zif_ghes221=>nullable_simple_user
      RAISING cx_static_check.
    ...
    METHODS parse_nullable_scoped_installa
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(nullable_scoped_installation) TYPE zif_ghes221=>nullable_scoped_installation
      RAISING cx_static_check.
    ...
    METHODS parse_nullable_license_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(nullable_license_simple) TYPE zif_ghes221=>nullable_license_simple
      RAISING cx_static_check.
    ...
    METHODS parse_nullable_authorization
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(nullable_authorization) TYPE zif_ghes221=>nullable_authorization
      RAISING cx_static_check.
    ...
    METHODS parse_enterprise_repository_ov
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_repository_overview) TYPE zif_ghes221=>enterprise_repository_overview
      RAISING cx_static_check.
    METHODS parse_enterprise_hook_overview
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_hook_overview) TYPE zif_ghes221=>enterprise_hook_overview
      RAISING cx_static_check.
    METHODS parse_enterprise_page_overview
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_page_overview) TYPE zif_ghes221=>enterprise_page_overview
      RAISING cx_static_check.
    METHODS parse_enterprise_organization_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_organization_overvi) TYPE zif_ghes221=>enterprise_organization_overvi
      RAISING cx_static_check.
    METHODS parse_enterprise_user_overview
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_user_overview) TYPE zif_ghes221=>enterprise_user_overview
      RAISING cx_static_check.
    METHODS parse_enterprise_pull_request_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_pull_request_overvi) TYPE zif_ghes221=>enterprise_pull_request_overvi
      RAISING cx_static_check.
    METHODS parse_enterprise_issue_overvie
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_issue_overview) TYPE zif_ghes221=>enterprise_issue_overview
      RAISING cx_static_check.
    METHODS parse_enterprise_milestone_ove
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_milestone_overview) TYPE zif_ghes221=>enterprise_milestone_overview
      RAISING cx_static_check.
    METHODS parse_enterprise_gist_overview
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_gist_overview) TYPE zif_ghes221=>enterprise_gist_overview
      RAISING cx_static_check.
    METHODS parse_enterprise_comment_overv
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_comment_overview) TYPE zif_ghes221=>enterprise_comment_overview
      RAISING cx_static_check.
    ...
    METHODS parse_nullable_milestone
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(nullable_milestone) TYPE zif_ghes221=>nullable_milestone
      RAISING cx_static_check.
    ...
    METHODS parse_nullable_integration
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(nullable_integration) TYPE zif_ghes221=>nullable_integration
      RAISING cx_static_check.
    ...
    METHODS parse_gist_history
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gist_history) TYPE zif_ghes221=>gist_history
      RAISING cx_static_check.
    ...
    METHODS parse_nullable_repository
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(nullable_repository) TYPE zif_ghes221=>nullable_repository
      RAISING cx_static_check.
    ...
    METHODS parse_nullable_team_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(nullable_team_simple) TYPE zif_ghes221=>nullable_team_simple
      RAISING cx_static_check.
    METHODS parse_team
      IMPORTING iv_prefix TYPE string
    ...
    METHODS parse_code_of_conduct_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_of_conduct_simple) TYPE zif_ghes221=>code_of_conduct_simple
      RAISING cx_static_check.
    ...
    METHODS parse_nullable_git_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(nullable_git_user) TYPE zif_ghes221=>nullable_git_user
      RAISING cx_static_check.
    ...
    METHODS parse_deployment_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(deployment_simple) TYPE zif_ghes221=>deployment_simple
      RAISING cx_static_check.
    ...
    METHODS parse_labeled_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(labeled_issue_event) TYPE zif_ghes221=>labeled_issue_event
      RAISING cx_static_check.
    METHODS parse_unlabeled_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(unlabeled_issue_event) TYPE zif_ghes221=>unlabeled_issue_event
      RAISING cx_static_check.
    METHODS parse_assigned_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(assigned_issue_event) TYPE zif_ghes221=>assigned_issue_event
      RAISING cx_static_check.
    METHODS parse_unassigned_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(unassigned_issue_event) TYPE zif_ghes221=>unassigned_issue_event
      RAISING cx_static_check.
    METHODS parse_milestoned_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(milestoned_issue_event) TYPE zif_ghes221=>milestoned_issue_event
      RAISING cx_static_check.
    METHODS parse_demilestoned_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(demilestoned_issue_event) TYPE zif_ghes221=>demilestoned_issue_event
      RAISING cx_static_check.
    METHODS parse_renamed_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(renamed_issue_event) TYPE zif_ghes221=>renamed_issue_event
      RAISING cx_static_check.
    METHODS parse_review_requested_issue_e
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(review_requested_issue_event) TYPE zif_ghes221=>review_requested_issue_event
      RAISING cx_static_check.
    METHODS parse_review_request_removed_i
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(review_request_removed_issue_e) TYPE zif_ghes221=>review_request_removed_issue_e
      RAISING cx_static_check.
    METHODS parse_review_dismissed_issue_e
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(review_dismissed_issue_event) TYPE zif_ghes221=>review_dismissed_issue_event
      RAISING cx_static_check.
    METHODS parse_locked_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(locked_issue_event) TYPE zif_ghes221=>locked_issue_event
      RAISING cx_static_check.
    METHODS parse_added_to_project_issue_e
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(added_to_project_issue_event) TYPE zif_ghes221=>added_to_project_issue_event
      RAISING cx_static_check.
    METHODS parse_moved_column_in_project_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(moved_column_in_project_issue_) TYPE zif_ghes221=>moved_column_in_project_issue_
      RAISING cx_static_check.
    METHODS parse_removed_from_project_iss
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(removed_from_project_issue_eve) TYPE zif_ghes221=>removed_from_project_issue_eve
      RAISING cx_static_check.
    METHODS parse_converted_note_to_issue_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(converted_note_to_issue_issue_) TYPE zif_ghes221=>converted_note_to_issue_issue_
      RAISING cx_static_check.
    ...
    METHODS parse_timeline_comment_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_comment_event) TYPE zif_ghes221=>timeline_comment_event
      RAISING cx_static_check.
    METHODS parse_timeline_cross_reference
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_cross_referenced_even) TYPE zif_ghes221=>timeline_cross_referenced_even
      RAISING cx_static_check.
    METHODS parse_timeline_committed_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_committed_event) TYPE zif_ghes221=>timeline_committed_event
      RAISING cx_static_check.
    METHODS parse_timeline_reviewed_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_reviewed_event) TYPE zif_ghes221=>timeline_reviewed_event
      RAISING cx_static_check.
    ...
    METHODS parse_timeline_line_commented_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_line_commented_event) TYPE zif_ghes221=>timeline_line_commented_event
      RAISING cx_static_check.
    METHODS parse_timeline_commit_commente
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_commit_commented_even) TYPE zif_ghes221=>timeline_commit_commented_even
      RAISING cx_static_check.
    METHODS parse_timeline_assigned_issue_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_assigned_issue_event) TYPE zif_ghes221=>timeline_assigned_issue_event
      RAISING cx_static_check.
    METHODS parse_timeline_unassigned_issu
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_unassigned_issue_even) TYPE zif_ghes221=>timeline_unassigned_issue_even
      RAISING cx_static_check.
    METHODS parse_timeline_issue_events
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(timeline_issue_events) TYPE zif_ghes221=>timeline_issue_events
      RAISING cx_static_check.
    ...
    METHODS json_enterprise_admin_create_g
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_create_gl
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_g
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_update_gl
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete_g
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_delete_gl
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_l
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_update_ld
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update01
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_update_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_o
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_create_or
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_o
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_update_or
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_p
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_create_pr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_p
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_update_pr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete_p
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_delete_pr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create01
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_create_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update02
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_update_02
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete01
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_delete_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_u
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_create_us
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_u
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_update_us
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete_u
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_delete_us
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_i
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_create_im
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete_i
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_delete_im
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_create_from_manifest
      IMPORTING data TYPE zif_ghes221=>bodyapps_create_from_manifest
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_create_installation_
      IMPORTING data TYPE zif_ghes221=>bodyapps_create_installation_a
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_delete_authorization
      IMPORTING data TYPE zif_ghes221=>bodyapps_delete_authorization
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_check_token
      IMPORTING data TYPE zif_ghes221=>bodyapps_check_token
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_reset_token
      IMPORTING data TYPE zif_ghes221=>bodyapps_reset_token
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_delete_token
      IMPORTING data TYPE zif_ghes221=>bodyapps_delete_token
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_create
      IMPORTING data TYPE zif_ghes221=>bodygists_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_update
      IMPORTING data TYPE zif_ghes221=>bodygists_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_delete
      IMPORTING data TYPE zif_ghes221=>bodygists_delete
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_create_comment
      IMPORTING data TYPE zif_ghes221=>bodygists_create_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_update_comment
      IMPORTING data TYPE zif_ghes221=>bodygists_update_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_delete_comment
      IMPORTING data TYPE zif_ghes221=>bodygists_delete_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_markdown_render
      IMPORTING data TYPE zif_ghes221=>bodymarkdown_render
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_mark_notificatio
      IMPORTING data TYPE zif_ghes221=>bodyactivity_mark_notification
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_set_thread_subsc
      IMPORTING data TYPE zif_ghes221=>bodyactivity_set_thread_subscr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_delete_thread_su
      IMPORTING data TYPE zif_ghes221=>bodyactivity_delete_thread_sub
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_update
      IMPORTING data TYPE zif_ghes221=>bodyorgs_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_create_webhook
      IMPORTING data TYPE zif_ghes221=>bodyorgs_create_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_update_webhook
      IMPORTING data TYPE zif_ghes221=>bodyorgs_update_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_delete_webhook
      IMPORTING data TYPE zif_ghes221=>bodyorgs_delete_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_set_membership_for_u
      IMPORTING data TYPE zif_ghes221=>bodyorgs_set_membership_for_us
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_remove_membership_fo
      IMPORTING data TYPE zif_ghes221=>bodyorgs_remove_membership_for
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update03
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_update_03
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_remove_p
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_remove_pr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_for_org
      IMPORTING data TYPE zif_ghes221=>bodyprojects_create_for_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_in_org
      IMPORTING data TYPE zif_ghes221=>bodyrepos_create_in_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create
      IMPORTING data TYPE zif_ghes221=>bodyteams_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_in_org
      IMPORTING data TYPE zif_ghes221=>bodyteams_update_in_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_in_org
      IMPORTING data TYPE zif_ghes221=>bodyteams_delete_in_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_discussion_i
      IMPORTING data TYPE zif_ghes221=>bodyteams_create_discussion_in
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_discussion_i
      IMPORTING data TYPE zif_ghes221=>bodyteams_update_discussion_in
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_discussion_i
      IMPORTING data TYPE zif_ghes221=>bodyteams_delete_discussion_in
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_discussion_c
      IMPORTING data TYPE zif_ghes221=>bodyteams_create_discussion_co
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_discussion_c
      IMPORTING data TYPE zif_ghes221=>bodyteams_update_discussion_co
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_discussion_c
      IMPORTING data TYPE zif_ghes221=>bodyteams_delete_discussion_co
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_team
      IMPORTING data TYPE zif_ghes221=>bodyreactions_create_for_team_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_te01
      IMPORTING data TYPE zif_ghes221=>bodyreactions_create_for_tea01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_membe
      IMPORTING data TYPE zif_ghes221=>bodyteams_add_or_update_member
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_membership_f
      IMPORTING data TYPE zif_ghes221=>bodyteams_remove_membership_fo
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_proje
      IMPORTING data TYPE zif_ghes221=>bodyteams_add_or_update_projec
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_project_in_o
      IMPORTING data TYPE zif_ghes221=>bodyteams_remove_project_in_or
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_repo_
      IMPORTING data TYPE zif_ghes221=>bodyteams_add_or_update_repo_p
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_repo_in_org
      IMPORTING data TYPE zif_ghes221=>bodyteams_remove_repo_in_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_update_card
      IMPORTING data TYPE zif_ghes221=>bodyprojects_update_card
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_delete_card
      IMPORTING data TYPE zif_ghes221=>bodyprojects_delete_card
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_move_card
      IMPORTING data TYPE zif_ghes221=>bodyprojects_move_card
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_update_column
      IMPORTING data TYPE zif_ghes221=>bodyprojects_update_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_delete_column
      IMPORTING data TYPE zif_ghes221=>bodyprojects_delete_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_move_column
      IMPORTING data TYPE zif_ghes221=>bodyprojects_move_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_update
      IMPORTING data TYPE zif_ghes221=>bodyprojects_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_delete
      IMPORTING data TYPE zif_ghes221=>bodyprojects_delete
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_add_collaborator
      IMPORTING data TYPE zif_ghes221=>bodyprojects_add_collaborator
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_remove_collabora
      IMPORTING data TYPE zif_ghes221=>bodyprojects_remove_collaborat
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_column
      IMPORTING data TYPE zif_ghes221=>bodyprojects_create_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update
      IMPORTING data TYPE zif_ghes221=>bodyrepos_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete
      IMPORTING data TYPE zif_ghes221=>bodyrepos_delete
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_branch_prote
      IMPORTING data TYPE zif_ghes221=>bodyrepos_update_branch_protec
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_branch_prote
      IMPORTING data TYPE zif_ghes221=>bodyrepos_delete_branch_protec
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_pull_request
      IMPORTING data TYPE zif_ghes221=>bodyrepos_update_pull_request_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_pull_request
      IMPORTING data TYPE zif_ghes221=>bodyrepos_delete_pull_request_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_status_check
      IMPORTING data TYPE zif_ghes221=>bodyrepos_update_status_check_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_remove_status_check
      IMPORTING data TYPE zif_ghes221=>bodyrepos_remove_status_check_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_create
      IMPORTING data TYPE zif_ghes221=>bodychecks_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_update
      IMPORTING data TYPE zif_ghes221=>bodychecks_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_create_suite
      IMPORTING data TYPE zif_ghes221=>bodychecks_create_suite
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_set_suites_prefere
      IMPORTING data TYPE zif_ghes221=>bodychecks_set_suites_preferen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_add_collaborator
      IMPORTING data TYPE zif_ghes221=>bodyrepos_add_collaborator
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_remove_collaborator
      IMPORTING data TYPE zif_ghes221=>bodyrepos_remove_collaborator
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_commit_comme
      IMPORTING data TYPE zif_ghes221=>bodyrepos_update_commit_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_commit_comme
      IMPORTING data TYPE zif_ghes221=>bodyrepos_delete_commit_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_comm
      IMPORTING data TYPE zif_ghes221=>bodyreactions_create_for_commi
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_commit_comme
      IMPORTING data TYPE zif_ghes221=>bodyrepos_create_commit_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_create_content_attac
      IMPORTING data TYPE zif_ghes221=>bodyapps_create_content_attach
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_or_update_fi
      IMPORTING data TYPE zif_ghes221=>bodyrepos_create_or_update_fil
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_file
      IMPORTING data TYPE zif_ghes221=>bodyrepos_delete_file
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_deployment
      IMPORTING data TYPE zif_ghes221=>bodyrepos_create_deployment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_deployment_s
      IMPORTING data TYPE zif_ghes221=>bodyrepos_create_deployment_st
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_dispatch_eve
      IMPORTING data TYPE zif_ghes221=>bodyrepos_create_dispatch_even
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_fork
      IMPORTING data TYPE zif_ghes221=>bodyrepos_create_fork
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_blob
      IMPORTING data TYPE zif_ghes221=>bodygit_create_blob
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_commit
      IMPORTING data TYPE zif_ghes221=>bodygit_create_commit
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_ref
      IMPORTING data TYPE zif_ghes221=>bodygit_create_ref
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_update_ref
      IMPORTING data TYPE zif_ghes221=>bodygit_update_ref
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_delete_ref
      IMPORTING data TYPE zif_ghes221=>bodygit_delete_ref
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_tag
      IMPORTING data TYPE zif_ghes221=>bodygit_create_tag
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_tree
      IMPORTING data TYPE zif_ghes221=>bodygit_create_tree
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_webhook
      IMPORTING data TYPE zif_ghes221=>bodyrepos_create_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_webhook
      IMPORTING data TYPE zif_ghes221=>bodyrepos_update_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_webhook
      IMPORTING data TYPE zif_ghes221=>bodyrepos_delete_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_invitation
      IMPORTING data TYPE zif_ghes221=>bodyrepos_update_invitation
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_invitation
      IMPORTING data TYPE zif_ghes221=>bodyrepos_delete_invitation
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create
      IMPORTING data TYPE zif_ghes221=>bodyissues_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update_comment
      IMPORTING data TYPE zif_ghes221=>bodyissues_update_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_delete_comment
      IMPORTING data TYPE zif_ghes221=>bodyissues_delete_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_issu
      IMPORTING data TYPE zif_ghes221=>bodyreactions_create_for_issue
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update
      IMPORTING data TYPE zif_ghes221=>bodyissues_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_add_assignees
      IMPORTING data TYPE zif_ghes221=>bodyissues_add_assignees
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_remove_assignees
      IMPORTING data TYPE zif_ghes221=>bodyissues_remove_assignees
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create_comment
      IMPORTING data TYPE zif_ghes221=>bodyissues_create_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_lock
      IMPORTING data TYPE zif_ghes221=>bodyissues_lock
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_unlock
      IMPORTING data TYPE zif_ghes221=>bodyissues_unlock
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_is01
      IMPORTING data TYPE zif_ghes221=>bodyreactions_create_for_iss01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_deploy_key
      IMPORTING data TYPE zif_ghes221=>bodyrepos_create_deploy_key
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create_label
      IMPORTING data TYPE zif_ghes221=>bodyissues_create_label
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update_label
      IMPORTING data TYPE zif_ghes221=>bodyissues_update_label
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_delete_label
      IMPORTING data TYPE zif_ghes221=>bodyissues_delete_label
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_merge
      IMPORTING data TYPE zif_ghes221=>bodyrepos_merge
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create_milestone
      IMPORTING data TYPE zif_ghes221=>bodyissues_create_milestone
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update_milestone
      IMPORTING data TYPE zif_ghes221=>bodyissues_update_milestone
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_delete_milestone
      IMPORTING data TYPE zif_ghes221=>bodyissues_delete_milestone
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_mark_repo_notifi
      IMPORTING data TYPE zif_ghes221=>bodyactivity_mark_repo_notific
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_pages_site
      IMPORTING data TYPE zif_ghes221=>bodyrepos_create_pages_site
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_information_
      IMPORTING data TYPE zif_ghes221=>bodyrepos_update_information_a
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_pages_site
      IMPORTING data TYPE zif_ghes221=>bodyrepos_delete_pages_site
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update04
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_update_04
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_remove01
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_remove_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_for_repo
      IMPORTING data TYPE zif_ghes221=>bodyprojects_create_for_repo
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create
      IMPORTING data TYPE zif_ghes221=>bodypulls_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update_review_comme
      IMPORTING data TYPE zif_ghes221=>bodypulls_update_review_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_delete_review_comme
      IMPORTING data TYPE zif_ghes221=>bodypulls_delete_review_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_pull
      IMPORTING data TYPE zif_ghes221=>bodyreactions_create_for_pull_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update
      IMPORTING data TYPE zif_ghes221=>bodypulls_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create_review_comme
      IMPORTING data TYPE zif_ghes221=>bodypulls_create_review_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create_reply_for_re
      IMPORTING data TYPE zif_ghes221=>bodypulls_create_reply_for_rev
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_merge
      IMPORTING data TYPE zif_ghes221=>bodypulls_merge
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_request_reviewers
      IMPORTING data TYPE zif_ghes221=>bodypulls_request_reviewers
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_remove_requested_re
      IMPORTING data TYPE zif_ghes221=>bodypulls_remove_requested_rev
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create_review
      IMPORTING data TYPE zif_ghes221=>bodypulls_create_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update_review
      IMPORTING data TYPE zif_ghes221=>bodypulls_update_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_delete_pending_revi
      IMPORTING data TYPE zif_ghes221=>bodypulls_delete_pending_revie
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_dismiss_review
      IMPORTING data TYPE zif_ghes221=>bodypulls_dismiss_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_submit_review
      IMPORTING data TYPE zif_ghes221=>bodypulls_submit_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update_branch
      IMPORTING data TYPE zif_ghes221=>bodypulls_update_branch
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_release
      IMPORTING data TYPE zif_ghes221=>bodyrepos_create_release
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_release_asse
      IMPORTING data TYPE zif_ghes221=>bodyrepos_update_release_asset
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_release_asse
      IMPORTING data TYPE zif_ghes221=>bodyrepos_delete_release_asset
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_release
      IMPORTING data TYPE zif_ghes221=>bodyrepos_update_release
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_release
      IMPORTING data TYPE zif_ghes221=>bodyrepos_delete_release
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_commit_statu
      IMPORTING data TYPE zif_ghes221=>bodyrepos_create_commit_status
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_set_repo_subscri
      IMPORTING data TYPE zif_ghes221=>bodyactivity_set_repo_subscrip
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_delete_repo_subs
      IMPORTING data TYPE zif_ghes221=>bodyactivity_delete_repo_subsc
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_replace_all_topics
      IMPORTING data TYPE zif_ghes221=>bodyrepos_replace_all_topics
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_transfer
      IMPORTING data TYPE zif_ghes221=>bodyrepos_transfer
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_using_templa
      IMPORTING data TYPE zif_ghes221=>bodyrepos_create_using_templat
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_users_update_authenticate
      IMPORTING data TYPE zif_ghes221=>bodyusers_update_authenticated
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_users_create_gpg_key_for_
      IMPORTING data TYPE zif_ghes221=>bodyusers_create_gpg_key_for_a
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_users_create_public_ssh_k
      IMPORTING data TYPE zif_ghes221=>bodyusers_create_public_ssh_ke
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_update_membership_fo
      IMPORTING data TYPE zif_ghes221=>bodyorgs_update_membership_for
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_for_authe
      IMPORTING data TYPE zif_ghes221=>bodyprojects_create_for_authen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_for_authenti
      IMPORTING data TYPE zif_ghes221=>bodyrepos_create_for_authentic
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_suspend_
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_suspend_u
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_unsuspen
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_unsuspend
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS parse_meta_root
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_meta_root) TYPE zif_ghes221=>response_meta_root
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_list_gl
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_list) TYPE zif_ghes221=>response_enterprise_admin_list
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_list_pu
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_li01) TYPE zif_ghes221=>response_enterprise_admin_li01
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_sync_ld
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_sync) TYPE zif_ghes221=>response_enterprise_admin_sync
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_sync_01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_sy01) TYPE zif_ghes221=>response_enterprise_admin_sy01
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_update_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_upda) TYPE zif_ghes221=>response_enterprise_admin_upda
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_list_pr
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_li02) TYPE zif_ghes221=>response_enterprise_admin_li02
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_updat01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_up01) TYPE zif_ghes221=>response_enterprise_admin_up01
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_delete_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_dele) TYPE zif_ghes221=>response_enterprise_admin_dele
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_start_p
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_star) TYPE zif_ghes221=>response_enterprise_admin_star
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_list_01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_li03) TYPE zif_ghes221=>response_enterprise_admin_li03
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_list_pe
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_li04) TYPE zif_ghes221=>response_enterprise_admin_li04
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_updat02
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_up02) TYPE zif_ghes221=>response_enterprise_admin_up02
      RAISING cx_static_check.
    METHODS parse_apps_list_installations
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_apps_list_installatio) TYPE zif_ghes221=>response_apps_list_installatio
      RAISING cx_static_check.
    METHODS parse_codes_of_conduct_get_all
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_codes_of_conduct_get_) TYPE zif_ghes221=>response_codes_of_conduct_get_
      RAISING cx_static_check.
    METHODS parse_emojis_get
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_emojis_get) TYPE zif_ghes221=>response_emojis_get
      RAISING cx_static_check.
    METHODS parse_activity_list_public_eve
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_public_) TYPE zif_ghes221=>response_activity_list_public_
      RAISING cx_static_check.
    METHODS parse_gists_list
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list) TYPE zif_ghes221=>response_gists_list
      RAISING cx_static_check.
    METHODS parse_gists_list_public
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_public) TYPE zif_ghes221=>response_gists_list_public
      RAISING cx_static_check.
    METHODS parse_gists_list_starred
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_starred) TYPE zif_ghes221=>response_gists_list_starred
      RAISING cx_static_check.
    METHODS parse_gists_list_comments
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_comments) TYPE zif_ghes221=>response_gists_list_comments
      RAISING cx_static_check.
    METHODS parse_gists_list_commits
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_commits) TYPE zif_ghes221=>response_gists_list_commits
      RAISING cx_static_check.
    METHODS parse_gists_list_forks
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_forks) TYPE zif_ghes221=>response_gists_list_forks
      RAISING cx_static_check.
    METHODS parse_gists_check_is_starred
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_check_is_starre) TYPE zif_ghes221=>response_gists_check_is_starre
      RAISING cx_static_check.
    METHODS parse_gitignore_get_all_templa
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gitignore_get_all_tem) TYPE zif_ghes221=>response_gitignore_get_all_tem
      RAISING cx_static_check.
    METHODS parse_apps_list_repos_accessib
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_apps_list_repos_acces) TYPE zif_ghes221=>response_apps_list_repos_acces
      RAISING cx_static_check.
    METHODS parse_issues_list
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list) TYPE zif_ghes221=>response_issues_list
      RAISING cx_static_check.
    METHODS parse_licenses_get_all_commonl
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_licenses_get_all_comm) TYPE zif_ghes221=>response_licenses_get_all_comm
      RAISING cx_static_check.
    METHODS parse_activity_list_public_e01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_publi01) TYPE zif_ghes221=>response_activity_list_publi01
      RAISING cx_static_check.
    METHODS parse_activity_list_notificati
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_notific) TYPE zif_ghes221=>response_activity_list_notific
      RAISING cx_static_check.
    METHODS parse_activity_mark_notificati
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_mark_notific) TYPE zif_ghes221=>response_activity_mark_notific
      RAISING cx_static_check.
    METHODS parse_orgs_list
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list) TYPE zif_ghes221=>response_orgs_list
      RAISING cx_static_check.
    METHODS parse_activity_list_public_org
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_publi02) TYPE zif_ghes221=>response_activity_list_publi02
      RAISING cx_static_check.
    METHODS parse_orgs_list_webhooks
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_webhooks) TYPE zif_ghes221=>response_orgs_list_webhooks
      RAISING cx_static_check.
    METHODS parse_orgs_list_app_installati
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_app_install) TYPE zif_ghes221=>response_orgs_list_app_install
      RAISING cx_static_check.
    METHODS parse_issues_list_for_org
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_for_org) TYPE zif_ghes221=>response_issues_list_for_org
      RAISING cx_static_check.
    METHODS parse_orgs_list_members
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_members) TYPE zif_ghes221=>response_orgs_list_members
      RAISING cx_static_check.
    METHODS parse_orgs_list_outside_collab
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_outside_col) TYPE zif_ghes221=>response_orgs_list_outside_col
      RAISING cx_static_check.
    METHODS parse_orgs_convert_member_to_o
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_convert_member_t) TYPE zif_ghes221=>response_orgs_convert_member_t
      RAISING cx_static_check.
    METHODS parse_orgs_remove_outside_coll
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_remove_outside_c) TYPE zif_ghes221=>response_orgs_remove_outside_c
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_list_02
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_li05) TYPE zif_ghes221=>response_enterprise_admin_li05
      RAISING cx_static_check.
    METHODS parse_projects_list_for_org
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_list_for_org) TYPE zif_ghes221=>response_projects_list_for_org
      RAISING cx_static_check.
    METHODS parse_orgs_list_public_members
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_public_memb) TYPE zif_ghes221=>response_orgs_list_public_memb
      RAISING cx_static_check.
    METHODS parse_repos_list_for_org
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_for_org) TYPE zif_ghes221=>response_repos_list_for_org
      RAISING cx_static_check.
    METHODS parse_teams_list
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list) TYPE zif_ghes221=>response_teams_list
      RAISING cx_static_check.
    METHODS parse_teams_list_discussions_i
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_discussion) TYPE zif_ghes221=>response_teams_list_discussion
      RAISING cx_static_check.
    METHODS parse_teams_list_discussion_co
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_discussi01) TYPE zif_ghes221=>response_teams_list_discussi01
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_team_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_te) TYPE zif_ghes221=>response_reactions_list_for_te
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_tea01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_01) TYPE zif_ghes221=>response_reactions_list_for_01
      RAISING cx_static_check.
    METHODS parse_teams_list_members_in_or
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_members_in) TYPE zif_ghes221=>response_teams_list_members_in
      RAISING cx_static_check.
    METHODS parse_teams_list_projects_in_o
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_projects_i) TYPE zif_ghes221=>response_teams_list_projects_i
      RAISING cx_static_check.
    METHODS parse_teams_add_or_update_proj
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_add_or_update_p) TYPE zif_ghes221=>response_teams_add_or_update_p
      RAISING cx_static_check.
    METHODS parse_teams_list_repos_in_org
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_repos_in_o) TYPE zif_ghes221=>response_teams_list_repos_in_o
      RAISING cx_static_check.
    METHODS parse_teams_list_child_in_org
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_child_in_o) TYPE zif_ghes221=>response_teams_list_child_in_o
      RAISING cx_static_check.
    METHODS parse_projects_delete_card
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_delete_card) TYPE zif_ghes221=>response_projects_delete_card
      RAISING cx_static_check.
    METHODS parse_projects_move_card
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_move_card) TYPE zif_ghes221=>response_projects_move_card
      RAISING cx_static_check.
    METHODS parse_projects_move_card01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_move_card01) TYPE zif_ghes221=>response_projects_move_card01
      RAISING cx_static_check.
    METHODS parse_projects_move_card02
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_move_card02) TYPE zif_ghes221=>response_projects_move_card02
      RAISING cx_static_check.
    METHODS parse_projects_list_cards
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_list_cards) TYPE zif_ghes221=>response_projects_list_cards
      RAISING cx_static_check.
    METHODS parse_projects_create_card
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_create_card) TYPE zif_ghes221=>response_projects_create_card
      RAISING cx_static_check.
    METHODS parse_projects_move_column
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_move_column) TYPE zif_ghes221=>response_projects_move_column
      RAISING cx_static_check.
    METHODS parse_projects_update
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_update) TYPE zif_ghes221=>response_projects_update
      RAISING cx_static_check.
    METHODS parse_projects_delete
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_delete) TYPE zif_ghes221=>response_projects_delete
      RAISING cx_static_check.
    METHODS parse_projects_list_collaborat
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_list_collabo) TYPE zif_ghes221=>response_projects_list_collabo
      RAISING cx_static_check.
    METHODS parse_projects_list_columns
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_list_columns) TYPE zif_ghes221=>response_projects_list_columns
      RAISING cx_static_check.
    METHODS parse_repos_delete
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_delete) TYPE zif_ghes221=>response_repos_delete
      RAISING cx_static_check.
    METHODS parse_issues_list_assignees
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_assignees) TYPE zif_ghes221=>response_issues_list_assignees
      RAISING cx_static_check.
    METHODS parse_repos_list_branches
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_branches) TYPE zif_ghes221=>response_repos_list_branches
      RAISING cx_static_check.
    METHODS parse_repos_get_all_status_che
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_all_status_) TYPE zif_ghes221=>response_repos_get_all_status_
      RAISING cx_static_check.
    METHODS parse_repos_add_status_check_c
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_add_status_chec) TYPE zif_ghes221=>response_repos_add_status_chec
      RAISING cx_static_check.
    METHODS parse_repos_set_status_check_c
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_set_status_chec) TYPE zif_ghes221=>response_repos_set_status_chec
      RAISING cx_static_check.
    METHODS parse_repos_remove_status_chec
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_remove_status_c) TYPE zif_ghes221=>response_repos_remove_status_c
      RAISING cx_static_check.
    METHODS parse_repos_get_apps_with_acce
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_apps_with_a) TYPE zif_ghes221=>response_repos_get_apps_with_a
      RAISING cx_static_check.
    METHODS parse_repos_add_app_access_res
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_add_app_access_) TYPE zif_ghes221=>response_repos_add_app_access_
      RAISING cx_static_check.
    METHODS parse_repos_set_app_access_res
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_set_app_access_) TYPE zif_ghes221=>response_repos_set_app_access_
      RAISING cx_static_check.
    METHODS parse_repos_remove_app_access_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_remove_app_acce) TYPE zif_ghes221=>response_repos_remove_app_acce
      RAISING cx_static_check.
    METHODS parse_repos_get_teams_with_acc
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_teams_with_) TYPE zif_ghes221=>response_repos_get_teams_with_
      RAISING cx_static_check.
    METHODS parse_repos_add_team_access_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_add_team_access) TYPE zif_ghes221=>response_repos_add_team_access
      RAISING cx_static_check.
    METHODS parse_repos_set_team_access_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_set_team_access) TYPE zif_ghes221=>response_repos_set_team_access
      RAISING cx_static_check.
    METHODS parse_repos_remove_team_access
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_remove_team_acc) TYPE zif_ghes221=>response_repos_remove_team_acc
      RAISING cx_static_check.
    METHODS parse_repos_get_users_with_acc
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_users_with_) TYPE zif_ghes221=>response_repos_get_users_with_
      RAISING cx_static_check.
    METHODS parse_repos_add_user_access_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_add_user_access) TYPE zif_ghes221=>response_repos_add_user_access
      RAISING cx_static_check.
    METHODS parse_repos_set_user_access_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_set_user_access) TYPE zif_ghes221=>response_repos_set_user_access
      RAISING cx_static_check.
    METHODS parse_repos_remove_user_access
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_remove_user_acc) TYPE zif_ghes221=>response_repos_remove_user_acc
      RAISING cx_static_check.
    METHODS parse_checks_list_annotations
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_checks_list_annotatio) TYPE zif_ghes221=>response_checks_list_annotatio
      RAISING cx_static_check.
    METHODS parse_checks_list_for_suite
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_checks_list_for_suite) TYPE zif_ghes221=>response_checks_list_for_suite
      RAISING cx_static_check.
    METHODS parse_checks_rerequest_suite
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_checks_rerequest_suit) TYPE zif_ghes221=>response_checks_rerequest_suit
      RAISING cx_static_check.
    METHODS parse_repos_list_collaborators
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_collaborat) TYPE zif_ghes221=>response_repos_list_collaborat
      RAISING cx_static_check.
    METHODS parse_repos_list_commit_commen
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_commit_com) TYPE zif_ghes221=>response_repos_list_commit_com
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_commi
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_co) TYPE zif_ghes221=>response_reactions_list_for_co
      RAISING cx_static_check.
    METHODS parse_repos_list_commits
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_commits) TYPE zif_ghes221=>response_repos_list_commits
      RAISING cx_static_check.
    METHODS parse_repos_list_branches_for_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_branches_f) TYPE zif_ghes221=>response_repos_list_branches_f
      RAISING cx_static_check.
    METHODS parse_repos_list_comments_for_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_comments_f) TYPE zif_ghes221=>response_repos_list_comments_f
      RAISING cx_static_check.
    METHODS parse_repos_list_pull_requests
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_pull_reque) TYPE zif_ghes221=>response_repos_list_pull_reque
      RAISING cx_static_check.
    METHODS parse_checks_list_for_ref
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_checks_list_for_ref) TYPE zif_ghes221=>response_checks_list_for_ref
      RAISING cx_static_check.
    METHODS parse_checks_list_suites_for_r
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_checks_list_suites_fo) TYPE zif_ghes221=>response_checks_list_suites_fo
      RAISING cx_static_check.
    METHODS parse_repos_list_commit_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_commit_sta) TYPE zif_ghes221=>response_repos_list_commit_sta
      RAISING cx_static_check.
    METHODS parse_repos_list_contributors
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_contributo) TYPE zif_ghes221=>response_repos_list_contributo
      RAISING cx_static_check.
    METHODS parse_repos_list_deployments
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_deployment) TYPE zif_ghes221=>response_repos_list_deployment
      RAISING cx_static_check.
    METHODS parse_repos_create_deployment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_create_deployme) TYPE zif_ghes221=>response_repos_create_deployme
      RAISING cx_static_check.
    METHODS parse_repos_list_deployment_st
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_deployme01) TYPE zif_ghes221=>response_repos_list_deployme01
      RAISING cx_static_check.
    METHODS parse_activity_list_repo_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_repo_ev) TYPE zif_ghes221=>response_activity_list_repo_ev
      RAISING cx_static_check.
    METHODS parse_repos_list_forks
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_forks) TYPE zif_ghes221=>response_repos_list_forks
      RAISING cx_static_check.
    METHODS parse_git_list_matching_refs
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_git_list_matching_ref) TYPE zif_ghes221=>response_git_list_matching_ref
      RAISING cx_static_check.
    METHODS parse_repos_list_webhooks
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_webhooks) TYPE zif_ghes221=>response_repos_list_webhooks
      RAISING cx_static_check.
    METHODS parse_repos_list_invitations
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_invitation) TYPE zif_ghes221=>response_repos_list_invitation
      RAISING cx_static_check.
    METHODS parse_issues_list_for_repo
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_for_repo) TYPE zif_ghes221=>response_issues_list_for_repo
      RAISING cx_static_check.
    METHODS parse_issues_list_comments_for
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_comments_) TYPE zif_ghes221=>response_issues_list_comments_
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_issue
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_is) TYPE zif_ghes221=>response_reactions_list_for_is
      RAISING cx_static_check.
    METHODS parse_issues_list_events_for_r
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_events_fo) TYPE zif_ghes221=>response_issues_list_events_fo
      RAISING cx_static_check.
    METHODS parse_issues_list_comments
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_comments) TYPE zif_ghes221=>response_issues_list_comments
      RAISING cx_static_check.
    METHODS parse_issues_list_events
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_events) TYPE zif_ghes221=>response_issues_list_events
      RAISING cx_static_check.
    METHODS parse_issues_list_labels_on_is
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_labels_on) TYPE zif_ghes221=>response_issues_list_labels_on
      RAISING cx_static_check.
    METHODS parse_issues_add_labels
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_add_labels) TYPE zif_ghes221=>response_issues_add_labels
      RAISING cx_static_check.
    METHODS parse_issues_set_labels
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_set_labels) TYPE zif_ghes221=>response_issues_set_labels
      RAISING cx_static_check.
    METHODS parse_issues_remove_label
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_remove_label) TYPE zif_ghes221=>response_issues_remove_label
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_iss01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_02) TYPE zif_ghes221=>response_reactions_list_for_02
      RAISING cx_static_check.
    METHODS parse_issues_list_events_for_t
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_events_01) TYPE zif_ghes221=>response_issues_list_events_01
      RAISING cx_static_check.
    METHODS parse_repos_list_deploy_keys
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_deploy_key) TYPE zif_ghes221=>response_repos_list_deploy_key
      RAISING cx_static_check.
    METHODS parse_issues_list_labels_for_r
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_labels_fo) TYPE zif_ghes221=>response_issues_list_labels_fo
      RAISING cx_static_check.
    METHODS parse_issues_list_milestones
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_milestone) TYPE zif_ghes221=>response_issues_list_milestone
      RAISING cx_static_check.
    METHODS parse_issues_list_labels_for_m
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_labels_01) TYPE zif_ghes221=>response_issues_list_labels_01
      RAISING cx_static_check.
    METHODS parse_activity_list_repo_notif
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_repo_no) TYPE zif_ghes221=>response_activity_list_repo_no
      RAISING cx_static_check.
    METHODS parse_activity_mark_repo_notif
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_mark_repo_no) TYPE zif_ghes221=>response_activity_mark_repo_no
      RAISING cx_static_check.
    METHODS parse_repos_list_pages_builds
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_pages_buil) TYPE zif_ghes221=>response_repos_list_pages_buil
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_list_03
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_li06) TYPE zif_ghes221=>response_enterprise_admin_li06
      RAISING cx_static_check.
    METHODS parse_projects_list_for_repo
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_list_for_rep) TYPE zif_ghes221=>response_projects_list_for_rep
      RAISING cx_static_check.
    METHODS parse_pulls_list
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list) TYPE zif_ghes221=>response_pulls_list
      RAISING cx_static_check.
    METHODS parse_pulls_list_review_commen
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_review_com) TYPE zif_ghes221=>response_pulls_list_review_com
      RAISING cx_static_check.
    METHODS parse_reactions_list_for_pull_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_reactions_list_for_pu) TYPE zif_ghes221=>response_reactions_list_for_pu
      RAISING cx_static_check.
    METHODS parse_pulls_list_review_comm01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_review_c01) TYPE zif_ghes221=>response_pulls_list_review_c01
      RAISING cx_static_check.
    METHODS parse_pulls_list_commits
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_commits) TYPE zif_ghes221=>response_pulls_list_commits
      RAISING cx_static_check.
    METHODS parse_pulls_list_files
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_files) TYPE zif_ghes221=>response_pulls_list_files
      RAISING cx_static_check.
    METHODS parse_pulls_merge
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_merge) TYPE zif_ghes221=>response_pulls_merge
      RAISING cx_static_check.
    METHODS parse_pulls_merge01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_merge01) TYPE zif_ghes221=>response_pulls_merge01
      RAISING cx_static_check.
    METHODS parse_pulls_list_reviews
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_reviews) TYPE zif_ghes221=>response_pulls_list_reviews
      RAISING cx_static_check.
    METHODS parse_pulls_list_comments_for_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_list_comments_f) TYPE zif_ghes221=>response_pulls_list_comments_f
      RAISING cx_static_check.
    METHODS parse_pulls_update_branch
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_pulls_update_branch) TYPE zif_ghes221=>response_pulls_update_branch
      RAISING cx_static_check.
    METHODS parse_repos_list_releases
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_releases) TYPE zif_ghes221=>response_repos_list_releases
      RAISING cx_static_check.
    METHODS parse_repos_list_release_asset
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_release_as) TYPE zif_ghes221=>response_repos_list_release_as
      RAISING cx_static_check.
    METHODS parse_repos_get_code_frequency
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_code_freque) TYPE zif_ghes221=>response_repos_get_code_freque
      RAISING cx_static_check.
    METHODS parse_repos_get_commit_activit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_commit_acti) TYPE zif_ghes221=>response_repos_get_commit_acti
      RAISING cx_static_check.
    METHODS parse_repos_get_contributors_s
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_contributor) TYPE zif_ghes221=>response_repos_get_contributor
      RAISING cx_static_check.
    METHODS parse_repos_get_punch_card_sta
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_get_punch_card_) TYPE zif_ghes221=>response_repos_get_punch_card_
      RAISING cx_static_check.
    METHODS parse_activity_list_watchers_f
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_watcher) TYPE zif_ghes221=>response_activity_list_watcher
      RAISING cx_static_check.
    METHODS parse_repos_list_tags
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_tags) TYPE zif_ghes221=>response_repos_list_tags
      RAISING cx_static_check.
    METHODS parse_repos_list_teams
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_teams) TYPE zif_ghes221=>response_repos_list_teams
      RAISING cx_static_check.
    METHODS parse_repos_list_public
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_public) TYPE zif_ghes221=>response_repos_list_public
      RAISING cx_static_check.
    METHODS parse_search_code
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_code) TYPE zif_ghes221=>response_search_code
      RAISING cx_static_check.
    METHODS parse_search_commits
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_commits) TYPE zif_ghes221=>response_search_commits
      RAISING cx_static_check.
    METHODS parse_search_issues_and_pull_r
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_issues_and_pul) TYPE zif_ghes221=>response_search_issues_and_pul
      RAISING cx_static_check.
    METHODS parse_search_labels
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_labels) TYPE zif_ghes221=>response_search_labels
      RAISING cx_static_check.
    METHODS parse_search_repos
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_repos) TYPE zif_ghes221=>response_search_repos
      RAISING cx_static_check.
    METHODS parse_search_topics
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_topics) TYPE zif_ghes221=>response_search_topics
      RAISING cx_static_check.
    METHODS parse_search_users
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_search_users) TYPE zif_ghes221=>response_search_users
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_get_all
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_get_) TYPE zif_ghes221=>response_enterprise_admin_get_
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_add_aut
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_add_) TYPE zif_ghes221=>response_enterprise_admin_add_
      RAISING cx_static_check.
    METHODS parse_enterprise_admin_remove_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_enterprise_admin_remo) TYPE zif_ghes221=>response_enterprise_admin_remo
      RAISING cx_static_check.
    METHODS parse_users_list_emails_for_au
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_emails_for) TYPE zif_ghes221=>response_users_list_emails_for
      RAISING cx_static_check.
    METHODS parse_users_add_email_for_auth
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_add_email_for_a) TYPE zif_ghes221=>response_users_add_email_for_a
      RAISING cx_static_check.
    METHODS parse_users_list_followers_for
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_followers_) TYPE zif_ghes221=>response_users_list_followers_
      RAISING cx_static_check.
    METHODS parse_users_list_followed_by_a
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_followed_b) TYPE zif_ghes221=>response_users_list_followed_b
      RAISING cx_static_check.
    METHODS parse_users_list_gpg_keys_for_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_gpg_keys_f) TYPE zif_ghes221=>response_users_list_gpg_keys_f
      RAISING cx_static_check.
    METHODS parse_apps_list_installations_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_apps_list_installat01) TYPE zif_ghes221=>response_apps_list_installat01
      RAISING cx_static_check.
    METHODS parse_apps_list_installation_r
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_apps_list_installat02) TYPE zif_ghes221=>response_apps_list_installat02
      RAISING cx_static_check.
    METHODS parse_issues_list_for_authenti
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_issues_list_for_authe) TYPE zif_ghes221=>response_issues_list_for_authe
      RAISING cx_static_check.
    METHODS parse_users_list_public_ssh_ke
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_public_ssh) TYPE zif_ghes221=>response_users_list_public_ssh
      RAISING cx_static_check.
    METHODS parse_orgs_list_memberships_fo
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_memberships) TYPE zif_ghes221=>response_orgs_list_memberships
      RAISING cx_static_check.
    METHODS parse_orgs_list_for_authentica
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_for_authent) TYPE zif_ghes221=>response_orgs_list_for_authent
      RAISING cx_static_check.
    METHODS parse_users_list_public_emails
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_public_ema) TYPE zif_ghes221=>response_users_list_public_ema
      RAISING cx_static_check.
    METHODS parse_repos_list_for_authentic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_for_authen) TYPE zif_ghes221=>response_repos_list_for_authen
      RAISING cx_static_check.
    METHODS parse_repos_list_invitations_f
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_invitati01) TYPE zif_ghes221=>response_repos_list_invitati01
      RAISING cx_static_check.
    METHODS parse_activity_list_repos_star
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_repos_s) TYPE zif_ghes221=>response_activity_list_repos_s
      RAISING cx_static_check.
    METHODS parse_activity_list_watched_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_watched) TYPE zif_ghes221=>response_activity_list_watched
      RAISING cx_static_check.
    METHODS parse_teams_list_for_authentic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_teams_list_for_authen) TYPE zif_ghes221=>response_teams_list_for_authen
      RAISING cx_static_check.
    METHODS parse_users_list
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list) TYPE zif_ghes221=>response_users_list
      RAISING cx_static_check.
    METHODS parse_activity_list_events_for
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_events_) TYPE zif_ghes221=>response_activity_list_events_
      RAISING cx_static_check.
    METHODS parse_activity_list_org_events
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_org_eve) TYPE zif_ghes221=>response_activity_list_org_eve
      RAISING cx_static_check.
    METHODS parse_activity_list_public_e02
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_publi03) TYPE zif_ghes221=>response_activity_list_publi03
      RAISING cx_static_check.
    METHODS parse_users_list_followers_f01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_follower01) TYPE zif_ghes221=>response_users_list_follower01
      RAISING cx_static_check.
    METHODS parse_users_list_following_for
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_following_) TYPE zif_ghes221=>response_users_list_following_
      RAISING cx_static_check.
    METHODS parse_gists_list_for_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_gists_list_for_user) TYPE zif_ghes221=>response_gists_list_for_user
      RAISING cx_static_check.
    METHODS parse_users_list_gpg_keys_fo01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_gpg_keys01) TYPE zif_ghes221=>response_users_list_gpg_keys01
      RAISING cx_static_check.
    METHODS parse_users_list_public_keys_f
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_users_list_public_key) TYPE zif_ghes221=>response_users_list_public_key
      RAISING cx_static_check.
    METHODS parse_orgs_list_for_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_orgs_list_for_user) TYPE zif_ghes221=>response_orgs_list_for_user
      RAISING cx_static_check.
    METHODS parse_projects_list_for_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_projects_list_for_use) TYPE zif_ghes221=>response_projects_list_for_use
      RAISING cx_static_check.
    METHODS parse_activity_list_received_e
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_receive) TYPE zif_ghes221=>response_activity_list_receive
      RAISING cx_static_check.
    METHODS parse_activity_list_received_p
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_recei01) TYPE zif_ghes221=>response_activity_list_recei01
      RAISING cx_static_check.
    METHODS parse_repos_list_for_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_repos_list_for_user) TYPE zif_ghes221=>response_repos_list_for_user
      RAISING cx_static_check.
    METHODS parse_activity_list_repos_watc
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_activity_list_repos_w) TYPE zif_ghes221=>response_activity_list_repos_w
      RAISING cx_static_check.
ENDCLASS.
...
* todo, handle type string
  ...
  METHOD parse_team_repository.
    ...
    team_repository-license = parse_nullable_license_simple( iv_prefix ).
...
* todo, array, topics
    ...
    team_repository-template_repository = parse_nullable_repository( iv_prefix ).
...
* todo, array, contexts
  ...
  METHOD parse_enterprise_admin_list_gl.
    ...
    DATA global_hook TYPE zif_ghes221=>global_hook.
  ...
  METHOD parse_enterprise_admin_list_pu.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA public_key_full TYPE zif_ghes221=>public_key_full.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_enterprise_admin_list_pr.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA pre_receive_environment TYPE zif_ghes221=>pre_receive_environment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
...
* todo, array, errors
  ...
  METHOD parse_enterprise_admin_list_01.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA pre_receive_hook TYPE zif_ghes221=>pre_receive_hook.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_enterprise_admin_list_pe.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA authorization TYPE zif_ghes221=>authorization.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR authorization.
  ...
  METHOD parse_apps_list_installations.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA installation_ghes_2 TYPE zif_ghes221=>installation_ghes_2.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_codes_of_conduct_get_all.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA code_of_conduct TYPE zif_ghes221=>code_of_conduct.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_activity_list_public_eve.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA event TYPE zif_ghes221=>event.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR event.
  ...
  METHOD parse_gists_list.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA base_gist TYPE zif_ghes221=>base_gist.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR base_gist.
  ...
  METHOD parse_gists_list_comments.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA gist_comment TYPE zif_ghes221=>gist_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR gist_comment.
  ...
  METHOD parse_gists_list_commits.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA gist_commit TYPE zif_ghes221=>gist_commit.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR gist_commit.
  ...
  METHOD parse_gists_list_forks.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA gist_simple TYPE zif_ghes221=>gist_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR gist_simple.
...
* todo, array, repositories
  ...
  METHOD parse_issues_list.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA issue TYPE zif_ghes221=>issue.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR issue.
  ...
  METHOD parse_licenses_get_all_commonl.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA license_simple TYPE zif_ghes221=>license_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_activity_list_notificati.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA thread TYPE zif_ghes221=>thread.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR thread.
  ...
  METHOD parse_orgs_list.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA organization_simple TYPE zif_ghes221=>organization_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_orgs_list_webhooks.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA org_hook TYPE zif_ghes221=>org_hook.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR org_hook.
...
* todo, array, installations
  ...
  METHOD parse_orgs_list_members.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA simple_user TYPE zif_ghes221=>simple_user.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR simple_user.
  ...
  METHOD parse_enterprise_admin_list_02.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA org_pre_receive_hook TYPE zif_ghes221=>org_pre_receive_hook.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_projects_list_for_org.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA project TYPE zif_ghes221=>project.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR project.
  ...
  METHOD parse_repos_list_for_org.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA minimal_repository TYPE zif_ghes221=>minimal_repository.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_teams_list.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA team TYPE zif_ghes221=>team.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR team.
  ...
  METHOD parse_teams_list_discussions_i.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA team_discussion TYPE zif_ghes221=>team_discussion.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_teams_list_discussion_co.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA team_discussion_comment TYPE zif_ghes221=>team_discussion_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_reactions_list_for_team_.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA reaction TYPE zif_ghes221=>reaction.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR reaction.
  ...
  METHOD parse_teams_list_projects_in_o.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA team_project TYPE zif_ghes221=>team_project.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR team_project.
...
* todo, array, errors
  ...
  METHOD parse_projects_list_cards.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA project_card TYPE zif_ghes221=>project_card.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR project_card.
...
* todo, array, errors
  ...
  METHOD parse_projects_list_columns.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA project_column TYPE zif_ghes221=>project_column.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_list_branches.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA short_branch TYPE zif_ghes221=>short_branch.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR short_branch.
...
* todo, handle type array, no item_ref
  ...
  METHOD parse_repos_get_apps_with_acce.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA integration TYPE zif_ghes221=>integration.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR integration.
  ...
  METHOD parse_checks_list_annotations.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA check_annotation TYPE zif_ghes221=>check_annotation.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
...
* todo, array, check_runs
  ...
  METHOD parse_repos_list_collaborators.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA collaborator TYPE zif_ghes221=>collaborator.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR collaborator.
  ...
  METHOD parse_repos_list_commit_commen.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA commit_comment TYPE zif_ghes221=>commit_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_list_commits.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA commit TYPE zif_ghes221=>commit.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR commit.
  ...
  METHOD parse_repos_list_branches_for_.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA branch_short TYPE zif_ghes221=>branch_short.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR branch_short.
  ...
  METHOD parse_repos_list_pull_requests.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA pull_request_simple TYPE zif_ghes221=>pull_request_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
...
* todo, array, check_suites
  ...
  METHOD parse_repos_list_commit_status.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA status TYPE zif_ghes221=>status.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR status.
  ...
  METHOD parse_repos_list_contributors.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA contributor TYPE zif_ghes221=>contributor.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR contributor.
  ...
  METHOD parse_repos_list_deployments.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA deployment TYPE zif_ghes221=>deployment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR deployment.
  ...
  METHOD parse_repos_list_deployment_st.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA deployment_status TYPE zif_ghes221=>deployment_status.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_git_list_matching_refs.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA git_ref TYPE zif_ghes221=>git_ref.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR git_ref.
  ...
  METHOD parse_repos_list_webhooks.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA hook TYPE zif_ghes221=>hook.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR hook.
  ...
  METHOD parse_repos_list_invitations.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA repository_invitation TYPE zif_ghes221=>repository_invitation.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_issues_list_for_repo.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA issue_simple TYPE zif_ghes221=>issue_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR issue_simple.
  ...
  METHOD parse_issues_list_comments_for.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA issue_comment TYPE zif_ghes221=>issue_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR issue_comment.
  ...
  METHOD parse_issues_list_events_for_r.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA issue_event TYPE zif_ghes221=>issue_event.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR issue_event.
  ...
  METHOD parse_issues_list_events.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA issue_event_for_issue TYPE zif_ghes221=>issue_event_for_issue.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_issues_list_labels_on_is.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA label TYPE zif_ghes221=>label.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR label.
  ...
  METHOD parse_issues_list_events_for_t.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA timeline_issue_events TYPE zif_ghes221=>timeline_issue_events.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_list_deploy_keys.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA deploy_key TYPE zif_ghes221=>deploy_key.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR deploy_key.
  ...
  METHOD parse_issues_list_milestones.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA milestone TYPE zif_ghes221=>milestone.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR milestone.
  ...
  METHOD parse_repos_list_pages_builds.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA page_build TYPE zif_ghes221=>page_build.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR page_build.
  ...
  METHOD parse_enterprise_admin_list_03.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA repository_pre_receive_hook TYPE zif_ghes221=>repository_pre_receive_hook.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_pulls_list_review_commen.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA pull_request_review_comment TYPE zif_ghes221=>pull_request_review_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_pulls_list_files.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA diff_entry TYPE zif_ghes221=>diff_entry.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR diff_entry.
  ...
  METHOD parse_pulls_list_reviews.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA pull_request_review TYPE zif_ghes221=>pull_request_review.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_pulls_list_comments_for_.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA review_comment TYPE zif_ghes221=>review_comment.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_list_releases.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA release TYPE zif_ghes221=>release.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR release.
  ...
  METHOD parse_repos_list_release_asset.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA release_asset TYPE zif_ghes221=>release_asset.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR release_asset.
  ...
  METHOD parse_repos_get_code_frequency.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA code_frequency_stat TYPE zif_ghes221=>code_frequency_stat.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_get_commit_activit.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA commit_activity TYPE zif_ghes221=>commit_activity.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_get_contributors_s.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA contributor_activity TYPE zif_ghes221=>contributor_activity.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
...
* todo, array, items
  ...
  METHOD parse_enterprise_admin_get_all.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA ssh_key TYPE zif_ghes221=>ssh_key.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR ssh_key.
  ...
  METHOD parse_users_list_emails_for_au.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA email TYPE zif_ghes221=>email.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR email.
  ...
  METHOD parse_users_list_gpg_keys_for_.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA gpg_key TYPE zif_ghes221=>gpg_key.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR gpg_key.
...
* todo, array, repositories
  ...
  METHOD parse_orgs_list_memberships_fo.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA org_membership TYPE zif_ghes221=>org_membership.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
  ...
  METHOD parse_repos_list_for_authentic.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA repository TYPE zif_ghes221=>repository.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR repository.
  ...
  METHOD parse_teams_list_for_authentic.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA team_full TYPE zif_ghes221=>team_full.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR team_full.
  ...
  METHOD parse_users_list_public_keys_f.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA key_simple TYPE zif_ghes221=>key_simple.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR key_simple.
...
* todo, handle more responses
  ...
  METHOD zif_ghes221~enterprise_admin_get_all_stats.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes221~enterprise_admin_get_comment_s.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes221~enterprise_admin_get_all_sta01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes221~enterprise_admin_get_hooks_sta.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes221~enterprise_admin_get_issue_sta.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes221~enterprise_admin_get_milestone.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes221~enterprise_admin_get_org_stats.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes221~enterprise_admin_get_pages_sta.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes221~enterprise_admin_get_pull_requ.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes221~enterprise_admin_get_repo_stat.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_ghes221~enterprise_admin_get_user_stat.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, handle more responses
  ...
  METHOD zif_ghes221~teams_list_discussions_in_org.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/teams/{team_slug}/discussions'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
    REPLACE ALL OCCURRENCES OF '{team_slug}' IN lv_uri WITH team_slug.
  ...
  METHOD zif_ghes221~teams_get_discussion_in_org.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
    REPLACE ALL OCCURRENCES OF '{team_slug}' IN lv_uri WITH team_slug.
...
* todo, handle more responses
  ...
  METHOD zif_ghes221~teams_list_discussion_comments.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
    REPLACE ALL OCCURRENCES OF '{team_slug}' IN lv_uri WITH team_slug.
    lv_temp = discussion_number.
    CONDENSE lv_temp.
  ...
  METHOD zif_ghes221~teams_get_discussion_comment_i.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments/{comment_number}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
    REPLACE ALL OCCURRENCES OF '{team_slug}' IN lv_uri WITH team_slug.
    lv_temp = discussion_number.
    CONDENSE lv_temp.
...
* todo, handle more responses
  ...
  METHOD zif_ghes221~reactions_list_for_team_discus.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments/{comment_number}/reactions'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
    REPLACE ALL OCCURRENCES OF '{team_slug}' IN lv_uri WITH team_slug.
    lv_temp = discussion_number.
    CONDENSE lv_temp.
  ...
  METHOD zif_ghes221~reactions_delete_for_team_disc.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments/{comment_number}/reactions/{reaction_id}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
    REPLACE ALL OCCURRENCES OF '{team_slug}' IN lv_uri WITH team_slug.
    lv_temp = discussion_number.
    CONDENSE lv_temp.
...
* todo, handle more responses
  ...
  METHOD zif_ghes221~reactions_list_for_team_disc01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/reactions'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
    REPLACE ALL OCCURRENCES OF '{team_slug}' IN lv_uri WITH team_slug.
    lv_temp = discussion_number.
    CONDENSE lv_temp.
  ...
  METHOD zif_ghes221~reactions_delete_for_team_di01.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/reactions/{reaction_id}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
    REPLACE ALL OCCURRENCES OF '{team_slug}' IN lv_uri WITH team_slug.
    lv_temp = discussion_number.
    CONDENSE lv_temp.
...
* todo, handle more responses
  ...
  METHOD zif_ghes221~teams_list_members_in_org.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/teams/{team_slug}/members'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
    REPLACE ALL OCCURRENCES OF '{team_slug}' IN lv_uri WITH team_slug.
    IF role IS SUPPLIED.
      mi_client->request->set_form_field( name = 'role' value = role ).
  ...
  METHOD zif_ghes221~teams_get_membership_for_user_.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/teams/{team_slug}/memberships/{username}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
    REPLACE ALL OCCURRENCES OF '{team_slug}' IN lv_uri WITH team_slug.
    REPLACE ALL OCCURRENCES OF '{username}' IN lv_uri WITH username.
    mi_client->request->set_method( 'GET' ).
...
* todo, handle more responses
  ...
  METHOD zif_ghes221~teams_list_projects_in_org.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/teams/{team_slug}/projects'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
    REPLACE ALL OCCURRENCES OF '{team_slug}' IN lv_uri WITH team_slug.
    lv_temp = per_page.
    CONDENSE lv_temp.
  ...
  METHOD zif_ghes221~teams_check_permissions_for_pr.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/teams/{team_slug}/projects/{project_id}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
    REPLACE ALL OCCURRENCES OF '{team_slug}' IN lv_uri WITH team_slug.
    lv_temp = project_id.
    CONDENSE lv_temp.
...
* todo, handle more responses
  ...
  METHOD zif_ghes221~teams_list_repos_in_org.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/teams/{team_slug}/repos'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
    REPLACE ALL OCCURRENCES OF '{team_slug}' IN lv_uri WITH team_slug.
    lv_temp = per_page.
    CONDENSE lv_temp.
  ...
  METHOD zif_ghes221~teams_check_permissions_for_re.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/teams/{team_slug}/repos/{owner}/{repo}'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
    REPLACE ALL OCCURRENCES OF '{team_slug}' IN lv_uri WITH team_slug.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
    REPLACE ALL OCCURRENCES OF '{repo}' IN lv_uri WITH repo.
...
* todo, handle more responses
  ...
  METHOD zif_ghes221~teams_list_child_in_org.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/orgs/{org}/teams/{team_slug}/teams'.
    REPLACE ALL OCCURRENCES OF '{org}' IN lv_uri WITH org.
    REPLACE ALL OCCURRENCES OF '{team_slug}' IN lv_uri WITH team_slug.
    lv_temp = per_page.
    CONDENSE lv_temp.
...
* todo, handle more responses
  ...
  METHOD zif_ghes221~reactions_delete_for_commit_co.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/comments/{comment_id}/reactions/{reaction_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
    REPLACE ALL OCCURRENCES OF '{repo}' IN lv_uri WITH repo.
    lv_temp = comment_id.
    CONDENSE lv_temp.
...
* todo, handle more responses
  ...
  METHOD zif_ghes221~repos_create_dispatch_event.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/dispatches'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
    REPLACE ALL OCCURRENCES OF '{repo}' IN lv_uri WITH repo.
    mi_client->request->set_method( 'POST' ).
    mi_client->request->set_header_field( name = '~request_uri' value = lv_uri ).
...
* todo, handle more responses
  ...
  METHOD zif_ghes221~reactions_delete_for_issue_com.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/issues/comments/{comment_id}/reactions/{reaction_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
    REPLACE ALL OCCURRENCES OF '{repo}' IN lv_uri WITH repo.
    lv_temp = comment_id.
    CONDENSE lv_temp.
...
* todo, handle more responses
  ...
  METHOD zif_ghes221~reactions_delete_for_issue.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/issues/{issue_number}/reactions/{reaction_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
    REPLACE ALL OCCURRENCES OF '{repo}' IN lv_uri WITH repo.
    lv_temp = issue_number.
    CONDENSE lv_temp.
...
* todo, handle more responses
  ...
  METHOD zif_ghes221~reactions_delete_for_pull_requ.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '{protocol}://{hostname}/api/v3/repos/{owner}/{repo}/pulls/comments/{comment_id}/reactions/{reaction_id}'.
    REPLACE ALL OCCURRENCES OF '{owner}' IN lv_uri WITH owner.
    REPLACE ALL OCCURRENCES OF '{repo}' IN lv_uri WITH repo.
    lv_temp = comment_id.
    CONDENSE lv_temp.
...
* todo, handle more responses
  ...
  METHOD zif_ghes221~repos_get_readme_in_directory.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
