...
* GitHub v3 REST API
  ...
  PROTECTED SECTION.
    ...
    METHODS json_enterprise_admin_enable_o
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_enable_or
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_set_sett
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_set_setti
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_add_auth
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_add_autho
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_remove_a
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_remove_au
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_e
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_create_en
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_upgrade_
      IMPORTING data TYPE zif_ghes221=>bodyenterprise_admin_upgrade_l
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
...
* todo, array, topics
    ...
    team_repository-template_repository-anonymous_access_enabled = mo_json->value_boolean( iv_prefix && '/template_repository/anonymous_access_enabled' ).
