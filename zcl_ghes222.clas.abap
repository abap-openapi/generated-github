...
* GitHub v3 REST API
  ...
  PROTECTED SECTION.
    ...
    METHODS parse_global_hook
      ...
      RETURNING VALUE(global_hook) TYPE zif_ghes222=>global_hook
      RAISING cx_static_check.
    METHODS parse_global_hook_2
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(global_hook_2) TYPE zif_ghes222=>global_hook_2
      RAISING cx_static_check.
    METHODS parse_enterprise_public_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_public_key) TYPE zif_ghes222=>enterprise_public_key
      RAISING cx_static_check.
    METHODS parse_ldap_mapping_team
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(ldap_mapping_team) TYPE zif_ghes222=>ldap_mapping_team
      RAISING cx_static_check.
    METHODS parse_ldap_mapping_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(ldap_mapping_user) TYPE zif_ghes222=>ldap_mapping_user
      RAISING cx_static_check.
    METHODS parse_organization_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(organization_simple) TYPE zif_ghes222=>organization_simple
      RAISING cx_static_check.
    METHODS parse_pre_receive_environment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pre_receive_environment) TYPE zif_ghes222=>pre_receive_environment
      RAISING cx_static_check.
    METHODS parse_pre_receive_environment_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pre_receive_environment_downlo) TYPE zif_ghes222=>pre_receive_environment_downlo
      RAISING cx_static_check.
    METHODS parse_pre_receive_hook
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pre_receive_hook) TYPE zif_ghes222=>pre_receive_hook
      RAISING cx_static_check.
    METHODS parse_simple_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(simple_user) TYPE zif_ghes222=>simple_user
      RAISING cx_static_check.
    METHODS parse_app_permissions
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(app_permissions) TYPE zif_ghes222=>app_permissions
      RAISING cx_static_check.
    METHODS parse_scoped_installation
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(scoped_installation) TYPE zif_ghes222=>scoped_installation
      RAISING cx_static_check.
    METHODS parse_authorization
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(authorization) TYPE zif_ghes222=>authorization
      RAISING cx_static_check.
    METHODS parse_integration
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(integration) TYPE zif_ghes222=>integration
      RAISING cx_static_check.
    METHODS parse_basic_error
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(basic_error) TYPE zif_ghes222=>basic_error
      RAISING cx_static_check.
    METHODS parse_validation_error_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(validation_error_simple) TYPE zif_ghes222=>validation_error_simple
      RAISING cx_static_check.
    METHODS parse_enterprise
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise) TYPE zif_ghes222=>enterprise
      RAISING cx_static_check.
    METHODS parse_installation_ghes_2
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(installation_ghes_2) TYPE zif_ghes222=>installation_ghes_2
      RAISING cx_static_check.
    METHODS parse_license_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(license_simple) TYPE zif_ghes222=>license_simple
      RAISING cx_static_check.
    METHODS parse_repository
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repository) TYPE zif_ghes222=>repository
      RAISING cx_static_check.
    METHODS parse_installation_token
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(installation_token) TYPE zif_ghes222=>installation_token
      RAISING cx_static_check.
    METHODS parse_validation_error
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(validation_error) TYPE zif_ghes222=>validation_error
      RAISING cx_static_check.
    METHODS parse_application_grant
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(application_grant) TYPE zif_ghes222=>application_grant
      RAISING cx_static_check.
    ...
    METHODS parse_enterprise_overview
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_overview) TYPE zif_ghes222=>enterprise_overview
      RAISING cx_static_check.
    METHODS parse_runner_groups_enterprise
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(runner_groups_enterprise) TYPE zif_ghes222=>runner_groups_enterprise
      RAISING cx_static_check.
    METHODS parse_runner_no_labels
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(runner_no_labels) TYPE zif_ghes222=>runner_no_labels
      RAISING cx_static_check.
    METHODS parse_runner_application
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(runner_application) TYPE zif_ghes222=>runner_application
      RAISING cx_static_check.
    METHODS parse_authentication_token
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(authentication_token) TYPE zif_ghes222=>authentication_token
      RAISING cx_static_check.
    METHODS parse_actor
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(actor) TYPE zif_ghes222=>actor
      RAISING cx_static_check.
    METHODS parse_label
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(label) TYPE zif_ghes222=>label
      RAISING cx_static_check.
    METHODS parse_milestone
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(milestone) TYPE zif_ghes222=>milestone
      RAISING cx_static_check.
    METHODS parse_author_association
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(author_association) TYPE zif_ghes222=>author_association
      RAISING cx_static_check.
    METHODS parse_issue_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_simple) TYPE zif_ghes222=>issue_simple
      RAISING cx_static_check.
    METHODS parse_reaction_rollup
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(reaction_rollup) TYPE zif_ghes222=>reaction_rollup
      RAISING cx_static_check.
    METHODS parse_issue_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_comment) TYPE zif_ghes222=>issue_comment
      RAISING cx_static_check.
    METHODS parse_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(event) TYPE zif_ghes222=>event
      RAISING cx_static_check.
    METHODS parse_link_with_type
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(link_with_type) TYPE zif_ghes222=>link_with_type
      RAISING cx_static_check.
    METHODS parse_feed
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(feed) TYPE zif_ghes222=>feed
      RAISING cx_static_check.
    METHODS parse_base_gist
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(base_gist) TYPE zif_ghes222=>base_gist
      RAISING cx_static_check.
    METHODS parse_gist_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gist_simple) TYPE zif_ghes222=>gist_simple
      RAISING cx_static_check.
    METHODS parse_gist_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gist_comment) TYPE zif_ghes222=>gist_comment
      RAISING cx_static_check.
    METHODS parse_gist_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gist_commit) TYPE zif_ghes222=>gist_commit
      RAISING cx_static_check.
    METHODS parse_gitignore_template
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gitignore_template) TYPE zif_ghes222=>gitignore_template
      RAISING cx_static_check.
    METHODS parse_issue
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue) TYPE zif_ghes222=>issue
      RAISING cx_static_check.
    METHODS parse_license
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(license) TYPE zif_ghes222=>license
      RAISING cx_static_check.
    METHODS parse_api_overview
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(api_overview) TYPE zif_ghes222=>api_overview
      RAISING cx_static_check.
    METHODS parse_minimal_repository
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(minimal_repository) TYPE zif_ghes222=>minimal_repository
      RAISING cx_static_check.
    METHODS parse_thread
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(thread) TYPE zif_ghes222=>thread
      RAISING cx_static_check.
    METHODS parse_thread_subscription
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(thread_subscription) TYPE zif_ghes222=>thread_subscription
      RAISING cx_static_check.
    METHODS parse_organization_full
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(organization_full) TYPE zif_ghes222=>organization_full
      RAISING cx_static_check.
    METHODS parse_runner_groups_org
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(runner_groups_org) TYPE zif_ghes222=>runner_groups_org
      RAISING cx_static_check.
    METHODS parse_organization_actions_sec
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(organization_actions_secret) TYPE zif_ghes222=>organization_actions_secret
      RAISING cx_static_check.
    METHODS parse_actions_public_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(actions_public_key) TYPE zif_ghes222=>actions_public_key
      RAISING cx_static_check.
    METHODS parse_org_hook
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(org_hook) TYPE zif_ghes222=>org_hook
      RAISING cx_static_check.
    METHODS parse_webhook_config_url
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(webhook_config_url) TYPE zif_ghes222=>webhook_config_url
      RAISING cx_static_check.
    METHODS parse_webhook_config_content_t
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(webhook_config_content_type) TYPE zif_ghes222=>webhook_config_content_type
      RAISING cx_static_check.
    METHODS parse_webhook_config_secret
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(webhook_config_secret) TYPE zif_ghes222=>webhook_config_secret
      RAISING cx_static_check.
    METHODS parse_webhook_config_insecure_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(webhook_config_insecure_ssl) TYPE zif_ghes222=>webhook_config_insecure_ssl
      RAISING cx_static_check.
    METHODS parse_org_membership
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(org_membership) TYPE zif_ghes222=>org_membership
      RAISING cx_static_check.
    METHODS parse_org_pre_receive_hook
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(org_pre_receive_hook) TYPE zif_ghes222=>org_pre_receive_hook
      RAISING cx_static_check.
    METHODS parse_project
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(project) TYPE zif_ghes222=>project
      RAISING cx_static_check.
    METHODS parse_team_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_simple) TYPE zif_ghes222=>team_simple
      RAISING cx_static_check.
    METHODS parse_team
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team) TYPE zif_ghes222=>team
      RAISING cx_static_check.
    METHODS parse_team_full
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_full) TYPE zif_ghes222=>team_full
      RAISING cx_static_check.
    METHODS parse_team_discussion
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_discussion) TYPE zif_ghes222=>team_discussion
      RAISING cx_static_check.
    METHODS parse_team_discussion_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_discussion_comment) TYPE zif_ghes222=>team_discussion_comment
      RAISING cx_static_check.
    METHODS parse_reaction
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(reaction) TYPE zif_ghes222=>reaction
      RAISING cx_static_check.
    METHODS parse_team_membership
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_membership) TYPE zif_ghes222=>team_membership
      RAISING cx_static_check.
    METHODS parse_team_project
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_project) TYPE zif_ghes222=>team_project
      RAISING cx_static_check.
    METHODS parse_team_repository
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(team_repository) TYPE zif_ghes222=>team_repository
      RAISING cx_static_check.
    METHODS parse_project_card
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(project_card) TYPE zif_ghes222=>project_card
      RAISING cx_static_check.
    METHODS parse_project_column
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(project_column) TYPE zif_ghes222=>project_column
      RAISING cx_static_check.
    METHODS parse_repository_collaborator_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repository_collaborator_permis) TYPE zif_ghes222=>repository_collaborator_permis
      RAISING cx_static_check.
    METHODS parse_rate_limit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(rate_limit) TYPE zif_ghes222=>rate_limit
      RAISING cx_static_check.
    METHODS parse_rate_limit_overview
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(rate_limit_overview) TYPE zif_ghes222=>rate_limit_overview
      RAISING cx_static_check.
    METHODS parse_full_repository
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(full_repository) TYPE zif_ghes222=>full_repository
      RAISING cx_static_check.
    METHODS parse_artifact
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(artifact) TYPE zif_ghes222=>artifact
      RAISING cx_static_check.
    METHODS parse_job
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(job) TYPE zif_ghes222=>job
      RAISING cx_static_check.
    METHODS parse_pull_request_minimal
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_minimal) TYPE zif_ghes222=>pull_request_minimal
      RAISING cx_static_check.
    METHODS parse_simple_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(simple_commit) TYPE zif_ghes222=>simple_commit
      RAISING cx_static_check.
    METHODS parse_workflow_run
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(workflow_run) TYPE zif_ghes222=>workflow_run
      RAISING cx_static_check.
    METHODS parse_actions_secret
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(actions_secret) TYPE zif_ghes222=>actions_secret
      RAISING cx_static_check.
    METHODS parse_workflow
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(workflow) TYPE zif_ghes222=>workflow
      RAISING cx_static_check.
    METHODS parse_protected_branch_admin_e
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(protected_branch_admin_enforce) TYPE zif_ghes222=>protected_branch_admin_enforce
      RAISING cx_static_check.
    METHODS parse_protected_branch_pull_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(protected_branch_pull_request_) TYPE zif_ghes222=>protected_branch_pull_request_
      RAISING cx_static_check.
    METHODS parse_branch_restriction_polic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(branch_restriction_policy) TYPE zif_ghes222=>branch_restriction_policy
      RAISING cx_static_check.
    METHODS parse_branch_protection
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(branch_protection) TYPE zif_ghes222=>branch_protection
      RAISING cx_static_check.
    METHODS parse_short_branch
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(short_branch) TYPE zif_ghes222=>short_branch
      RAISING cx_static_check.
    METHODS parse_git_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_user) TYPE zif_ghes222=>git_user
      RAISING cx_static_check.
    METHODS parse_verification
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(verification) TYPE zif_ghes222=>verification
      RAISING cx_static_check.
    METHODS parse_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(commit) TYPE zif_ghes222=>commit
      RAISING cx_static_check.
    METHODS parse_branch_with_protection
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(branch_with_protection) TYPE zif_ghes222=>branch_with_protection
      RAISING cx_static_check.
    METHODS parse_status_check_policy
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(status_check_policy) TYPE zif_ghes222=>status_check_policy
      RAISING cx_static_check.
    ...
    METHODS parse_check_annotation
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(check_annotation) TYPE zif_ghes222=>check_annotation
      RAISING cx_static_check.
    METHODS parse_check_suite
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(check_suite) TYPE zif_ghes222=>check_suite
      RAISING cx_static_check.
    METHODS parse_check_suite_preference
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(check_suite_preference) TYPE zif_ghes222=>check_suite_preference
      RAISING cx_static_check.
    METHODS parse_code_scanning_alert_stat
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_alert_state) TYPE zif_ghes222=>code_scanning_alert_state
      RAISING cx_static_check.
    METHODS parse_code_scanning_alert_ref
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_alert_ref) TYPE zif_ghes222=>code_scanning_alert_ref
      RAISING cx_static_check.
    METHODS parse_alert_number
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(alert_number) TYPE zif_ghes222=>alert_number
      RAISING cx_static_check.
    METHODS parse_alert_created_at
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(alert_created_at) TYPE zif_ghes222=>alert_created_at
      RAISING cx_static_check.
    METHODS parse_alert_url
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(alert_url) TYPE zif_ghes222=>alert_url
      RAISING cx_static_check.
    ...
    METHODS parse_code_scanning_alert_dism
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_alert_dismissed_) TYPE zif_ghes222=>code_scanning_alert_dismissed_
      RAISING cx_static_check.
    METHODS parse_code_scanning_alert_di01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_alert_dismisse01) TYPE zif_ghes222=>code_scanning_alert_dismisse01
      RAISING cx_static_check.
    METHODS parse_code_scanning_alert_rule
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_alert_rule) TYPE zif_ghes222=>code_scanning_alert_rule
      RAISING cx_static_check.
    METHODS parse_code_scanning_analysis_t
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_analysis_tool_na) TYPE zif_ghes222=>code_scanning_analysis_tool_na
      RAISING cx_static_check.
    METHODS parse_code_scanning_analysis01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_analysis_tool) TYPE zif_ghes222=>code_scanning_analysis_tool
      RAISING cx_static_check.
    METHODS parse_code_scanning_alert_code
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_alert_code_scann) TYPE zif_ghes222=>code_scanning_alert_code_scann
      RAISING cx_static_check.
    METHODS parse_code_scanning_analysis_a
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_analysis_analysi) TYPE zif_ghes222=>code_scanning_analysis_analysi
      RAISING cx_static_check.
    ...
    METHODS parse_code_scanning_alert_inst
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_alert_instances) TYPE zif_ghes222=>code_scanning_alert_instances
      RAISING cx_static_check.
    METHODS parse_code_scanning_alert_co01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_alert_code_sca01) TYPE zif_ghes222=>code_scanning_alert_code_sca01
      RAISING cx_static_check.
    METHODS parse_code_scanning_alert_set_
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_alert_set_state) TYPE zif_ghes222=>code_scanning_alert_set_state
      RAISING cx_static_check.
    METHODS parse_code_scanning_analysis_r
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_analysis_ref) TYPE zif_ghes222=>code_scanning_analysis_ref
      RAISING cx_static_check.
    ...
    METHODS parse_code_scanning_analysis02
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_analysis_created) TYPE zif_ghes222=>code_scanning_analysis_created
      RAISING cx_static_check.
    ...
    METHODS parse_code_scanning_analysis03
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_analysis_code_sc) TYPE zif_ghes222=>code_scanning_analysis_code_sc
      RAISING cx_static_check.
    METHODS parse_code_scanning_analysis_s
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_scanning_analysis_sarif_f) TYPE zif_ghes222=>code_scanning_analysis_sarif_f
      RAISING cx_static_check.
    METHODS parse_collaborator
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(collaborator) TYPE zif_ghes222=>collaborator
      RAISING cx_static_check.
    METHODS parse_repository_invitation
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repository_invitation) TYPE zif_ghes222=>repository_invitation
      RAISING cx_static_check.
    METHODS parse_commit_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(commit_comment) TYPE zif_ghes222=>commit_comment
      RAISING cx_static_check.
    METHODS parse_scim_error
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(scim_error) TYPE zif_ghes222=>scim_error
      RAISING cx_static_check.
    METHODS parse_branch_short
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(branch_short) TYPE zif_ghes222=>branch_short
      RAISING cx_static_check.
    METHODS parse_link
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(link) TYPE zif_ghes222=>link
      RAISING cx_static_check.
    METHODS parse_pull_request_simple
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_simple) TYPE zif_ghes222=>pull_request_simple
      RAISING cx_static_check.
    METHODS parse_simple_commit_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(simple_commit_status) TYPE zif_ghes222=>simple_commit_status
      RAISING cx_static_check.
    METHODS parse_combined_commit_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(combined_commit_status) TYPE zif_ghes222=>combined_commit_status
      RAISING cx_static_check.
    METHODS parse_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(status) TYPE zif_ghes222=>status
      RAISING cx_static_check.
    METHODS parse_diff_entry
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(diff_entry) TYPE zif_ghes222=>diff_entry
      RAISING cx_static_check.
    METHODS parse_commit_comparison
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(commit_comparison) TYPE zif_ghes222=>commit_comparison
      RAISING cx_static_check.
    METHODS parse_content_tree
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_tree) TYPE zif_ghes222=>content_tree
      RAISING cx_static_check.
    METHODS parse_content_directory
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_directory) TYPE zif_ghes222=>content_directory
      RAISING cx_static_check.
    METHODS parse_content_file
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_file) TYPE zif_ghes222=>content_file
      RAISING cx_static_check.
    METHODS parse_content_symlink
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_symlink) TYPE zif_ghes222=>content_symlink
      RAISING cx_static_check.
    METHODS parse_content_submodule
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(content_submodule) TYPE zif_ghes222=>content_submodule
      RAISING cx_static_check.
    METHODS parse_file_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(file_commit) TYPE zif_ghes222=>file_commit
      RAISING cx_static_check.
    METHODS parse_contributor
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(contributor) TYPE zif_ghes222=>contributor
      RAISING cx_static_check.
    METHODS parse_deployment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(deployment) TYPE zif_ghes222=>deployment
      RAISING cx_static_check.
    METHODS parse_deployment_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(deployment_status) TYPE zif_ghes222=>deployment_status
      RAISING cx_static_check.
    METHODS parse_short_blob
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(short_blob) TYPE zif_ghes222=>short_blob
      RAISING cx_static_check.
    METHODS parse_blob
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(blob) TYPE zif_ghes222=>blob
      RAISING cx_static_check.
    METHODS parse_git_commit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_commit) TYPE zif_ghes222=>git_commit
      RAISING cx_static_check.
    METHODS parse_git_ref
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_ref) TYPE zif_ghes222=>git_ref
      RAISING cx_static_check.
    METHODS parse_git_tag
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_tag) TYPE zif_ghes222=>git_tag
      RAISING cx_static_check.
    METHODS parse_git_tree
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(git_tree) TYPE zif_ghes222=>git_tree
      RAISING cx_static_check.
    METHODS parse_hook_response
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(hook_response) TYPE zif_ghes222=>hook_response
      RAISING cx_static_check.
    METHODS parse_hook
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(hook) TYPE zif_ghes222=>hook
      RAISING cx_static_check.
    METHODS parse_issue_event_label
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_label) TYPE zif_ghes222=>issue_event_label
      RAISING cx_static_check.
    METHODS parse_issue_event_dismissed_re
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_dismissed_review) TYPE zif_ghes222=>issue_event_dismissed_review
      RAISING cx_static_check.
    METHODS parse_issue_event_milestone
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_milestone) TYPE zif_ghes222=>issue_event_milestone
      RAISING cx_static_check.
    METHODS parse_issue_event_project_card
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_project_card) TYPE zif_ghes222=>issue_event_project_card
      RAISING cx_static_check.
    METHODS parse_issue_event_rename
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_rename) TYPE zif_ghes222=>issue_event_rename
      RAISING cx_static_check.
    METHODS parse_issue_event
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event) TYPE zif_ghes222=>issue_event
      RAISING cx_static_check.
    METHODS parse_issue_event_for_issue
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_event_for_issue) TYPE zif_ghes222=>issue_event_for_issue
      RAISING cx_static_check.
    METHODS parse_deploy_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(deploy_key) TYPE zif_ghes222=>deploy_key
      RAISING cx_static_check.
    METHODS parse_language
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(language) TYPE zif_ghes222=>language
      RAISING cx_static_check.
    METHODS parse_license_content
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(license_content) TYPE zif_ghes222=>license_content
      RAISING cx_static_check.
    METHODS parse_pages_source_hash
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pages_source_hash) TYPE zif_ghes222=>pages_source_hash
      RAISING cx_static_check.
    METHODS parse_page
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(page) TYPE zif_ghes222=>page
      RAISING cx_static_check.
    METHODS parse_page_build
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(page_build) TYPE zif_ghes222=>page_build
      RAISING cx_static_check.
    METHODS parse_page_build_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(page_build_status) TYPE zif_ghes222=>page_build_status
      RAISING cx_static_check.
    METHODS parse_repository_pre_receive_h
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repository_pre_receive_hook) TYPE zif_ghes222=>repository_pre_receive_hook
      RAISING cx_static_check.
    METHODS parse_pull_request
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request) TYPE zif_ghes222=>pull_request
      RAISING cx_static_check.
    METHODS parse_pull_request_review_comm
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_review_comment) TYPE zif_ghes222=>pull_request_review_comment
      RAISING cx_static_check.
    METHODS parse_pull_request_merge_resul
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_merge_result) TYPE zif_ghes222=>pull_request_merge_result
      RAISING cx_static_check.
    METHODS parse_pull_request_review_requ
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_review_request) TYPE zif_ghes222=>pull_request_review_request
      RAISING cx_static_check.
    METHODS parse_pull_request_review
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(pull_request_review) TYPE zif_ghes222=>pull_request_review
      RAISING cx_static_check.
    METHODS parse_review_comment
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(review_comment) TYPE zif_ghes222=>review_comment
      RAISING cx_static_check.
    METHODS parse_release_asset
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(release_asset) TYPE zif_ghes222=>release_asset
      RAISING cx_static_check.
    METHODS parse_release
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(release) TYPE zif_ghes222=>release
      RAISING cx_static_check.
    METHODS parse_stargazer
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(stargazer) TYPE zif_ghes222=>stargazer
      RAISING cx_static_check.
    METHODS parse_code_frequency_stat
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_frequency_stat) TYPE zif_ghes222=>code_frequency_stat
      RAISING cx_static_check.
    METHODS parse_commit_activity
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(commit_activity) TYPE zif_ghes222=>commit_activity
      RAISING cx_static_check.
    METHODS parse_contributor_activity
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(contributor_activity) TYPE zif_ghes222=>contributor_activity
      RAISING cx_static_check.
    METHODS parse_participation_stats
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(participation_stats) TYPE zif_ghes222=>participation_stats
      RAISING cx_static_check.
    METHODS parse_repository_subscription
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repository_subscription) TYPE zif_ghes222=>repository_subscription
      RAISING cx_static_check.
    METHODS parse_tag
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(tag) TYPE zif_ghes222=>tag
      RAISING cx_static_check.
    METHODS parse_topic
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(topic) TYPE zif_ghes222=>topic
      RAISING cx_static_check.
    METHODS parse_search_result_text_match
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(search_result_text_matches) TYPE zif_ghes222=>search_result_text_matches
      RAISING cx_static_check.
    METHODS parse_code_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code_search_result_item) TYPE zif_ghes222=>code_search_result_item
      RAISING cx_static_check.
    METHODS parse_commit_search_result_ite
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(commit_search_result_item) TYPE zif_ghes222=>commit_search_result_item
      RAISING cx_static_check.
    METHODS parse_issue_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issue_search_result_item) TYPE zif_ghes222=>issue_search_result_item
      RAISING cx_static_check.
    METHODS parse_label_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(label_search_result_item) TYPE zif_ghes222=>label_search_result_item
      RAISING cx_static_check.
    METHODS parse_repo_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(repo_search_result_item) TYPE zif_ghes222=>repo_search_result_item
      RAISING cx_static_check.
    METHODS parse_topic_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(topic_search_result_item) TYPE zif_ghes222=>topic_search_result_item
      RAISING cx_static_check.
    METHODS parse_user_search_result_item
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(user_search_result_item) TYPE zif_ghes222=>user_search_result_item
      RAISING cx_static_check.
    METHODS parse_configuration_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(configuration_status) TYPE zif_ghes222=>configuration_status
      RAISING cx_static_check.
    METHODS parse_maintenance_status
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(maintenance_status) TYPE zif_ghes222=>maintenance_status
      RAISING cx_static_check.
    METHODS parse_enterprise_settings
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(enterprise_settings) TYPE zif_ghes222=>enterprise_settings
      RAISING cx_static_check.
    METHODS parse_ssh_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(ssh_key) TYPE zif_ghes222=>ssh_key
      RAISING cx_static_check.
    METHODS parse_private_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(private_user) TYPE zif_ghes222=>private_user
      RAISING cx_static_check.
    METHODS parse_public_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(public_user) TYPE zif_ghes222=>public_user
      RAISING cx_static_check.
    METHODS parse_email
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(email) TYPE zif_ghes222=>email
      RAISING cx_static_check.
    METHODS parse_gpg_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(gpg_key) TYPE zif_ghes222=>gpg_key
      RAISING cx_static_check.
    METHODS parse_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(key) TYPE zif_ghes222=>key
      RAISING cx_static_check.
    METHODS parse_starred_repository
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(starred_repository) TYPE zif_ghes222=>starred_repository
      RAISING cx_static_check.
    METHODS parse_hovercard
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(hovercard) TYPE zif_ghes222=>hovercard
      RAISING cx_static_check.
    ...
    METHODS json_enterprise_admin_update_g
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_update_gl
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete_g
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_delete_gl
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_l
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_update_ld
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update01
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_update_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_o
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_create_or
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_o
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_update_or
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_p
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_create_pr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_p
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_update_pr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete_p
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_delete_pr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create01
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_create_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update02
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_update_02
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete01
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_delete_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_u
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_create_us
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_u
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_update_us
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete_u
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_delete_us
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_i
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_create_im
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete_i
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_delete_im
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_create_installation_
      IMPORTING data TYPE zif_ghes222=>bodyapps_create_installation_a
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_delete_authorization
      IMPORTING data TYPE zif_ghes222=>bodyapps_delete_authorization
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_check_token
      IMPORTING data TYPE zif_ghes222=>bodyapps_check_token
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_apps_reset_token
      IMPORTING data TYPE zif_ghes222=>bodyapps_reset_token
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_oauth_authorizations_crea
      IMPORTING data TYPE zif_ghes222=>bodyoauth_authorizations_creat
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_oauth_authorizations_get_
      IMPORTING data TYPE zif_ghes222=>bodyoauth_authorizations_get_o
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_oauth_authorizations_ge01
      IMPORTING data TYPE zif_ghes222=>bodyoauth_authorizations_get01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_oauth_authorizations_upda
      IMPORTING data TYPE zif_ghes222=>bodyoauth_authorizations_updat
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_oauth_authorizations_dele
      IMPORTING data TYPE zif_ghes222=>bodyoauth_authorizations_delet
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    ...
    METHODS json_enterprise_admin_create_s
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_create_se
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update_s
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_update_se
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_delete_s
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_delete_se
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_set_org_
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_set_org_a
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_set_self
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_set_self_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_create
      IMPORTING data TYPE zif_ghes222=>bodygists_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_update
      IMPORTING data TYPE zif_ghes222=>bodygists_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_delete
      IMPORTING data TYPE zif_ghes222=>bodygists_delete
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_create_comment
      IMPORTING data TYPE zif_ghes222=>bodygists_create_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_update_comment
      IMPORTING data TYPE zif_ghes222=>bodygists_update_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_gists_delete_comment
      IMPORTING data TYPE zif_ghes222=>bodygists_delete_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_markdown_render
      IMPORTING data TYPE zif_ghes222=>bodymarkdown_render
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_mark_notificatio
      IMPORTING data TYPE zif_ghes222=>bodyactivity_mark_notification
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_set_thread_subsc
      IMPORTING data TYPE zif_ghes222=>bodyactivity_set_thread_subscr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_delete_thread_su
      IMPORTING data TYPE zif_ghes222=>bodyactivity_delete_thread_sub
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_update
      IMPORTING data TYPE zif_ghes222=>bodyorgs_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_create_self_hoste
      IMPORTING data TYPE zif_ghes222=>bodyactions_create_self_hosted
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_update_self_hoste
      IMPORTING data TYPE zif_ghes222=>bodyactions_update_self_hosted
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_delete_self_hoste
      IMPORTING data TYPE zif_ghes222=>bodyactions_delete_self_hosted
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_set_repo_access_t
      IMPORTING data TYPE zif_ghes222=>bodyactions_set_repo_access_to
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_set_self_hosted_r
      IMPORTING data TYPE zif_ghes222=>bodyactions_set_self_hosted_ru
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_create_or_update_
      IMPORTING data TYPE zif_ghes222=>bodyactions_create_or_update_o
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_delete_org_secret
      IMPORTING data TYPE zif_ghes222=>bodyactions_delete_org_secret
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_set_selected_repo
      IMPORTING data TYPE zif_ghes222=>bodyactions_set_selected_repos
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_create_webhook
      IMPORTING data TYPE zif_ghes222=>bodyorgs_create_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_update_webhook
      IMPORTING data TYPE zif_ghes222=>bodyorgs_update_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_delete_webhook
      IMPORTING data TYPE zif_ghes222=>bodyorgs_delete_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_set_membership_for_u
      IMPORTING data TYPE zif_ghes222=>bodyorgs_set_membership_for_us
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_remove_membership_fo
      IMPORTING data TYPE zif_ghes222=>bodyorgs_remove_membership_for
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update03
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_update_03
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_remove_p
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_remove_pr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_for_org
      IMPORTING data TYPE zif_ghes222=>bodyprojects_create_for_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_in_org
      IMPORTING data TYPE zif_ghes222=>bodyrepos_create_in_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create
      IMPORTING data TYPE zif_ghes222=>bodyteams_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_in_org
      IMPORTING data TYPE zif_ghes222=>bodyteams_update_in_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_in_org
      IMPORTING data TYPE zif_ghes222=>bodyteams_delete_in_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_discussion_i
      IMPORTING data TYPE zif_ghes222=>bodyteams_create_discussion_in
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_discussion_i
      IMPORTING data TYPE zif_ghes222=>bodyteams_update_discussion_in
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_discussion_i
      IMPORTING data TYPE zif_ghes222=>bodyteams_delete_discussion_in
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_discussion_c
      IMPORTING data TYPE zif_ghes222=>bodyteams_create_discussion_co
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_discussion_c
      IMPORTING data TYPE zif_ghes222=>bodyteams_update_discussion_co
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_discussion_c
      IMPORTING data TYPE zif_ghes222=>bodyteams_delete_discussion_co
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_team
      IMPORTING data TYPE zif_ghes222=>bodyreactions_create_for_team_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_te01
      IMPORTING data TYPE zif_ghes222=>bodyreactions_create_for_tea01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_membe
      IMPORTING data TYPE zif_ghes222=>bodyteams_add_or_update_member
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_membership_f
      IMPORTING data TYPE zif_ghes222=>bodyteams_remove_membership_fo
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_proje
      IMPORTING data TYPE zif_ghes222=>bodyteams_add_or_update_projec
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_project_in_o
      IMPORTING data TYPE zif_ghes222=>bodyteams_remove_project_in_or
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_repo_
      IMPORTING data TYPE zif_ghes222=>bodyteams_add_or_update_repo_p
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_repo_in_org
      IMPORTING data TYPE zif_ghes222=>bodyteams_remove_repo_in_org
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_update_card
      IMPORTING data TYPE zif_ghes222=>bodyprojects_update_card
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_delete_card
      IMPORTING data TYPE zif_ghes222=>bodyprojects_delete_card
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_move_card
      IMPORTING data TYPE zif_ghes222=>bodyprojects_move_card
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_update_column
      IMPORTING data TYPE zif_ghes222=>bodyprojects_update_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_delete_column
      IMPORTING data TYPE zif_ghes222=>bodyprojects_delete_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_card
      IMPORTING data TYPE zif_ghes222=>bodyprojects_create_card
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_move_column
      IMPORTING data TYPE zif_ghes222=>bodyprojects_move_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_update
      IMPORTING data TYPE zif_ghes222=>bodyprojects_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_delete
      IMPORTING data TYPE zif_ghes222=>bodyprojects_delete
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_add_collaborator
      IMPORTING data TYPE zif_ghes222=>bodyprojects_add_collaborator
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_remove_collabora
      IMPORTING data TYPE zif_ghes222=>bodyprojects_remove_collaborat
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_column
      IMPORTING data TYPE zif_ghes222=>bodyprojects_create_column
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update
      IMPORTING data TYPE zif_ghes222=>bodyrepos_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete
      IMPORTING data TYPE zif_ghes222=>bodyrepos_delete
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_create_or_updat01
      IMPORTING data TYPE zif_ghes222=>bodyactions_create_or_update_r
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_delete_repo_secre
      IMPORTING data TYPE zif_ghes222=>bodyactions_delete_repo_secret
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_actions_create_workflow_d
      IMPORTING data TYPE zif_ghes222=>bodyactions_create_workflow_di
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_branch_prote
      IMPORTING data TYPE zif_ghes222=>bodyrepos_update_branch_protec
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_branch_prote
      IMPORTING data TYPE zif_ghes222=>bodyrepos_delete_branch_protec
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_pull_request
      IMPORTING data TYPE zif_ghes222=>bodyrepos_update_pull_request_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_pull_request
      IMPORTING data TYPE zif_ghes222=>bodyrepos_delete_pull_request_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_status_check
      IMPORTING data TYPE zif_ghes222=>bodyrepos_update_status_check_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_remove_status_check
      IMPORTING data TYPE zif_ghes222=>bodyrepos_remove_status_check_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_add_status_check_co
      IMPORTING data TYPE zif_ghes222=>bodyrepos_add_status_check_con
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_set_status_check_co
      IMPORTING data TYPE zif_ghes222=>bodyrepos_set_status_check_con
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_remove_status_che01
      IMPORTING data TYPE zif_ghes222=>bodyrepos_remove_status_chec01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_add_app_access_rest
      IMPORTING data TYPE zif_ghes222=>bodyrepos_add_app_access_restr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_set_app_access_rest
      IMPORTING data TYPE zif_ghes222=>bodyrepos_set_app_access_restr
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_remove_app_access_r
      IMPORTING data TYPE zif_ghes222=>bodyrepos_remove_app_access_re
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_add_team_access_res
      IMPORTING data TYPE zif_ghes222=>bodyrepos_add_team_access_rest
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_set_team_access_res
      IMPORTING data TYPE zif_ghes222=>bodyrepos_set_team_access_rest
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_remove_team_access_
      IMPORTING data TYPE zif_ghes222=>bodyrepos_remove_team_access_r
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_add_user_access_res
      IMPORTING data TYPE zif_ghes222=>bodyrepos_add_user_access_rest
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_set_user_access_res
      IMPORTING data TYPE zif_ghes222=>bodyrepos_set_user_access_rest
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_remove_user_access_
      IMPORTING data TYPE zif_ghes222=>bodyrepos_remove_user_access_r
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_create
      IMPORTING data TYPE zif_ghes222=>bodychecks_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_update
      IMPORTING data TYPE zif_ghes222=>bodychecks_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_create_suite
      IMPORTING data TYPE zif_ghes222=>bodychecks_create_suite
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_checks_set_suites_prefere
      IMPORTING data TYPE zif_ghes222=>bodychecks_set_suites_preferen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_code_scanning_update_aler
      IMPORTING data TYPE zif_ghes222=>bodycode_scanning_update_alert
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_code_scanning_upload_sari
      IMPORTING data TYPE zif_ghes222=>bodycode_scanning_upload_sarif
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_add_collaborator
      IMPORTING data TYPE zif_ghes222=>bodyrepos_add_collaborator
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_remove_collaborator
      IMPORTING data TYPE zif_ghes222=>bodyrepos_remove_collaborator
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_commit_comme
      IMPORTING data TYPE zif_ghes222=>bodyrepos_update_commit_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_commit_comme
      IMPORTING data TYPE zif_ghes222=>bodyrepos_delete_commit_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_comm
      IMPORTING data TYPE zif_ghes222=>bodyreactions_create_for_commi
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_commit_comme
      IMPORTING data TYPE zif_ghes222=>bodyrepos_create_commit_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_or_update_fi
      IMPORTING data TYPE zif_ghes222=>bodyrepos_create_or_update_fil
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_file
      IMPORTING data TYPE zif_ghes222=>bodyrepos_delete_file
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_deployment
      IMPORTING data TYPE zif_ghes222=>bodyrepos_create_deployment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_deployment_s
      IMPORTING data TYPE zif_ghes222=>bodyrepos_create_deployment_st
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_dispatch_eve
      IMPORTING data TYPE zif_ghes222=>bodyrepos_create_dispatch_even
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_fork
      IMPORTING data TYPE zif_ghes222=>bodyrepos_create_fork
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_blob
      IMPORTING data TYPE zif_ghes222=>bodygit_create_blob
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_commit
      IMPORTING data TYPE zif_ghes222=>bodygit_create_commit
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_ref
      IMPORTING data TYPE zif_ghes222=>bodygit_create_ref
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_update_ref
      IMPORTING data TYPE zif_ghes222=>bodygit_update_ref
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_delete_ref
      IMPORTING data TYPE zif_ghes222=>bodygit_delete_ref
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_tag
      IMPORTING data TYPE zif_ghes222=>bodygit_create_tag
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_git_create_tree
      IMPORTING data TYPE zif_ghes222=>bodygit_create_tree
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_webhook
      IMPORTING data TYPE zif_ghes222=>bodyrepos_create_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_webhook
      IMPORTING data TYPE zif_ghes222=>bodyrepos_update_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_webhook
      IMPORTING data TYPE zif_ghes222=>bodyrepos_delete_webhook
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_invitation
      IMPORTING data TYPE zif_ghes222=>bodyrepos_update_invitation
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_invitation
      IMPORTING data TYPE zif_ghes222=>bodyrepos_delete_invitation
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create
      IMPORTING data TYPE zif_ghes222=>bodyissues_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update_comment
      IMPORTING data TYPE zif_ghes222=>bodyissues_update_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_delete_comment
      IMPORTING data TYPE zif_ghes222=>bodyissues_delete_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_issu
      IMPORTING data TYPE zif_ghes222=>bodyreactions_create_for_issue
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update
      IMPORTING data TYPE zif_ghes222=>bodyissues_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_add_assignees
      IMPORTING data TYPE zif_ghes222=>bodyissues_add_assignees
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_remove_assignees
      IMPORTING data TYPE zif_ghes222=>bodyissues_remove_assignees
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create_comment
      IMPORTING data TYPE zif_ghes222=>bodyissues_create_comment
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_add_labels
      IMPORTING data TYPE zif_ghes222=>bodyissues_add_labels
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_set_labels
      IMPORTING data TYPE zif_ghes222=>bodyissues_set_labels
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_remove_all_labels
      IMPORTING data TYPE zif_ghes222=>bodyissues_remove_all_labels
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_lock
      IMPORTING data TYPE zif_ghes222=>bodyissues_lock
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_unlock
      IMPORTING data TYPE zif_ghes222=>bodyissues_unlock
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_is01
      IMPORTING data TYPE zif_ghes222=>bodyreactions_create_for_iss01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_deploy_key
      IMPORTING data TYPE zif_ghes222=>bodyrepos_create_deploy_key
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create_label
      IMPORTING data TYPE zif_ghes222=>bodyissues_create_label
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update_label
      IMPORTING data TYPE zif_ghes222=>bodyissues_update_label
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_delete_label
      IMPORTING data TYPE zif_ghes222=>bodyissues_delete_label
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_merge
      IMPORTING data TYPE zif_ghes222=>bodyrepos_merge
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_create_milestone
      IMPORTING data TYPE zif_ghes222=>bodyissues_create_milestone
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_update_milestone
      IMPORTING data TYPE zif_ghes222=>bodyissues_update_milestone
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_issues_delete_milestone
      IMPORTING data TYPE zif_ghes222=>bodyissues_delete_milestone
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_mark_repo_notifi
      IMPORTING data TYPE zif_ghes222=>bodyactivity_mark_repo_notific
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_pages_site
      IMPORTING data TYPE zif_ghes222=>bodyrepos_create_pages_site
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_information_
      IMPORTING data TYPE zif_ghes222=>bodyrepos_update_information_a
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_pages_site
      IMPORTING data TYPE zif_ghes222=>bodyrepos_delete_pages_site
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_update04
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_update_04
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_remove01
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_remove_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_for_repo
      IMPORTING data TYPE zif_ghes222=>bodyprojects_create_for_repo
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create
      IMPORTING data TYPE zif_ghes222=>bodypulls_create
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update_review_comme
      IMPORTING data TYPE zif_ghes222=>bodypulls_update_review_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_delete_review_comme
      IMPORTING data TYPE zif_ghes222=>bodypulls_delete_review_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_pull
      IMPORTING data TYPE zif_ghes222=>bodyreactions_create_for_pull_
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update
      IMPORTING data TYPE zif_ghes222=>bodypulls_update
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create_review_comme
      IMPORTING data TYPE zif_ghes222=>bodypulls_create_review_commen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create_reply_for_re
      IMPORTING data TYPE zif_ghes222=>bodypulls_create_reply_for_rev
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_merge
      IMPORTING data TYPE zif_ghes222=>bodypulls_merge
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_request_reviewers
      IMPORTING data TYPE zif_ghes222=>bodypulls_request_reviewers
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_remove_requested_re
      IMPORTING data TYPE zif_ghes222=>bodypulls_remove_requested_rev
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_create_review
      IMPORTING data TYPE zif_ghes222=>bodypulls_create_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update_review
      IMPORTING data TYPE zif_ghes222=>bodypulls_update_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_delete_pending_revi
      IMPORTING data TYPE zif_ghes222=>bodypulls_delete_pending_revie
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_dismiss_review
      IMPORTING data TYPE zif_ghes222=>bodypulls_dismiss_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_submit_review
      IMPORTING data TYPE zif_ghes222=>bodypulls_submit_review
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_pulls_update_branch
      IMPORTING data TYPE zif_ghes222=>bodypulls_update_branch
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_release
      IMPORTING data TYPE zif_ghes222=>bodyrepos_create_release
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_release_asse
      IMPORTING data TYPE zif_ghes222=>bodyrepos_update_release_asset
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_release_asse
      IMPORTING data TYPE zif_ghes222=>bodyrepos_delete_release_asset
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_update_release
      IMPORTING data TYPE zif_ghes222=>bodyrepos_update_release
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_delete_release
      IMPORTING data TYPE zif_ghes222=>bodyrepos_delete_release
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_commit_statu
      IMPORTING data TYPE zif_ghes222=>bodyrepos_create_commit_status
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_set_repo_subscri
      IMPORTING data TYPE zif_ghes222=>bodyactivity_set_repo_subscrip
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_activity_delete_repo_subs
      IMPORTING data TYPE zif_ghes222=>bodyactivity_delete_repo_subsc
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_replace_all_topics
      IMPORTING data TYPE zif_ghes222=>bodyrepos_replace_all_topics
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_transfer
      IMPORTING data TYPE zif_ghes222=>bodyrepos_transfer
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_using_templa
      IMPORTING data TYPE zif_ghes222=>bodyrepos_create_using_templat
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_enable_o
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_enable_or
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_set_sett
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_set_setti
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_add_auth
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_add_autho
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_remove_a
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_remove_au
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_create_e
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_create_en
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_upgrade_
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_upgrade_l
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_legacy
      IMPORTING data TYPE zif_ghes222=>bodyteams_update_legacy
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_legacy
      IMPORTING data TYPE zif_ghes222=>bodyteams_delete_legacy
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_discussion_l
      IMPORTING data TYPE zif_ghes222=>bodyteams_create_discussion_le
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_discussion_l
      IMPORTING data TYPE zif_ghes222=>bodyteams_update_discussion_le
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_discussion_l
      IMPORTING data TYPE zif_ghes222=>bodyteams_delete_discussion_le
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_create_discussion01
      IMPORTING data TYPE zif_ghes222=>bodyteams_create_discussion_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_update_discussion01
      IMPORTING data TYPE zif_ghes222=>bodyteams_update_discussion_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_delete_discussion01
      IMPORTING data TYPE zif_ghes222=>bodyteams_delete_discussion_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_te02
      IMPORTING data TYPE zif_ghes222=>bodyreactions_create_for_tea02
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_reactions_create_for_te03
      IMPORTING data TYPE zif_ghes222=>bodyreactions_create_for_tea03
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_mem01
      IMPORTING data TYPE zif_ghes222=>bodyteams_add_or_update_memb01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_membership01
      IMPORTING data TYPE zif_ghes222=>bodyteams_remove_membership_01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_pro01
      IMPORTING data TYPE zif_ghes222=>bodyteams_add_or_update_proj01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_project_lega
      IMPORTING data TYPE zif_ghes222=>bodyteams_remove_project_legac
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_add_or_update_rep01
      IMPORTING data TYPE zif_ghes222=>bodyteams_add_or_update_repo01
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_teams_remove_repo_legacy
      IMPORTING data TYPE zif_ghes222=>bodyteams_remove_repo_legacy
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_users_update_authenticate
      IMPORTING data TYPE zif_ghes222=>bodyusers_update_authenticated
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_users_add_email_for_authe
      IMPORTING data TYPE zif_ghes222=>bodyusers_add_email_for_authen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_users_delete_email_for_au
      IMPORTING data TYPE zif_ghes222=>bodyusers_delete_email_for_aut
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_users_create_gpg_key_for_
      IMPORTING data TYPE zif_ghes222=>bodyusers_create_gpg_key_for_a
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_users_create_public_ssh_k
      IMPORTING data TYPE zif_ghes222=>bodyusers_create_public_ssh_ke
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_orgs_update_membership_fo
      IMPORTING data TYPE zif_ghes222=>bodyorgs_update_membership_for
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_projects_create_for_authe
      IMPORTING data TYPE zif_ghes222=>bodyprojects_create_for_authen
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_repos_create_for_authenti
      IMPORTING data TYPE zif_ghes222=>bodyrepos_create_for_authentic
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
    METHODS json_enterprise_admin_suspend_
      IMPORTING data TYPE zif_ghes222=>bodyenterprise_admin_suspend_u
      RETURNING VALUE(json) TYPE string
      RAISING cx_static_check.
...
* todo, number, id
  ...
  METHOD parse_runner_no_labels.
* todo, number, id
    runner_no_labels-name = mo_json->value_string( iv_prefix && '/name' ).
    runner_no_labels-os = mo_json->value_string( iv_prefix && '/os' ).
    runner_no_labels-status = mo_json->value_string( iv_prefix && '/status' ).
    runner_no_labels-busy = mo_json->value_boolean( iv_prefix && '/busy' ).
  ENDMETHOD.
...
* todo, handle more responses
  ...
  METHOD zif_ghes222~enterprise_admin_get_self_ho01.
    ...
    WRITE / lv_code.
    CREATE OBJECT mo_json EXPORTING iv_json = mi_client->response->get_cdata( ).
    return_data = parse_runner_no_labels( '' ).
  ENDMETHOD.
