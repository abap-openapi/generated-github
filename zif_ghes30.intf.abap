...
* Component schema: response_enterprise_admin_list_self_h02, object
  TYPES: BEGIN OF response_enterprise_admin_li09,
           total_count TYPE f,
           runners TYPE STANDARD TABLE OF string WITH DEFAULT KEY, " todo, handle array
         END OF response_enterprise_admin_li09.

* Component schema: response_enterprise_admin_list_runner_a, array
  TYPES response_enterprise_admin_li10 TYPE STANDARD TABLE OF runner_application WITH DEFAULT KEY.
...
* Component schema: response_enterprise_admin_list_pre_re02, array
  TYPES response_enterprise_admin_li11 TYPE STANDARD TABLE OF org_pre_receive_hook WITH DEFAULT KEY.
...
* Component schema: response_enterprise_admin_list_pre_re03, array
  TYPES response_enterprise_admin_li12 TYPE STANDARD TABLE OF repository_pre_receive_hook WITH DEFAULT KEY.
...
*     application/json, #/components/schemas/response_enterprise_admin_list_pre_re03
  METHODS enterprise_admin_list_pre_re03
    IMPORTING
      ...
      direction TYPE string DEFAULT 'desc'
    RETURNING
      VALUE(return_data) TYPE response_enterprise_admin_li12
    RAISING cx_static_check.
